...
func VisualizationV2Converter(input dashboardv2.VizConfigKind) string {
	calls := []string{
		`text.NewVisualizationV2Builder()`,
	}
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).Code != nil {

		buffer.WriteString(`Code(`)
		arg0 := CodeOptionsConverter(*input.Spec.Options.(*Options).Code)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).Content != "" && input.Spec.Options.(*Options).Content != "# Title\n\nFor markdown syntax help: [commonmark.org/help](https://commonmark.org/help/)" {

		buffer.WriteString(`Content(`)
		arg0 := fmt.Sprintf("%#v", input.Spec.Options.(*Options).Content)
		buffer.WriteString(arg0)
