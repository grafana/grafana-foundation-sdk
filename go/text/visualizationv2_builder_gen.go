...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("text.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) Mode(mode TextMode) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) Code(code cog.Builder[CodeOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) Content(content string) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
