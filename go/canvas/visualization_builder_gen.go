...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("canvas.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) InlineEditing(inlineEditing bool) *VisualizationBuilder {
...
// Enable pan and zoom
func (builder *VisualizationBuilder) PanZoom(panZoom bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
// Enable infinite pan
func (builder *VisualizationBuilder) InfinitePan(infinitePan bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) Root(root cog.Builder[CanvasOptionsRoot]) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
