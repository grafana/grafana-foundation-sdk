...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("canvas.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) InlineEditing(inlineEditing bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).InlineEditing = inlineEditing

	return builder
}

// Show all available element types
func (builder *VisualizationV2Builder) ShowAdvancedTypes(showAdvancedTypes bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowAdvancedTypes = showAdvancedTypes

	return builder
}

// Enable pan and zoom
func (builder *VisualizationV2Builder) PanZoom(panZoom bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).PanZoom = panZoom

	return builder
}

// Enable infinite pan
func (builder *VisualizationV2Builder) InfinitePan(infinitePan bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).InfinitePan = infinitePan
...
func (builder *VisualizationV2Builder) Root(root cog.Builder[CanvasOptionsRoot]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Root = rootResource
