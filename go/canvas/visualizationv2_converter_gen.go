...
func VisualizationV2Converter(input dashboardv2.VizConfigKind) string {
	calls := []string{
		`canvas.NewVisualizationV2Builder()`,
	}
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).InlineEditing != true {

		buffer.WriteString(`InlineEditing(`)
		arg0 := fmt.Sprintf("%#v", input.Spec.Options.(*Options).InlineEditing)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).ShowAdvancedTypes != true {

		buffer.WriteString(`ShowAdvancedTypes(`)
		arg0 := fmt.Sprintf("%#v", input.Spec.Options.(*Options).ShowAdvancedTypes)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).PanZoom != true {

		buffer.WriteString(`PanZoom(`)
		arg0 := fmt.Sprintf("%#v", input.Spec.Options.(*Options).PanZoom)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).InfinitePan != true {

		buffer.WriteString(`InfinitePan(`)
		arg0 := fmt.Sprintf("%#v", input.Spec.Options.(*Options).InfinitePan)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := CanvasOptionsRootConverter(input.Spec.Options.(*Options).Root)
		buffer.WriteString(arg0)
