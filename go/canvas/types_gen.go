...
func (resource *Placement) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["rotation"] != nil {
		if string(fields["rotation"]) != "null" {
			if err := json.Unmarshal(fields["rotation"], &resource.Rotation); err != nil {
				errs = append(errs, cog.MakeBuildErrors("rotation", err)...)
			}
...
func (resource *LineConfig) UnmarshalJSONStrict(raw []byte) error {
	...
	// Field "radius"
	if fields["radius"] != nil {
		if string(fields["radius"]) != "null" {
			if err := json.Unmarshal(fields["radius"], &resource.Radius); err != nil {
				errs = append(errs, cog.MakeBuildErrors("radius", err)...)
			}
...
func (resource *CanvasConnection) UnmarshalJSONStrict(raw []byte) error {
	...
	// Field "vertices"
	if fields["vertices"] != nil {
		if string(fields["vertices"]) != "null" {

			partialArray := []json.RawMessage{}
			if err := json.Unmarshal(fields["vertices"], &partialArray); err != nil {
				return err
			}

			for i1 := range partialArray {
				var result1 ConnectionCoordinates

				result1 = ConnectionCoordinates{}
				if err := result1.UnmarshalJSONStrict(partialArray[i1]); err != nil {
					errs = append(errs, cog.MakeBuildErrors("vertices["+strconv.Itoa(i1)+"]", err)...)
				}
				resource.Vertices = append(resource.Vertices, result1)
			}

		}
		delete(fields, "vertices")

	}
	// Field "sourceOriginal"
	if fields["sourceOriginal"] != nil {
		if string(fields["sourceOriginal"]) != "null" {

			resource.SourceOriginal = &ConnectionCoordinates{}
			if err := resource.SourceOriginal.UnmarshalJSONStrict(fields["sourceOriginal"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("sourceOriginal", err)...)
			}

		}
		delete(fields, "sourceOriginal")

	}
	// Field "targetOriginal"
	if fields["targetOriginal"] != nil {
		if string(fields["targetOriginal"]) != "null" {

			resource.TargetOriginal = &ConnectionCoordinates{}
			if err := resource.TargetOriginal.UnmarshalJSONStrict(fields["targetOriginal"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("targetOriginal", err)...)
			}

		}
		delete(fields, "targetOriginal")
...
func (resource CanvasConnection) Validate() error {
	...
	for i1 := range resource.Vertices {
		if err := resource.Vertices[i1].Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("vertices["+strconv.Itoa(i1)+"]", err)...)
		}
	}
	if resource.SourceOriginal != nil {
		if err := resource.SourceOriginal.Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("sourceOriginal", err)...)
		}
	}
	if resource.TargetOriginal != nil {
		if err := resource.TargetOriginal.Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("targetOriginal", err)...)
		}
	}
...
func (resource *Options) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["panZoom"] != nil {
		if string(fields["panZoom"]) != "null" {
			if err := json.Unmarshal(fields["panZoom"], &resource.PanZoom); err != nil {
				errs = append(errs, cog.MakeBuildErrors("panZoom", err)...)
			}
		} else {
			errs = append(errs, cog.MakeBuildErrors("panZoom", errors.New("required field is null"))...)
	...
	if fields["infinitePan"] != nil {
		if string(fields["infinitePan"]) != "null" {
			if err := json.Unmarshal(fields["infinitePan"], &resource.InfinitePan); err != nil {
				errs = append(errs, cog.MakeBuildErrors("infinitePan", err)...)
			}
		} else {
			errs = append(errs, cog.MakeBuildErrors("infinitePan", errors.New("required field is null"))...)
...
func VariantConfig() variants.PanelcfgConfig {
	return variants.PanelcfgConfig{
		Identifier: "canvas", OptionsUnmarshaler: func(raw []byte) (any, error) {
			options := &Options{}
