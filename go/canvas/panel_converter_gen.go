...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).InlineEditing != true {

		buffer.WriteString(`InlineEditing(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).InlineEditing)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowAdvancedTypes != true {

		buffer.WriteString(`ShowAdvancedTypes(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowAdvancedTypes)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).PanZoom != true {

		buffer.WriteString(`PanZoom(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).PanZoom)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).InfinitePan != true {

		buffer.WriteString(`InfinitePan(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).InfinitePan)
		buffer.WriteString(arg0)
