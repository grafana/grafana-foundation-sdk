...
func NewQueryV2Builder() *QueryV2Builder {
	...
	builder.internal.Group = "grafana-athena-datasource"
...
func (builder *QueryV2Builder) Build() (dashboardv2.DataQueryKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.DataQueryKind{}, cog.MakeBuildErrors("athena.queryV2", builder.errors)
	}
...
func (builder *QueryV2Builder) Format(format FormatOptions) *QueryV2Builder {
...
func (builder *QueryV2Builder) ConnectionArgs(connectionArgs cog.Builder[ConnectionArgs]) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
