...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "barchart"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("barchart.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) ColorByField(colorByField string) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ColorByField = &colorByField

	return builder
}

// Controls the orientation of the bar chart, either vertical or horizontal.
func (builder *VisualizationV2Builder) Orientation(orientation common.VizOrientation) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Orientation = orientation

	return builder
}

// Controls the radius of each bar.
func (builder *VisualizationV2Builder) BarRadius(barRadius float64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).BarRadius = &barRadius

	return builder
}

// Controls the rotation of the x axis labels.
func (builder *VisualizationV2Builder) XTickLabelRotation(xTickLabelRotation int32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).XTickLabelRotation = xTickLabelRotation

	return builder
}

// Sets the max length that a label can have before it is truncated.
func (builder *VisualizationV2Builder) XTickLabelMaxLength(xTickLabelMaxLength int32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).XTickLabelMaxLength = xTickLabelMaxLength
...
func (builder *VisualizationV2Builder) XTickLabelSpacing(xTickLabelSpacing int32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).XTickLabelSpacing = &xTickLabelSpacing

	return builder
}

// Controls whether bars are stacked or not, either normally or in percent mode.
func (builder *VisualizationV2Builder) Stacking(stacking common.StackingMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Stacking = stacking
...
func (builder *VisualizationV2Builder) BarWidth(barWidth float64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).BarWidth = barWidth

	return builder
}

// Controls the width of groups. 1 = max with, 0 = min width.
func (builder *VisualizationV2Builder) GroupWidth(groupWidth float64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).GroupWidth = groupWidth
...
func (builder *VisualizationV2Builder) Text(text cog.Builder[common.VizTextDisplayOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Text = &textResource
...
func (builder *VisualizationV2Builder) FullHighlight(fullHighlight bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).FullHighlight = fullHighlight
...
func (builder *VisualizationV2Builder) FillOpacity(fillOpacity int32) *VisualizationV2Builder {
	if builder.internal.Spec.FieldConfig.Defaults.Custom == nil {
		builder.internal.Spec.FieldConfig.Defaults.Custom = NewFieldConfig()
	}
