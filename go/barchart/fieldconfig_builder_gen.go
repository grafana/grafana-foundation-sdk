...
func (builder *FieldConfigBuilder) Build() (FieldConfig, error) {
	...
	if len(builder.errors) > 0 {
		return FieldConfig{}, cog.MakeBuildErrors("barchart.fieldConfig", builder.errors)
	}
...
func (builder *FieldConfigBuilder) FillOpacity(fillOpacity int32) *FieldConfigBuilder {
