...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).ColorByField != nil && *input.Options.(*Options).ColorByField != "" {
		...
		arg0 := fmt.Sprintf("%#v", *input.Options.(*Options).ColorByField)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).BarRadius != nil && *input.Options.(*Options).BarRadius != 0 {
		...
		arg0 := fmt.Sprintf("%#v", *input.Options.(*Options).BarRadius)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).XTickLabelSpacing != nil && *input.Options.(*Options).XTickLabelSpacing != 0 {
		...
		arg0 := fmt.Sprintf("%#v", *input.Options.(*Options).XTickLabelSpacing)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).LineWidth != nil && *input.FieldConfig.Defaults.Custom.(*FieldConfig).LineWidth != 1 {
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).FillOpacity != nil && *input.FieldConfig.Defaults.Custom.(*FieldConfig).FillOpacity != 80 {
