...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).Labels != "" {

		buffer.WriteString(`Labels(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).Labels)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).Alertmanager != "" {

		buffer.WriteString(`Alertmanager(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).Alertmanager)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ExpandAll)
		buffer.WriteString(arg0)
