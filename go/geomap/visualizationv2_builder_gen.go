...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("geomap.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) View(view cog.Builder[MapViewConfig]) *VisualizationV2Builder {
	...
	builder.internal.Spec.Options.(*Options).View = viewResource

	return builder
}

func (builder *VisualizationV2Builder) Controls(controls cog.Builder[ControlsOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Controls = controlsResource

	return builder
}

func (builder *VisualizationV2Builder) Basemap(basemap cog.Builder[common.MapLayerOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Basemap = basemapResource

	return builder
}

func (builder *VisualizationV2Builder) Layers(layers []cog.Builder[common.MapLayerOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Layers = layersResources

	return builder
}

func (builder *VisualizationV2Builder) Tooltip(tooltip cog.Builder[TooltipOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
