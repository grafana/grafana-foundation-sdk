...
func VisualizationV2Converter(input dashboardv2.VizConfigKind) string {
	calls := []string{
		`geomap.NewVisualizationV2Builder()`,
	}
	...
	if input.Spec.Options != nil {
		...
		arg0 := MapViewConfigConverter(input.Spec.Options.(*Options).View)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := ControlsOptionsConverter(input.Spec.Options.(*Options).Controls)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := common.MapLayerOptionsConverter(input.Spec.Options.(*Options).Basemap)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).Layers != nil && len(input.Spec.Options.(*Options).Layers) >= 1 {

		buffer.WriteString(`Layers(`)
		tmparg0 := []string{}
		for _, arg1 := range input.Spec.Options.(*Options).Layers {
	...
	if input.Spec.Options != nil {
		...
		arg0 := TooltipOptionsConverter(input.Spec.Options.(*Options).Tooltip)
		buffer.WriteString(arg0)
