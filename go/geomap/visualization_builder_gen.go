...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("geomap.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) View(view cog.Builder[MapViewConfig]) *VisualizationBuilder {
...
func (builder *VisualizationBuilder) Controls(controls cog.Builder[ControlsOptions]) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) Basemap(basemap cog.Builder[common.MapLayerOptions]) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) Layers(layers []cog.Builder[common.MapLayerOptions]) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) Tooltip(tooltip cog.Builder[TooltipOptions]) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
