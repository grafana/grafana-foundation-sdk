...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("histogram.visualization", builder.errors)
	}
...
// Bucket count (approx)
func (builder *VisualizationBuilder) BucketCount(bucketCount int32) *VisualizationBuilder {
...
// Size of each bucket
func (builder *VisualizationBuilder) BucketSize(bucketSize int32) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) BucketOffset(bucketOffset float32) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) Combine(combine bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
