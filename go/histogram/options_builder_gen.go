...
// Bucket count (approx)
func (builder *OptionsBuilder) BucketCount(bucketCount int32) *OptionsBuilder {
	builder.internal.BucketCount = &bucketCount
...
func (builder *OptionsBuilder) BucketOffset(bucketOffset float32) *OptionsBuilder {
