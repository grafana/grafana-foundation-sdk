...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "histogram"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("histogram.visualizationV2", builder.errors)
	}
...
// Bucket count (approx)
func (builder *VisualizationV2Builder) BucketCount(bucketCount int32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).BucketCount = &bucketCount

	return builder
}

// Size of each bucket
func (builder *VisualizationV2Builder) BucketSize(bucketSize int32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).BucketSize = &bucketSize

	return builder
}

// Offset buckets by this amount
func (builder *VisualizationV2Builder) BucketOffset(bucketOffset float32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).BucketOffset = &bucketOffset
...
func (builder *VisualizationV2Builder) Combine(combine bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Combine = &combine
