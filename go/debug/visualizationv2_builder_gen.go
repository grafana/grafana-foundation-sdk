...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("debug.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) Mode(mode DebugMode) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) Counters(counters cog.Builder[UpdateConfig]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
