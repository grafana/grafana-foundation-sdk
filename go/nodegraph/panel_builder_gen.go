...
func (builder *PanelBuilder) Build() (dashboard.Panel, error) {
	...
	if len(builder.errors) > 0 {
		return dashboard.Panel{}, cog.MakeBuildErrors("nodegraph.panel", builder.errors)
	}
...
func (builder *PanelBuilder) ZoomMode(zoomMode ZoomMode) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = NewOptions()
	}
	builder.internal.Options.(*Options).ZoomMode = &zoomMode
