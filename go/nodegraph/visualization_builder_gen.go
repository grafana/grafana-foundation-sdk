...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("nodegraph.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) LayoutAlgorithm(layoutAlgorithm LayoutAlgorithm) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).LayoutAlgorithm = &layoutAlgorithm
