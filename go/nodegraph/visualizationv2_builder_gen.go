...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("nodegraph.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) Nodes(nodes cog.Builder[NodeOptions]) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) Edges(edges cog.Builder[EdgeOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) ZoomMode(zoomMode ZoomMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
