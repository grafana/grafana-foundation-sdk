...
func VisualizationConverter(input dashboardv2beta1.VizConfigKind) string {
	calls := []string{
		`nodegraph.NewVisualizationBuilder()`,
	}
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).Nodes != nil {

		buffer.WriteString(`Nodes(`)
		arg0 := NodeOptionsConverter(*input.Spec.Options.(*Options).Nodes)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).Edges != nil {

		buffer.WriteString(`Edges(`)
		arg0 := EdgeOptionsConverter(*input.Spec.Options.(*Options).Edges)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).ZoomMode != nil {

		buffer.WriteString(`ZoomMode(`)
		arg0 := cog.Dump(*input.Spec.Options.(*Options).ZoomMode)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).LayoutAlgorithm != nil {

		buffer.WriteString(`LayoutAlgorithm(`)
		arg0 := cog.Dump(*input.Spec.Options.(*Options).LayoutAlgorithm)
		buffer.WriteString(arg0)
