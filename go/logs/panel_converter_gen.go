...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil {
		...
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowLabels)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowCommonLabels)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowLogContextToggle)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).WrapLogMessage)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).PrettifyLogMessage)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).EnableLogDetails)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).DedupStrategy)
		buffer.WriteString(arg0)
