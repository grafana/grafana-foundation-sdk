...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("logs.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) ShowLabels(showLabels bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowLabels = showLabels

	return builder
}

func (builder *VisualizationV2Builder) ShowCommonLabels(showCommonLabels bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowCommonLabels = showCommonLabels

	return builder
}

func (builder *VisualizationV2Builder) ShowTime(showTime bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowTime = showTime

	return builder
}

func (builder *VisualizationV2Builder) ShowLogContextToggle(showLogContextToggle bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowLogContextToggle = showLogContextToggle

	return builder
}

func (builder *VisualizationV2Builder) WrapLogMessage(wrapLogMessage bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).WrapLogMessage = wrapLogMessage

	return builder
}

func (builder *VisualizationV2Builder) PrettifyLogMessage(prettifyLogMessage bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).PrettifyLogMessage = prettifyLogMessage

	return builder
}

func (builder *VisualizationV2Builder) EnableLogDetails(enableLogDetails bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).EnableLogDetails = enableLogDetails

	return builder
}

func (builder *VisualizationV2Builder) SortOrder(sortOrder common.LogsSortOrder) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).SortOrder = sortOrder

	return builder
}

func (builder *VisualizationV2Builder) DedupStrategy(dedupStrategy common.LogsDedupStrategy) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).DedupStrategy = dedupStrategy

	return builder
}

func (builder *VisualizationV2Builder) EnableInfiniteScrolling(enableInfiniteScrolling bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).EnableInfiniteScrolling = &enableInfiniteScrolling

	return builder
}

// Display controls to jump to the last or first log line, and filters by log level.
func (builder *VisualizationV2Builder) ShowControls(showControls bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) ShowFieldSelector(showFieldSelector bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) SyntaxHighlighting(syntaxHighlighting bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) FontSize(fontSize OptionsFontSize) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) DetailsMode(detailsMode OptionsDetailsMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
