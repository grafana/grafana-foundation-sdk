...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("logs.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) ShowLabels(showLabels bool) *VisualizationBuilder {
...
func (builder *VisualizationBuilder) ShowTime(showTime bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) ShowLogContextToggle(showLogContextToggle bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) ControlsStorageKey(controlsStorageKey string) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ControlsStorageKey = &controlsStorageKey

	return builder
}

func (builder *VisualizationBuilder) WrapLogMessage(wrapLogMessage bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) PrettifyLogMessage(prettifyLogMessage bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) DedupStrategy(dedupStrategy common.LogsDedupStrategy) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) EnableInfiniteScrolling(enableInfiniteScrolling bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) OnLogOptionsChange(onLogOptionsChange any) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).OnLogOptionsChange = &onLogOptionsChange
