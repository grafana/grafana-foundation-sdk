...
func (builder *OptionsBuilder) LogRowMenuIconsBefore(logRowMenuIconsBefore any) *OptionsBuilder {
	builder.internal.LogRowMenuIconsBefore = &logRowMenuIconsBefore

	return builder
}

func (builder *OptionsBuilder) LogRowMenuIconsAfter(logRowMenuIconsAfter any) *OptionsBuilder {
	builder.internal.LogRowMenuIconsAfter = &logRowMenuIconsAfter
