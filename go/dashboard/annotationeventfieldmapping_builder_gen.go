...
func (builder *AnnotationEventFieldMappingBuilder) Build() (AnnotationEventFieldMapping, error) {
	...
	if len(builder.errors) > 0 {
		return AnnotationEventFieldMapping{}, cog.MakeBuildErrors("dashboard.annotationEventFieldMapping", builder.errors)
	}

	return *builder.internal, nil
}

func (builder *AnnotationEventFieldMappingBuilder) RecordError(path string, err error) *AnnotationEventFieldMappingBuilder {
	builder.errors = append(builder.errors, cog.MakeBuildErrors(path, err)...)
	return builder
}

// Source type for the field value.
func (builder *AnnotationEventFieldMappingBuilder) Source(source AnnotationEventFieldSource) *AnnotationEventFieldMappingBuilder {
