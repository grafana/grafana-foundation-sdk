...
func DashboardMetaConverter(input DashboardMeta) string {
	...
	if input.PublicDashboardAccessToken != nil && *input.PublicDashboardAccessToken != "" {

		buffer.WriteString(`PublicDashboardAccessToken(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.PublicDashboardAccessToken))
		buffer.WriteString(arg0)
