...
```go
func (builder *CustomVariableBuilder) Current(current dashboardv2.VariableOption) *CustomVariableBuilder
```
...
```go
func (builder *CustomVariableBuilder) Hide(hide dashboardv2.VariableHide) *CustomVariableBuilder
```
...
```go
func (builder *CustomVariableBuilder) Options(options []dashboardv2.VariableOption) *CustomVariableBuilder
```

### <span class="badge object-method"></span> Origin

```go
func (builder *CustomVariableBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *CustomVariableBuilder
```
...
```go
func (builder *CustomVariableBuilder) ValuesFormat(valuesFormat dashboardv2.CustomVariableSpecValuesFormat) *CustomVariableBuilder
```
