...
```go
type Action struct {
    Type dashboardv2.ActionType `json:"type"`
    Title string `json:"title"`
    Fetch *dashboardv2.FetchOptions `json:"fetch,omitempty"`
    Infinity *dashboardv2.InfinityOptions `json:"infinity,omitempty"`
    Confirmation *string `json:"confirmation,omitempty"`
    OneClick *bool `json:"oneClick,omitempty"`
    Variables []dashboardv2.ActionVariable `json:"variables,omitempty"`
    Style *dashboardv2.Dashboardv2ActionStyle `json:"style,omitempty"`
}
```
## Methods
