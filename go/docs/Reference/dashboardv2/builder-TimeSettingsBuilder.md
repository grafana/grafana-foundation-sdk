...
```go
func (builder *TimeSettingsBuilder) QuickRanges(quickRanges []cog.Builder[dashboardv2.TimeRangeOption]) *TimeSettingsBuilder
```
...
```go
func (builder *TimeSettingsBuilder) WeekStart(weekStart dashboardv2.TimeSettingsSpecWeekStart) *TimeSettingsBuilder
```
