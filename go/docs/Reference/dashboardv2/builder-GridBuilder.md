...
```go
func (builder *GridBuilder) Item(item cog.Builder[dashboardv2.GridLayoutItemKind]) *GridBuilder
```

### <span class="badge object-method"></span> Items

```go
func (builder *GridBuilder) Items(items []cog.Builder[dashboardv2.GridLayoutItemKind]) *GridBuilder
```
