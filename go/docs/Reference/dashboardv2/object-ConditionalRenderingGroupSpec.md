...
type ConditionalRenderingGroupSpec struct {
    Visibility dashboardv2.ConditionalRenderingGroupSpecVisibility `json:"visibility"`
    Condition dashboardv2.ConditionalRenderingGroupSpecCondition `json:"condition"`
    Items []dashboardv2.ConditionalRenderingVariableKindOrConditionalRenderingDataKindOrConditionalRenderingTimeRangeSizeKind `json:"items"`
}
```
## Methods
