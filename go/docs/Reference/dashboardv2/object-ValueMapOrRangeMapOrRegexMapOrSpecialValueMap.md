...
type ValueMapOrRangeMapOrRegexMapOrSpecialValueMap struct {
    ValueMap *dashboardv2.ValueMap `json:"ValueMap,omitempty"`
    RangeMap *dashboardv2.RangeMap `json:"RangeMap,omitempty"`
    RegexMap *dashboardv2.RegexMap `json:"RegexMap,omitempty"`
    SpecialValueMap *dashboardv2.SpecialValueMap `json:"SpecialValueMap,omitempty"`
}
```
## Methods
