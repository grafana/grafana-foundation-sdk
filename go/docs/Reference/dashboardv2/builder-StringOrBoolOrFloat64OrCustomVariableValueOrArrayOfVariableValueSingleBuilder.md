---
title: <span class="badge builder"></span> StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingleBuilder
---
# <span class="badge builder"></span> StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingleBuilder
...
```go
func (builder *StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingleBuilder) ArrayOfVariableValueSingle(arrayOfVariableValueSingle []cog.Builder[dashboardv2.VariableValueSingle]) *StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingleBuilder
```
...
```go
func (builder *StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingleBuilder) CustomVariableValue(customVariableValue dashboardv2.CustomVariableValue) *StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingleBuilder
```
