...
```go
func (builder *LibraryPanelBuilder) Id(id int32) *LibraryPanelBuilder
```

### <span class="badge object-method"></span> LibraryPanel

```go
func (builder *LibraryPanelBuilder) LibraryPanel(libraryPanel cog.Builder[dashboardv2.LibraryPanelRef]) *LibraryPanelBuilder
```
