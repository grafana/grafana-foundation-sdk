...
```go
func (builder *IntervalVariableBuilder) Current(current dashboardv2.VariableOption) *IntervalVariableBuilder
```
...
```go
func (builder *IntervalVariableBuilder) Hide(hide dashboardv2.VariableHide) *IntervalVariableBuilder
```
...
```go
func (builder *IntervalVariableBuilder) Options(options []dashboardv2.VariableOption) *IntervalVariableBuilder
```

### <span class="badge object-method"></span> Origin

```go
func (builder *IntervalVariableBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *IntervalVariableBuilder
```
