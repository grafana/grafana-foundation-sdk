...
```go
func (builder *RowsBuilder) Row(row cog.Builder[dashboardv2.RowsLayoutRowKind]) *RowsBuilder
```

### <span class="badge object-method"></span> Rows

```go
func (builder *RowsBuilder) Rows(rows []cog.Builder[dashboardv2.RowsLayoutRowKind]) *RowsBuilder
```
