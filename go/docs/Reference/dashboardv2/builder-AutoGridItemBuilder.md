...
```go
func (builder *AutoGridItemBuilder) ConditionalRendering(conditionalRendering cog.Builder[dashboardv2.ConditionalRenderingGroupKind]) *AutoGridItemBuilder
```
...
```go
func (builder *AutoGridItemBuilder) Repeat(repeat cog.Builder[dashboardv2.AutoGridRepeatOptions]) *AutoGridItemBuilder
```
