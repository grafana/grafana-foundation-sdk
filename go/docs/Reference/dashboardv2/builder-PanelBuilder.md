...
```go
func (builder *PanelBuilder) Data(data cog.Builder[dashboardv2.QueryGroupKind]) *PanelBuilder
```
...
```go
func (builder *PanelBuilder) Id(id int32) *PanelBuilder
```

### <span class="badge object-method"></span> Links

```go
func (builder *PanelBuilder) Links(links []cog.Builder[dashboardv2.DataLink]) *PanelBuilder
```
...
```go
func (builder *PanelBuilder) Visualization(vizConfig cog.Builder[dashboardv2.VizConfigKind]) *PanelBuilder
```
