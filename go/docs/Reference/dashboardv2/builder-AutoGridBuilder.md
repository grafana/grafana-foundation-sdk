...
```go
func (builder *AutoGridBuilder) ColumnWidthMode(columnWidthMode dashboardv2.AutoGridLayoutSpecColumnWidthMode) *AutoGridBuilder
```
...
```go
func (builder *AutoGridBuilder) Item(item cog.Builder[dashboardv2.AutoGridLayoutItemKind]) *AutoGridBuilder
```

### <span class="badge object-method"></span> Items

```go
func (builder *AutoGridBuilder) Items(items []cog.Builder[dashboardv2.AutoGridLayoutItemKind]) *AutoGridBuilder
```
...
```go
func (builder *AutoGridBuilder) RowHeightMode(rowHeightMode dashboardv2.AutoGridLayoutSpecRowHeightMode) *AutoGridBuilder
```
