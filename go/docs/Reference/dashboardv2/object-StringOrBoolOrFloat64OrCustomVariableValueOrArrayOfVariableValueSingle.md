...
type StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingle struct {
    ...
    CustomVariableValue *dashboardv2.CustomVariableValue `json:"CustomVariableValue,omitempty"`
    ArrayOfVariableValueSingle []dashboardv2.VariableValueSingle `json:"ArrayOfVariableValueSingle,omitempty"`
}
```
## Methods
