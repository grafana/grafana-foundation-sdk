...
```go
func (builder *FieldColorBuilder) Mode(mode dashboardv2.FieldColorModeId) *FieldColorBuilder
```
...
```go
func (builder *FieldColorBuilder) SeriesBy(seriesBy dashboardv2.FieldColorSeriesByMode) *FieldColorBuilder
```
