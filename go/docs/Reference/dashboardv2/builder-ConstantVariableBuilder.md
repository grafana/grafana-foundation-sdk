...
```go
func (builder *ConstantVariableBuilder) Current(current dashboardv2.VariableOption) *ConstantVariableBuilder
```
...
```go
func (builder *ConstantVariableBuilder) Hide(hide dashboardv2.VariableHide) *ConstantVariableBuilder
```
...
```go
func (builder *ConstantVariableBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *ConstantVariableBuilder
```
