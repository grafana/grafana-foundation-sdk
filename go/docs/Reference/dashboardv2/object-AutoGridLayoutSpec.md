...
type AutoGridLayoutSpec struct {
    ...
    ColumnWidthMode dashboardv2.AutoGridLayoutSpecColumnWidthMode `json:"columnWidthMode"`
    ColumnWidth *float64 `json:"columnWidth,omitempty"`
    RowHeightMode dashboardv2.AutoGridLayoutSpecRowHeightMode `json:"rowHeightMode"`
    RowHeight *float64 `json:"rowHeight,omitempty"`
    FillScreen *bool `json:"fillScreen,omitempty"`
    Items []dashboardv2.AutoGridLayoutItemKind `json:"items"`
}
```
## Methods
