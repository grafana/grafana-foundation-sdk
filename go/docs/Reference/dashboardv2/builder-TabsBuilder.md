...
```go
func (builder *TabsBuilder) Tab(tab cog.Builder[dashboardv2.TabsLayoutTabKind]) *TabsBuilder
```

### <span class="badge object-method"></span> Tabs

```go
func (builder *TabsBuilder) Tabs(tabs []cog.Builder[dashboardv2.TabsLayoutTabKind]) *TabsBuilder
```
