...
```go
func (builder *QueryVariableBuilder) Current(current dashboardv2.VariableOption) *QueryVariableBuilder
```
...
```go
func (builder *QueryVariableBuilder) Hide(hide dashboardv2.VariableHide) *QueryVariableBuilder
```
...
```go
func (builder *QueryVariableBuilder) Options(options []dashboardv2.VariableOption) *QueryVariableBuilder
```

### <span class="badge object-method"></span> Origin

```go
func (builder *QueryVariableBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *QueryVariableBuilder
```
...
```go
func (builder *QueryVariableBuilder) Query(query cog.Builder[dashboardv2.DataQueryKind]) *QueryVariableBuilder
```

### <span class="badge object-method"></span> Refresh

```go
func (builder *QueryVariableBuilder) Refresh(refresh dashboardv2.VariableRefresh) *QueryVariableBuilder
```
...
```go
func (builder *QueryVariableBuilder) RegexApplyTo(regexApplyTo dashboardv2.VariableRegexApplyTo) *QueryVariableBuilder
```
...
```go
func (builder *QueryVariableBuilder) Sort(sort dashboardv2.VariableSort) *QueryVariableBuilder
```

### <span class="badge object-method"></span> StaticOptions

```go
func (builder *QueryVariableBuilder) StaticOptions(staticOptions []dashboardv2.VariableOption) *QueryVariableBuilder
```

### <span class="badge object-method"></span> StaticOptionsOrder

```go
func (builder *QueryVariableBuilder) StaticOptionsOrder(staticOptionsOrder dashboardv2.QueryVariableSpecStaticOptionsOrder) *QueryVariableBuilder
```
