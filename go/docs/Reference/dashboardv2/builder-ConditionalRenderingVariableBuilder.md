...
```go
func (builder *ConditionalRenderingVariableBuilder) Operator(operator dashboardv2.ConditionalRenderingVariableSpecOperator) *ConditionalRenderingVariableBuilder
```
