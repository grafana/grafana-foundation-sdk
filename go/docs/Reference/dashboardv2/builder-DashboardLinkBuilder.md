...
```go
func (builder *DashboardLinkBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *DashboardLinkBuilder
```
...
```go
func (builder *DashboardLinkBuilder) Type(typeArg dashboardv2.DashboardLinkType) *DashboardLinkBuilder
```
