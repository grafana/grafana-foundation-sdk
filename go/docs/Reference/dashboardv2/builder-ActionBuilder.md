...
```go
func (builder *ActionBuilder) Fetch(fetch cog.Builder[dashboardv2.FetchOptions]) *ActionBuilder
```

### <span class="badge object-method"></span> Infinity

```go
func (builder *ActionBuilder) Infinity(infinity cog.Builder[dashboardv2.InfinityOptions]) *ActionBuilder
```
...
```go
func (builder *ActionBuilder) Style(style cog.Builder[dashboardv2.Dashboardv2ActionStyle]) *ActionBuilder
```
...
```go
func (builder *ActionBuilder) Type(typeArg dashboardv2.ActionType) *ActionBuilder
```

### <span class="badge object-method"></span> Variables

```go
func (builder *ActionBuilder) Variables(variables []cog.Builder[dashboardv2.ActionVariable]) *ActionBuilder
```
