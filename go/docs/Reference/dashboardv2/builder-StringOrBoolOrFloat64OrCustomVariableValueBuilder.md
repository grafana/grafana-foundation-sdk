...
```go
func (builder *StringOrBoolOrFloat64OrCustomVariableValueBuilder) CustomVariableValue(customVariableValue dashboardv2.CustomVariableValue) *StringOrBoolOrFloat64OrCustomVariableValueBuilder
```
