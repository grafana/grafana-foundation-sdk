...
```go
func (builder *DatasourceVariableBuilder) Current(current dashboardv2.VariableOption) *DatasourceVariableBuilder
```
...
```go
func (builder *DatasourceVariableBuilder) Hide(hide dashboardv2.VariableHide) *DatasourceVariableBuilder
```
...
```go
func (builder *DatasourceVariableBuilder) Options(options []dashboardv2.VariableOption) *DatasourceVariableBuilder
```

### <span class="badge object-method"></span> Origin

```go
func (builder *DatasourceVariableBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *DatasourceVariableBuilder
```
...
```go
func (builder *DatasourceVariableBuilder) Refresh(refresh dashboardv2.VariableRefresh) *DatasourceVariableBuilder
```
