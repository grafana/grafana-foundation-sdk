...
```go
func (builder *VizConfigKindBuilder) Actions(actions []cog.Builder[dashboardv2.Action]) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) ColorScheme(color cog.Builder[dashboardv2.FieldColor]) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) Defaults(defaults dashboardv2.FieldConfig) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) FieldConfig(fieldConfig dashboardv2.FieldConfigSource) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) Mappings(mappings []dashboardv2.ValueMapping) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) NullValueMode(nullValueMode dashboardv2.NullValueMode) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) Override(matcher dashboardv2.MatcherConfig, properties []dashboardv2.DynamicConfigValue) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) OverrideByFieldType(fieldType string, properties []dashboardv2.DynamicConfigValue) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) OverrideByName(name string, properties []dashboardv2.DynamicConfigValue) *VizConfigKindBuilder
```

### <span class="badge object-method"></span> OverrideByQuery

```go
func (builder *VizConfigKindBuilder) OverrideByQuery(queryRefId string, properties []dashboardv2.DynamicConfigValue) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) OverrideByRegexp(regexp string, properties []dashboardv2.DynamicConfigValue) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) Overrides(overrides []cog.Builder[dashboardv2.Dashboardv2FieldConfigSourceOverrides]) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) Spec(spec dashboardv2.VizConfigSpec) *VizConfigKindBuilder
```
...
```go
func (builder *VizConfigKindBuilder) Thresholds(thresholds cog.Builder[dashboardv2.ThresholdsConfig]) *VizConfigKindBuilder
```
