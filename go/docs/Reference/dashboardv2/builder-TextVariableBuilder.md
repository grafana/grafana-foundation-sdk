...
```go
func (builder *TextVariableBuilder) Current(current dashboardv2.VariableOption) *TextVariableBuilder
```
...
```go
func (builder *TextVariableBuilder) Hide(hide dashboardv2.VariableHide) *TextVariableBuilder
```
...
```go
func (builder *TextVariableBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *TextVariableBuilder
```
