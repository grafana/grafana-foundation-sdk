...
```go
func (builder *SwitchVariableBuilder) Hide(hide dashboardv2.VariableHide) *SwitchVariableBuilder
```
...
```go
func (builder *SwitchVariableBuilder) Origin(origin cog.Builder[dashboardv2.ControlSourceRef]) *SwitchVariableBuilder
```
