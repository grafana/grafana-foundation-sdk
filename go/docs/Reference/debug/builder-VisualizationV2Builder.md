...
```go
func (builder *VisualizationV2Builder) Counters(counters cog.Builder[debug.UpdateConfig]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Mode(mode debug.DebugMode) *VisualizationV2Builder
```
