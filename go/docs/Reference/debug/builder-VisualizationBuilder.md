...
```go
func (builder *VisualizationBuilder) Counters(counters cog.Builder[debug.UpdateConfig]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Mode(mode debug.DebugMode) *VisualizationBuilder
```
