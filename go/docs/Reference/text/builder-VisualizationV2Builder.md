...
```go
func (builder *VisualizationV2Builder) Code(code cog.Builder[text.CodeOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Mode(mode text.TextMode) *VisualizationV2Builder
```
