...
```go
func (builder *VisualizationV2Builder) DetailsMode(detailsMode logs.OptionsDetailsMode) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) FontSize(fontSize logs.OptionsFontSize) *VisualizationV2Builder
```
