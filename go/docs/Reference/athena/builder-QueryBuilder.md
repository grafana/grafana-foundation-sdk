...
```go
func (builder *QueryBuilder) ConnectionArgs(connectionArgs cog.Builder[athena.ConnectionArgs]) *QueryBuilder
```
...
```go
func (builder *QueryBuilder) Format(format athena.FormatOptions) *QueryBuilder
```
