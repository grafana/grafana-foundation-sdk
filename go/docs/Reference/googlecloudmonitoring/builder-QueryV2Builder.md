...
```go
func (builder *QueryV2Builder) PromQLQuery(promQLQuery cog.Builder[googlecloudmonitoring.PromQLQuery]) *QueryV2Builder
```
...
```go
func (builder *QueryV2Builder) SloQuery(sloQuery cog.Builder[googlecloudmonitoring.SLOQuery]) *QueryV2Builder
```
...
```go
func (builder *QueryV2Builder) TimeSeriesList(timeSeriesList cog.Builder[googlecloudmonitoring.TimeSeriesList]) *QueryV2Builder
```
...
```go
func (builder *QueryV2Builder) TimeSeriesQuery(timeSeriesQuery cog.Builder[googlecloudmonitoring.TimeSeriesQuery]) *QueryV2Builder
```
