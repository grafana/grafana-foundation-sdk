...
```go
func (builder *VisualizationV2Builder) InsertNulls(insertNulls statetimeline.BoolOrUint32) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) SpanNulls(spanNulls statetimeline.BoolOrUint32) *VisualizationV2Builder
```
