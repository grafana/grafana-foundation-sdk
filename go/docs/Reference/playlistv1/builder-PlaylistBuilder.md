...
```go
func (builder *PlaylistBuilder) Item(item cog.Builder[playlistv1.Item]) *PlaylistBuilder
```

### <span class="badge object-method"></span> Items

```go
func (builder *PlaylistBuilder) Items(items []cog.Builder[playlistv1.Item]) *PlaylistBuilder
```
