...
```go
func (builder *VisualizationBuilder) Mapping(mapping xychart.SeriesMapping) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) PointShape(pointShape xychart.PointShape) *VisualizationBuilder
```

### <span class="badge object-method"></span> PointSize

```go
func (builder *VisualizationBuilder) PointSize(pointSize cog.Builder[xychart.XychartFieldConfigPointSize]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Series(series []cog.Builder[xychart.XYSeriesConfig]) *VisualizationBuilder
```

### <span class="badge object-method"></span> Show

```go
func (builder *VisualizationBuilder) Show(show xychart.XYShowMode) *VisualizationBuilder
```
