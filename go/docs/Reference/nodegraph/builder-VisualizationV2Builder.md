...
```go
func (builder *VisualizationV2Builder) Edges(edges cog.Builder[nodegraph.EdgeOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Nodes(nodes cog.Builder[nodegraph.NodeOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) ZoomMode(zoomMode nodegraph.ZoomMode) *VisualizationV2Builder
```
