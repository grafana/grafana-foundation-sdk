...
```go
func (builder *VisualizationBuilder) LayoutAlgorithm(layoutAlgorithm nodegraph.LayoutAlgorithm) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) ZoomMode(zoomMode nodegraph.ZoomMode) *VisualizationBuilder
```
