...
```go
func (builder *QueryV2Builder) BucketAggs(bucketAggs []elasticsearch.BucketAggregation) *QueryV2Builder
```
...
```go
func (builder *QueryV2Builder) Metrics(metrics []elasticsearch.MetricAggregation) *QueryV2Builder
```
