...
```go
func (builder *QueryBuilder) BucketAggs(bucketAggs []elasticsearch.BucketAggregation) *QueryBuilder
```
...
```go
func (builder *QueryBuilder) Metrics(metrics []elasticsearch.MetricAggregation) *QueryBuilder
```
