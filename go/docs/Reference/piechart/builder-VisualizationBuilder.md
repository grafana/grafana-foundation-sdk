...
```go
func (builder *VisualizationBuilder) DisplayLabels(displayLabels []piechart.PieChartLabels) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Legend(legend cog.Builder[piechart.PieChartLegendOptions]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) PieType(pieType piechart.PieChartType) *VisualizationBuilder
```
