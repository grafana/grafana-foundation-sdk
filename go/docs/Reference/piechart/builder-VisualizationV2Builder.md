...
```go
func (builder *VisualizationV2Builder) DisplayLabels(displayLabels []piechart.PieChartLabels) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Legend(legend cog.Builder[piechart.PieChartLegendOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) PieType(pieType piechart.PieChartType) *VisualizationV2Builder
```
