...
```go
func (builder *VisualizationV2Builder) CandleStyle(candleStyle candlestick.CandleStyle) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) ColorStrategy(colorStrategy candlestick.ColorStrategy) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Colors(colors cog.Builder[candlestick.CandlestickColors]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Fields(fields cog.Builder[candlestick.CandlestickFieldMap]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Mode(mode candlestick.VizDisplayMode) *VisualizationV2Builder
```
