...
```go
func (builder *VisualizationV2Builder) CellValues(cellValues cog.Builder[heatmap.CellValues]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Color(color cog.Builder[heatmap.HeatmapColorOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Exemplars(exemplars cog.Builder[heatmap.ExemplarConfig]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) FilterValues(filterValues cog.Builder[heatmap.FilterValueRange]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Legend(legend cog.Builder[heatmap.HeatmapLegend]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) RowsFrame(rowsFrame cog.Builder[heatmap.RowsHeatmapOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) SelectionMode(selectionMode heatmap.HeatmapSelectionMode) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Tooltip(tooltip cog.Builder[heatmap.HeatmapTooltip]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) YAxis(yAxis cog.Builder[heatmap.YAxisConfig]) *VisualizationV2Builder
```
