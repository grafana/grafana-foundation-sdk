...
```go
func (builder *VisualizationBuilder) CellValues(cellValues cog.Builder[heatmap.CellValues]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Color(color cog.Builder[heatmap.HeatmapColorOptions]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Exemplars(exemplars cog.Builder[heatmap.ExemplarConfig]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) FilterValues(filterValues cog.Builder[heatmap.FilterValueRange]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Legend(legend cog.Builder[heatmap.HeatmapLegend]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) RowsFrame(rowsFrame cog.Builder[heatmap.RowsHeatmapOptions]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) SelectionMode(selectionMode heatmap.HeatmapSelectionMode) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Tooltip(tooltip cog.Builder[heatmap.HeatmapTooltip]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) YAxis(yAxis cog.Builder[heatmap.YAxisConfig]) *VisualizationBuilder
```
