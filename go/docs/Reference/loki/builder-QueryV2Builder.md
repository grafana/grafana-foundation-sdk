...
```go
func (builder *QueryV2Builder) Direction(direction loki.LokiQueryDirection) *QueryV2Builder
```

### <span class="badge object-method"></span> EditorMode

```go
func (builder *QueryV2Builder) EditorMode(editorMode loki.QueryEditorMode) *QueryV2Builder
```
