---
title: <span class="badge object-type-struct"></span> LogsQuery
---
# <span class="badge object-type-struct"></span> LogsQuery
...
```go
func (logsQuery *LogsQuery) UnmarshalJSONStrict(raw []byte) error
```
...
```go
func (logsQuery *LogsQuery) Equals(other LogsQuery) bool
```
...
```go
func (logsQuery *LogsQuery) Validate() error
```
