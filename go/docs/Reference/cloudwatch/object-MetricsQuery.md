---
title: <span class="badge object-type-struct"></span> MetricsQuery
---
# <span class="badge object-type-struct"></span> MetricsQuery
...
type MetricsQuery struct {
    ...
    QueryMode cloudwatch.QueryMode `json:"queryMode"`
...
```go
func (metricsQuery *MetricsQuery) UnmarshalJSONStrict(raw []byte) error
```
...
```go
func (metricsQuery *MetricsQuery) Equals(other MetricsQuery) bool
```
...
```go
func (metricsQuery *MetricsQuery) Validate() error
```
