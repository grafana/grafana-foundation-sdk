...
type ValueMapOrRangeMapOrRegexMapOrSpecialValueMap struct {
    ValueMap *dashboardv2beta1.ValueMap `json:"ValueMap,omitempty"`
    RangeMap *dashboardv2beta1.RangeMap `json:"RangeMap,omitempty"`
    RegexMap *dashboardv2beta1.RegexMap `json:"RegexMap,omitempty"`
    SpecialValueMap *dashboardv2beta1.SpecialValueMap `json:"SpecialValueMap,omitempty"`
}
```
## Methods
