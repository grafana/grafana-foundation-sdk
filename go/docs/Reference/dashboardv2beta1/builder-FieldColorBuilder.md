...
```go
func (builder *FieldColorBuilder) Mode(mode dashboardv2beta1.FieldColorModeId) *FieldColorBuilder
```
...
```go
func (builder *FieldColorBuilder) SeriesBy(seriesBy dashboardv2beta1.FieldColorSeriesByMode) *FieldColorBuilder
```
