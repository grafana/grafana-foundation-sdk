...
```go
func (builder *VisualizationV2Builder) Controls(controls cog.Builder[geomap.ControlsOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) Tooltip(tooltip cog.Builder[geomap.TooltipOptions]) *VisualizationV2Builder
```
...
```go
func (builder *VisualizationV2Builder) View(view cog.Builder[geomap.MapViewConfig]) *VisualizationV2Builder
```
