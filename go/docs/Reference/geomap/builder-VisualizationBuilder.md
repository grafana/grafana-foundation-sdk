...
```go
func (builder *VisualizationBuilder) Controls(controls cog.Builder[geomap.ControlsOptions]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) Tooltip(tooltip cog.Builder[geomap.TooltipOptions]) *VisualizationBuilder
```
...
```go
func (builder *VisualizationBuilder) View(view cog.Builder[geomap.MapViewConfig]) *VisualizationBuilder
```
