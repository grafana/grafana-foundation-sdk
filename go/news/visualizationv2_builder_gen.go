...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("news.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) FeedUrl(feedUrl string) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) ShowImage(showImage bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
