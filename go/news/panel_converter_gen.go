...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).FeedUrl != nil && *input.Options.(*Options).FeedUrl != "" {

		buffer.WriteString(`FeedUrl(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).FeedUrl))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowImage != nil && *input.Options.(*Options).ShowImage != true {

		buffer.WriteString(`ShowImage(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).ShowImage))
		buffer.WriteString(arg0)
