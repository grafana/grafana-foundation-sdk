...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "datagrid"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("datagrid.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) SelectedSeries(selectedSeries int32) *VisualizationV2Builder {
