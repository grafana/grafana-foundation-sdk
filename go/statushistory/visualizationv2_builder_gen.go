...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "status-history"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("statushistory.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) RowHeight(rowHeight float32) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) ColWidth(colWidth float64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ColWidth = &colWidth
