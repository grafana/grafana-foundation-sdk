...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("statushistory.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) RowHeight(rowHeight float32) *VisualizationBuilder {
...
func (builder *VisualizationBuilder) ColWidth(colWidth float64) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
