...
func TypeReduceConverter(input TypeReduce) string {
	...
	if input.ResultAssertions != nil {
		...
		arg0 := ExprTypeReduceResultAssertionsConverter(*input.ResultAssertions)
		buffer.WriteString(arg0)
	...
	if input.Settings != nil {
		...
		arg0 := ExprTypeReduceSettingsConverter(*input.Settings)
		buffer.WriteString(arg0)
	...
	if input.TimeRange != nil {
		...
		arg0 := ExprTypeReduceTimeRangeConverter(*input.TimeRange)
		buffer.WriteString(arg0)
