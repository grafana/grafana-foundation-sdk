...
func (builder *ExprTypeClassicConditionsConditionsEvaluatorBuilder) RecordError(path string, err error) *ExprTypeClassicConditionsConditionsEvaluatorBuilder {
