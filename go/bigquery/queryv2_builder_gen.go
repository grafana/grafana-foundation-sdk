...
func (builder *QueryV2Builder) Build() (dashboardv2.DataQueryKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.DataQueryKind{}, cog.MakeBuildErrors("bigquery.queryV2", builder.errors)
	}
...
func (builder *QueryV2Builder) Format(format QueryFormat) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
...
func (builder *QueryV2Builder) QueryPriority(queryPriority QueryPriority) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
...
func (builder *QueryV2Builder) EditorMode(editorMode EditorMode) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
...
func (builder *QueryV2Builder) Sql(sql cog.Builder[SQLExpression]) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
