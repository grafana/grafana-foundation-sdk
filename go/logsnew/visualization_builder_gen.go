...
func NewVisualizationBuilder() *VisualizationBuilder {
	...
	builder.internal.Group = "logsnew"
...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("logsnew.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) Grammar(grammar any) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Grammar = &grammar
