...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).NamePlacement)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).MinVizWidth != 8 {
	...
	if input.Options != nil && input.Options.(*Options).MinVizHeight != 16 {
	...
	if input.Options != nil && input.Options.(*Options).MaxVizHeight != 300 {

		buffer.WriteString(`MaxVizHeight(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).MaxVizHeight)
		buffer.WriteString(arg0)
