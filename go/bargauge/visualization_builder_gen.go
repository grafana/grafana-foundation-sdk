...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("bargauge.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) DisplayMode(displayMode common.BarGaugeDisplayMode) *VisualizationBuilder {
...
func (builder *VisualizationBuilder) ValueMode(valueMode common.BarGaugeValueMode) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) NamePlacement(namePlacement common.BarGaugeNamePlacement) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) ShowUnfilled(showUnfilled bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) Sizing(sizing common.BarGaugeSizing) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) MinVizWidth(minVizWidth uint32) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) MinVizHeight(minVizHeight uint32) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) ReduceOptions(reduceOptions cog.Builder[common.ReduceDataOptions]) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) MaxVizHeight(maxVizHeight uint32) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
