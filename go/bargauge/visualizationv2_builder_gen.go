...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "bargauge"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("bargauge.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) DisplayMode(displayMode common.BarGaugeDisplayMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).DisplayMode = displayMode

	return builder
}

func (builder *VisualizationV2Builder) ValueMode(valueMode common.BarGaugeValueMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ValueMode = valueMode

	return builder
}

func (builder *VisualizationV2Builder) NamePlacement(namePlacement common.BarGaugeNamePlacement) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).NamePlacement = namePlacement

	return builder
}

func (builder *VisualizationV2Builder) ShowUnfilled(showUnfilled bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowUnfilled = showUnfilled

	return builder
}

func (builder *VisualizationV2Builder) Sizing(sizing common.BarGaugeSizing) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Sizing = sizing

	return builder
}

func (builder *VisualizationV2Builder) MinVizWidth(minVizWidth uint32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).MinVizWidth = minVizWidth

	return builder
}

func (builder *VisualizationV2Builder) MinVizHeight(minVizHeight uint32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).MinVizHeight = minVizHeight
...
func (builder *VisualizationV2Builder) ReduceOptions(reduceOptions cog.Builder[common.ReduceDataOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).ReduceOptions = reduceOptionsResource
...
func (builder *VisualizationV2Builder) MaxVizHeight(maxVizHeight uint32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).MaxVizHeight = maxVizHeight
