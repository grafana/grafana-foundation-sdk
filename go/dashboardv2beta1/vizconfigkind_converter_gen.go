...
func VizConfigKindConverter(input VizConfigKind) string {
	calls := []string{
		`dashboardv2beta1.NewVizConfigKindBuilder()`,
	}
...

	{
		...
		arg0 := cog.Dump(input.Spec.FieldConfig)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Writeable != nil {

		buffer.WriteString(`Writeable(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Writeable)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Filterable != nil {

		buffer.WriteString(`Filterable(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Filterable)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Thresholds != nil {
		...
		arg0 := ThresholdsConfigConverter(*input.Spec.FieldConfig.Defaults.Thresholds)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Color != nil {
		...
		arg0 := FieldColorConverter(*input.Spec.FieldConfig.Defaults.Color)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Actions != nil && len(input.Spec.FieldConfig.Defaults.Actions) >= 1 {
		...
		for _, arg1 := range input.Spec.FieldConfig.Defaults.Actions {
			tmpactionsarg1 := ActionConverter(arg1)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil {
		...
		arg0 := cog.Dump(input.Spec.FieldConfig.Defaults.Custom)
		buffer.WriteString(arg0)
...

	{
		...
		arg0 := cog.Dump(input.Spec.FieldConfig.Defaults)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Overrides != nil && len(input.Spec.FieldConfig.Overrides) >= 1 {
		...
		for _, arg1 := range input.Spec.FieldConfig.Overrides {
			tmpoverridesarg1 := Dashboardv2beta1FieldConfigSourceOverridesConverter(arg1)
