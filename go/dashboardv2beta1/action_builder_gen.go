...
func (builder *ActionBuilder) Build() (Action, error) {
	...
	if len(builder.errors) > 0 {
		return Action{}, cog.MakeBuildErrors("dashboardv2beta1.action", builder.errors)
	}
...
func (builder *ActionBuilder) Style(style cog.Builder[Dashboardv2beta1ActionStyle]) *ActionBuilder {
