...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("statetimeline.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) RowHeight(rowHeight float64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).RowHeight = rowHeight

	return builder
}

// Merge equal consecutive values
func (builder *VisualizationV2Builder) MergeValues(mergeValues bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).MergeValues = &mergeValues

	return builder
}

// Controls value alignment on the timelines
func (builder *VisualizationV2Builder) AlignValue(alignValue common.TimelineValueAlignment) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).AlignValue = &alignValue
...
func (builder *VisualizationV2Builder) Timezone(timezone []common.TimeZone) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Timezone = timezone

	return builder
}

// Enables pagination when > 0
func (builder *VisualizationV2Builder) PerPage(perPage float64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).PerPage = &perPage

	return builder
}

func (builder *VisualizationV2Builder) LineWidth(lineWidth uint32) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) SpanNulls(spanNulls BoolOrUint32) *VisualizationV2Builder {
	if builder.internal.Spec.FieldConfig.Defaults.Custom == nil {
		builder.internal.Spec.FieldConfig.Defaults.Custom = NewFieldConfig()
	}
...
func (builder *VisualizationV2Builder) InsertNulls(insertNulls BoolOrUint32) *VisualizationV2Builder {
	if builder.internal.Spec.FieldConfig.Defaults.Custom == nil {
		builder.internal.Spec.FieldConfig.Defaults.Custom = NewFieldConfig()
	}
...
func (builder *VisualizationV2Builder) DisablePagination() *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
