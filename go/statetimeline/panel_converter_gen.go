...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).MergeValues != nil && *input.Options.(*Options).MergeValues != true {
		...
		arg0 := fmt.Sprintf("%#v", *input.Options.(*Options).MergeValues)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).LineWidth != nil && *input.FieldConfig.Defaults.Custom.(*FieldConfig).LineWidth != 0 {
