...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "annolist"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("annotationslist.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) OnlyFromThisDashboard(onlyFromThisDashboard bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).OnlyFromThisDashboard = onlyFromThisDashboard

	return builder
}

func (builder *VisualizationV2Builder) OnlyInTimeRange(onlyInTimeRange bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).OnlyInTimeRange = onlyInTimeRange
...
func (builder *VisualizationV2Builder) Limit(limit uint32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Limit = limit

	return builder
}

func (builder *VisualizationV2Builder) ShowUser(showUser bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowUser = showUser
...
func (builder *VisualizationV2Builder) ShowTags(showTags bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowTags = showTags

	return builder
}

func (builder *VisualizationV2Builder) NavigateToPanel(navigateToPanel bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).NavigateToPanel = navigateToPanel

	return builder
}

func (builder *VisualizationV2Builder) NavigateBefore(navigateBefore string) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).NavigateBefore = navigateBefore

	return builder
}

func (builder *VisualizationV2Builder) NavigateAfter(navigateAfter string) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).NavigateAfter = navigateAfter
