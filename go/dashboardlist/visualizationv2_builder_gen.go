...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "dashlist"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("dashboardlist.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) KeepTime(keepTime bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).KeepTime = keepTime

	return builder
}

func (builder *VisualizationV2Builder) IncludeVars(includeVars bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).IncludeVars = includeVars

	return builder
}

func (builder *VisualizationV2Builder) ShowStarred(showStarred bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowStarred = showStarred

	return builder
}

func (builder *VisualizationV2Builder) ShowRecentlyViewed(showRecentlyViewed bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowRecentlyViewed = showRecentlyViewed

	return builder
}

func (builder *VisualizationV2Builder) ShowSearch(showSearch bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowSearch = showSearch

	return builder
}

func (builder *VisualizationV2Builder) ShowHeadings(showHeadings bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowHeadings = showHeadings

	return builder
}

func (builder *VisualizationV2Builder) ShowFolderNames(showFolderNames bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowFolderNames = showFolderNames

	return builder
}

func (builder *VisualizationV2Builder) MaxItems(maxItems int64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).MaxItems = maxItems

	return builder
}

func (builder *VisualizationV2Builder) Query(query string) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Query = query

	return builder
}

func (builder *VisualizationV2Builder) Tags(tags []string) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Tags = tags

	return builder
}

// folderId is deprecated, and migrated to folderUid on panel init
func (builder *VisualizationV2Builder) FolderId(folderId int64) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).FolderId = &folderId

	return builder
}

func (builder *VisualizationV2Builder) FolderUID(folderUID string) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).FolderUID = &folderUID
