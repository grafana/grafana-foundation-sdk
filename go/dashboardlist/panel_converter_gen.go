...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).KeepTime != false {

		buffer.WriteString(`KeepTime(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).KeepTime)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).IncludeVars != false {

		buffer.WriteString(`IncludeVars(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).IncludeVars)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowStarred != true {

		buffer.WriteString(`ShowStarred(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowStarred)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowRecentlyViewed != false {

		buffer.WriteString(`ShowRecentlyViewed(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowRecentlyViewed)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowSearch != false {

		buffer.WriteString(`ShowSearch(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowSearch)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowHeadings != true {

		buffer.WriteString(`ShowHeadings(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowHeadings)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowFolderNames != true {

		buffer.WriteString(`ShowFolderNames(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowFolderNames)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).MaxItems != 10 {

		buffer.WriteString(`MaxItems(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).MaxItems)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).Query != "" {

		buffer.WriteString(`Query(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).Query)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).FolderId != nil {

		buffer.WriteString(`FolderId(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).FolderId))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).FolderUID != nil && *input.Options.(*Options).FolderUID != "" {

		buffer.WriteString(`FolderUID(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).FolderUID))
		buffer.WriteString(arg0)
