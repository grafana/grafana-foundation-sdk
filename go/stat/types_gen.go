...
func NewOptions() *Options {
	return &Options{
		...
		PercentChangeColorMode: common.PercentChangeColorModeStandard,
	}
}
...
func (resource *Options) UnmarshalJSONStrict(raw []byte) error {
	...
	// Field "showPercentChange"
	if fields["showPercentChange"] != nil {
		if string(fields["showPercentChange"]) != "null" {
			if err := json.Unmarshal(fields["showPercentChange"], &resource.ShowPercentChange); err != nil {
				errs = append(errs, cog.MakeBuildErrors("showPercentChange", err)...)
			}
		} else {
			errs = append(errs, cog.MakeBuildErrors("showPercentChange", errors.New("required field is null"))...)

		}
		delete(fields, "showPercentChange")
	} else {
		errs = append(errs, cog.MakeBuildErrors("showPercentChange", errors.New("required field is missing from input"))...)
	}
	// Field "reduceOptions"
	...
	// Field "percentChangeColorMode"
	if fields["percentChangeColorMode"] != nil {
		if string(fields["percentChangeColorMode"]) != "null" {
			if err := json.Unmarshal(fields["percentChangeColorMode"], &resource.PercentChangeColorMode); err != nil {
				errs = append(errs, cog.MakeBuildErrors("percentChangeColorMode", err)...)
			}
		} else {
			errs = append(errs, cog.MakeBuildErrors("percentChangeColorMode", errors.New("required field is null"))...)

		}
		delete(fields, "percentChangeColorMode")
	} else {
		errs = append(errs, cog.MakeBuildErrors("percentChangeColorMode", errors.New("required field is missing from input"))...)
	}
	// Field "orientation"
...
func (resource Options) Equals(other Options) bool {
	...
	if resource.PercentChangeColorMode != other.PercentChangeColorMode {
		return false
	}
