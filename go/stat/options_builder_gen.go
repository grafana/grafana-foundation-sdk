...
func (builder *OptionsBuilder) WideLayout(wideLayout bool) *OptionsBuilder {
	builder.internal.WideLayout = wideLayout

	return builder
}

func (builder *OptionsBuilder) ShowPercentChange(showPercentChange bool) *OptionsBuilder {
	builder.internal.ShowPercentChange = showPercentChange
...
func (builder *OptionsBuilder) PercentChangeColorMode(percentChangeColorMode common.PercentChangeColorMode) *OptionsBuilder {
	builder.internal.PercentChangeColorMode = percentChangeColorMode
