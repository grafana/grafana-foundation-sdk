...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).GraphMode)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).ColorMode)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).JustifyMode)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).TextMode)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).WideLayout != true {

		buffer.WriteString(`WideLayout(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).WideLayout)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowPercentChange != false {

		buffer.WriteString(`ShowPercentChange(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowPercentChange)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).PercentChangeColorMode)
		buffer.WriteString(arg0)
