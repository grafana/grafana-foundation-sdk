...
func VisualizationV2Converter(input dashboardv2.VizConfigKind) string {
	calls := []string{
		`stat.NewVisualizationV2Builder()`,
	}
	...
	if input.Spec.Options != nil {
		...
		arg0 := cog.Dump(input.Spec.Options.(*Options).GraphMode)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := cog.Dump(input.Spec.Options.(*Options).ColorMode)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := cog.Dump(input.Spec.Options.(*Options).JustifyMode)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := cog.Dump(input.Spec.Options.(*Options).TextMode)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).WideLayout != true {

		buffer.WriteString(`WideLayout(`)
		arg0 := fmt.Sprintf("%#v", input.Spec.Options.(*Options).WideLayout)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).ShowPercentChange != false {

		buffer.WriteString(`ShowPercentChange(`)
		arg0 := fmt.Sprintf("%#v", input.Spec.Options.(*Options).ShowPercentChange)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		buffer.WriteString(`PercentChangeColorMode(`)
		arg0 := cog.Dump(input.Spec.Options.(*Options).PercentChangeColorMode)
		buffer.WriteString(arg0)
