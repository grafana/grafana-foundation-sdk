...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("stat.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) GraphMode(graphMode common.BigValueGraphMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).GraphMode = graphMode

	return builder
}

func (builder *VisualizationV2Builder) ColorMode(colorMode common.BigValueColorMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ColorMode = colorMode

	return builder
}

func (builder *VisualizationV2Builder) JustifyMode(justifyMode common.BigValueJustifyMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).JustifyMode = justifyMode

	return builder
}

func (builder *VisualizationV2Builder) TextMode(textMode common.BigValueTextMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).TextMode = textMode

	return builder
}

func (builder *VisualizationV2Builder) WideLayout(wideLayout bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).WideLayout = wideLayout

	return builder
}

func (builder *VisualizationV2Builder) ShowPercentChange(showPercentChange bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowPercentChange = showPercentChange
...
func (builder *VisualizationV2Builder) PercentChangeColorMode(percentChangeColorMode common.PercentChangeColorMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).PercentChangeColorMode = percentChangeColorMode
