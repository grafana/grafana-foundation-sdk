...
func NewQueryBuilder() *QueryBuilder {
	...
	builder.internal.Group = "grafanapyroscope"
...
func (builder *QueryBuilder) Build() (dashboardv2beta1.DataQueryKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.DataQueryKind{}, cog.MakeBuildErrors("grafanapyroscope.query", builder.errors)
	}
...
func (builder *QueryBuilder) SpanSelector(spanSelector []string) *QueryBuilder {
	...
	builder.internal.Spec.(*Dataquery).SpanSelector = spanSelector
...
func (builder *QueryBuilder) GroupBy(groupBy []string) *QueryBuilder {
	...
	builder.internal.Spec.(*Dataquery).GroupBy = groupBy
...
func (builder *QueryBuilder) MaxNodes(maxNodes int64) *QueryBuilder {
	...
	builder.internal.Spec.(*Dataquery).MaxNodes = &maxNodes
