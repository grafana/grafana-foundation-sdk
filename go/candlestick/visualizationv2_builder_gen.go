...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "candlestick"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("candlestick.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) Mode(mode VizDisplayMode) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) CandleStyle(candleStyle CandleStyle) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).CandleStyle = candleStyle

	return builder
}

// Sets the color strategy for the candlesticks
func (builder *VisualizationV2Builder) ColorStrategy(colorStrategy ColorStrategy) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ColorStrategy = colorStrategy

	return builder
}

// Map fields to appropriate dimension
func (builder *VisualizationV2Builder) Fields(fields cog.Builder[CandlestickFieldMap]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Fields = fieldsResource

	return builder
}

// Set which colors are used when the price movement is up or down
func (builder *VisualizationV2Builder) Colors(colors cog.Builder[CandlestickColors]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Colors = colorsResource
...
func (builder *VisualizationV2Builder) IncludeAllFields(includeAllFields bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).IncludeAllFields = &includeAllFields
