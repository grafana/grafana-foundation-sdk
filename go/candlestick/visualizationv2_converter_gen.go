...
func VisualizationV2Converter(input dashboardv2.VizConfigKind) string {
	calls := []string{
		`candlestick.NewVisualizationV2Builder()`,
	}
	...
	if input.Spec.Options != nil {
		...
		arg0 := cog.Dump(input.Spec.Options.(*Options).Mode)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := cog.Dump(input.Spec.Options.(*Options).CandleStyle)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := cog.Dump(input.Spec.Options.(*Options).ColorStrategy)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := CandlestickFieldMapConverter(input.Spec.Options.(*Options).Fields)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := CandlestickColorsConverter(input.Spec.Options.(*Options).Colors)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).IncludeAllFields != nil && *input.Spec.Options.(*Options).IncludeAllFields != false {

		buffer.WriteString(`IncludeAllFields(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.Options.(*Options).IncludeAllFields)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).DrawStyle != nil {

		buffer.WriteString(`DrawStyle(`)
		arg0 := cog.Dump(*input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).DrawStyle)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).Transform != nil {

		buffer.WriteString(`Transform(`)
		arg0 := cog.Dump(*input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).Transform)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).LineColor != nil && *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).LineColor != "" {

		buffer.WriteString(`LineColor(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).LineColor)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).LineInterpolation != nil {

		buffer.WriteString(`LineInterpolation(`)
		arg0 := cog.Dump(*input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).LineInterpolation)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).FillColor != nil && *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).FillColor != "" {

		buffer.WriteString(`FillColor(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).FillColor)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).FillOpacity != nil {
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).ShowPoints != nil {

		buffer.WriteString(`ShowPoints(`)
		arg0 := cog.Dump(*input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).ShowPoints)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointSize != nil {
		...
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointSize)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointColor != nil && *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointColor != "" {

		buffer.WriteString(`PointColor(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointColor)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).BarAlignment != nil {

		buffer.WriteString(`BarAlignment(`)
		arg0 := cog.Dump(*input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).BarAlignment)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).BarWidthFactor != nil {

		buffer.WriteString(`BarWidthFactor(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).BarWidthFactor)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).FillBelowTo != nil && *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).FillBelowTo != "" {

		buffer.WriteString(`FillBelowTo(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).FillBelowTo)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointSymbol != nil && *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointSymbol != "" {

		buffer.WriteString(`PointSymbol(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).PointSymbol)
		buffer.WriteString(arg0)
	...
	if input.Spec.FieldConfig.Defaults.Custom != nil && input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).BarMaxWidth != nil {

		buffer.WriteString(`BarMaxWidth(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.FieldConfig.Defaults.Custom.(*FieldConfig).BarMaxWidth)
		buffer.WriteString(arg0)
