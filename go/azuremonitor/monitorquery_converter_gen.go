...
func MonitorQueryConverter(input MonitorQuery) string {
	...
	if input.AzureMonitor != nil {
		...
		arg0 := MetricQueryConverter(*input.AzureMonitor)
		buffer.WriteString(arg0)
	...
	if input.AzureLogAnalytics != nil {
		...
		arg0 := LogsQueryConverter(*input.AzureLogAnalytics)
		buffer.WriteString(arg0)
	...
	if input.AzureResourceGraph != nil {
		...
		arg0 := ResourceGraphQueryConverter(*input.AzureResourceGraph)
		buffer.WriteString(arg0)
	...
	if input.AzureTraces != nil {
		...
		arg0 := TracesQueryConverter(*input.AzureTraces)
		buffer.WriteString(arg0)
