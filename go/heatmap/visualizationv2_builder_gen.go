...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "heatmap"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("heatmap.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) Calculate(calculate bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).Calculate = &calculate

	return builder
}

// Calculation options for the heatmap
func (builder *VisualizationV2Builder) Calculation(calculation cog.Builder[common.HeatmapCalculationOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Calculation = &calculationResource

	return builder
}

// Controls the color options
func (builder *VisualizationV2Builder) Color(color cog.Builder[HeatmapColorOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	colorResource, err := color.Build()
	...
	builder.internal.Spec.Options.(*Options).Color = colorResource

	return builder
}

// Filters values between a given range
func (builder *VisualizationV2Builder) FilterValues(filterValues cog.Builder[FilterValueRange]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).FilterValues = &filterValuesResource

	return builder
}

// Controls tick alignment and value name when not calculating from data
func (builder *VisualizationV2Builder) RowsFrame(rowsFrame cog.Builder[RowsHeatmapOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).RowsFrame = &rowsFrameResource
...
func (builder *VisualizationV2Builder) ShowValue(showValue common.VisibilityMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowValue = showValue

	return builder
}

// Controls gap between cells
func (builder *VisualizationV2Builder) CellGap(cellGap uint8) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).CellGap = &cellGap

	return builder
}

// Controls cell radius
func (builder *VisualizationV2Builder) CellRadius(cellRadius float32) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).CellRadius = &cellRadius

	return builder
}

// Controls cell value unit
func (builder *VisualizationV2Builder) CellValues(cellValues cog.Builder[CellValues]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).CellValues = &cellValuesResource

	return builder
}

// Controls yAxis placement
func (builder *VisualizationV2Builder) YAxis(yAxis cog.Builder[YAxisConfig]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).YAxis = yAxisResource
...
func (builder *VisualizationV2Builder) Legend(legend cog.Builder[HeatmapLegend]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) Tooltip(tooltip cog.Builder[HeatmapTooltip]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationV2Builder) Exemplars(exemplars cog.Builder[ExemplarConfig]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	...
	builder.internal.Spec.Options.(*Options).Exemplars = exemplarsResource

	return builder
}

// Controls which axis to allow selection on
func (builder *VisualizationV2Builder) SelectionMode(selectionMode HeatmapSelectionMode) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).SelectionMode = &selectionMode
