...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).Tooltip.MaxHeight != nil {
		...
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).Tooltip.MaxHeight))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).Tooltip.MaxWidth != nil {
		...
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).Tooltip.MaxWidth))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).Tooltip.ShowColorScale != nil {
		...
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).Tooltip.ShowColorScale))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).SelectionMode != nil {

		buffer.WriteString(`SelectionMode(`)
		arg0 := cog.Dump(*input.Options.(*Options).SelectionMode)
		buffer.WriteString(arg0)
