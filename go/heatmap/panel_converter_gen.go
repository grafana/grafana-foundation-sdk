...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).Calculate != nil && *input.Options.(*Options).Calculate != false {

		buffer.WriteString(`Calculate(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).Calculate))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).Calculation != nil {

		buffer.WriteString(`Calculation(`)
		arg0 := common.HeatmapCalculationOptionsConverter(*input.Options.(*Options).Calculation)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).CellGap != nil && *input.Options.(*Options).CellGap != 1 {

		buffer.WriteString(`CellGap(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).CellGap))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).CellRadius != nil {

		buffer.WriteString(`CellRadius(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).CellRadius))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).Legend.Show == true {
	...
	if input.Options != nil && input.Options.(*Options).Legend.Show == false {

		buffer.WriteString(`HideLegend(`)
		buffer.WriteString(")")
	...
	if input.Options != nil && input.Options.(*Options).Tooltip.Show == true {

		buffer.WriteString(`ShowTooltip(`)
		buffer.WriteString(")")
	...
	if input.Options != nil && input.Options.(*Options).Tooltip.Show == false {

		buffer.WriteString(`HideTooltip(`)
		buffer.WriteString(")")
	...
	if input.Options != nil && input.Options.(*Options).Exemplars.Color != "" && input.Options.(*Options).Exemplars.Color != "rgba(255,0,255,0.7)" {

		buffer.WriteString(`ExemplarsColor(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).Exemplars.Color)
		buffer.WriteString(arg0)
