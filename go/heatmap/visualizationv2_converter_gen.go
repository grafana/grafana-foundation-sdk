...
func VisualizationV2Converter(input dashboardv2.VizConfigKind) string {
	calls := []string{
		`heatmap.NewVisualizationV2Builder()`,
	}
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).Calculate != nil && *input.Spec.Options.(*Options).Calculate != false {

		buffer.WriteString(`Calculate(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.Options.(*Options).Calculate)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).Calculation != nil {

		buffer.WriteString(`Calculation(`)
		arg0 := common.HeatmapCalculationOptionsConverter(*input.Spec.Options.(*Options).Calculation)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := HeatmapColorOptionsConverter(input.Spec.Options.(*Options).Color)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).FilterValues != nil {

		buffer.WriteString(`FilterValues(`)
		arg0 := FilterValueRangeConverter(*input.Spec.Options.(*Options).FilterValues)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).RowsFrame != nil {

		buffer.WriteString(`RowsFrame(`)
		arg0 := RowsHeatmapOptionsConverter(*input.Spec.Options.(*Options).RowsFrame)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).CellGap != nil && *input.Spec.Options.(*Options).CellGap != 1 {

		buffer.WriteString(`CellGap(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.Options.(*Options).CellGap)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).CellRadius != nil {

		buffer.WriteString(`CellRadius(`)
		arg0 := fmt.Sprintf("%#v", *input.Spec.Options.(*Options).CellRadius)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).CellValues != nil {

		buffer.WriteString(`CellValues(`)
		arg0 := CellValuesConverter(*input.Spec.Options.(*Options).CellValues)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := YAxisConfigConverter(input.Spec.Options.(*Options).YAxis)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := HeatmapLegendConverter(input.Spec.Options.(*Options).Legend)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := HeatmapTooltipConverter(input.Spec.Options.(*Options).Tooltip)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil {
		...
		arg0 := ExemplarConfigConverter(input.Spec.Options.(*Options).Exemplars)
		buffer.WriteString(arg0)
	...
	if input.Spec.Options != nil && input.Spec.Options.(*Options).SelectionMode != nil {

		buffer.WriteString(`SelectionMode(`)
		arg0 := cog.Dump(*input.Spec.Options.(*Options).SelectionMode)
		buffer.WriteString(arg0)
