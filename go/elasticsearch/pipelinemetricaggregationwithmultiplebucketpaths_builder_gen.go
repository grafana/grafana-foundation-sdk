...
func (builder *PipelineMetricAggregationWithMultipleBucketPathsBuilder) RecordError(path string, err error) *PipelineMetricAggregationWithMultipleBucketPathsBuilder {
