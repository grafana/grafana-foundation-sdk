...
func NewQueryV2Builder() *QueryV2Builder {
	...
	builder.internal.Group = "elasticsearch"
...
func (builder *QueryV2Builder) Build() (dashboardv2.DataQueryKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.DataQueryKind{}, cog.MakeBuildErrors("elasticsearch.queryV2", builder.errors)
	}
...
// Name of time field
func (builder *QueryV2Builder) TimeField(timeField string) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
	builder.internal.Spec.(*Dataquery).TimeField = &timeField

	return builder
}

// List of bucket aggregations
func (builder *QueryV2Builder) BucketAggs(bucketAggs []BucketAggregation) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
	builder.internal.Spec.(*Dataquery).BucketAggs = bucketAggs

	return builder
}

// List of metric aggregations
func (builder *QueryV2Builder) Metrics(metrics []MetricAggregation) *QueryV2Builder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
	builder.internal.Spec.(*Dataquery).Metrics = metrics
