...
func (builder *QueryBuilder) Build() (dashboardv2beta1.DataQueryKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.DataQueryKind{}, cog.MakeBuildErrors("elasticsearch.query", builder.errors)
	}
...
// Name of time field
func (builder *QueryBuilder) TimeField(timeField string) *QueryBuilder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
...
func (builder *QueryBuilder) BucketAggs(bucketAggs []BucketAggregation) *QueryBuilder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
...
func (builder *QueryBuilder) Metrics(metrics []MetricAggregation) *QueryBuilder {
	if builder.internal.Spec == nil {
		builder.internal.Spec = NewDataquery()
	}
