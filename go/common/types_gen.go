...
func (resource *GraphFieldConfig) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["insertNulls"] != nil {
		if string(fields["insertNulls"]) != "null" {
			...
			resource.InsertNulls = &BoolOrFloat64{}
...
func (resource *TableAutoCellOptions) UnmarshalJSONStrict(raw []byte) error {
	...
	// Field "wrapText"
	if fields["wrapText"] != nil {
		if string(fields["wrapText"]) != "null" {
			if err := json.Unmarshal(fields["wrapText"], &resource.WrapText); err != nil {
				errs = append(errs, cog.MakeBuildErrors("wrapText", err)...)
			}

		}
		delete(fields, "wrapText")
...
func (resource *TableImageCellOptions) UnmarshalJSONStrict(raw []byte) error {
	...
	// Field "alt"
	if fields["alt"] != nil {
		if string(fields["alt"]) != "null" {
			if err := json.Unmarshal(fields["alt"], &resource.Alt); err != nil {
				errs = append(errs, cog.MakeBuildErrors("alt", err)...)
			}
...
func NewTableDataLinksCellOptions() *TableDataLinksCellOptions {
	return &TableDataLinksCellOptions{
		Type: TableCellDisplayModeDataLinks,
	}
}
...
func (resource TableDataLinksCellOptions) Validate() error {
	var errs cog.BuildErrors
	if resource.Type != "data-links" {
		errs = append(errs, cog.MakeBuildErrors("type", errors.New("must be data-links"))...)
	}
...
func NewTableActionsCellOptions() *TableActionsCellOptions {
	return &TableActionsCellOptions{
		Type: TableCellDisplayModeActions,
	}
}

// UnmarshalJSONStrict implements a custom JSON unmarshalling logic to decode `TableActionsCellOptions` from JSON.
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *TableActionsCellOptions) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
...
func (resource TableActionsCellOptions) Equals(other TableActionsCellOptions) bool {
	if resource.Type != other.Type {
		return false
	}
...
func (resource TableActionsCellOptions) Validate() error {
	var errs cog.BuildErrors
	if resource.Type != "actions" {
		errs = append(errs, cog.MakeBuildErrors("type", errors.New("must be actions"))...)
	}
...
func (resource *TableColoredBackgroundCellOptions) UnmarshalJSONStrict(raw []byte) error {
	...
	// Field "applyToRow"
	if fields["applyToRow"] != nil {
		if string(fields["applyToRow"]) != "null" {
			if err := json.Unmarshal(fields["applyToRow"], &resource.ApplyToRow); err != nil {
				errs = append(errs, cog.MakeBuildErrors("applyToRow", err)...)
			}

		}
		delete(fields, "applyToRow")
...
type TableCellOptions = TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions
...
type TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions struct {
	...
	TableActionsCellOptions           *TableActionsCellOptions           `json:"TableActionsCellOptions,omitempty"`
...
func NewTableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions() *TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions {
	return &TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions{}
}
...
func (resource TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions) MarshalJSON() ([]byte, error) {
	...
	if resource.TableActionsCellOptions != nil {
		return json.Marshal(resource.TableActionsCellOptions)
	}
...
func (resource *TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions) UnmarshalJSON(raw []byte) error {
	if raw == nil {
		return nil
	}
	...
	case "actions":
		var tableActionsCellOptions TableActionsCellOptions
		if err := json.Unmarshal(raw, &tableActionsCellOptions); err != nil {
			return err
		}

		resource.TableActionsCellOptions = &tableActionsCellOptions
		return nil
	case "auto":
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	// FIXME: this is wasteful, we need to find a more efficient way to unmarshal this.
	...
	switch discriminator {
	case "actions":
		tableActionsCellOptions := &TableActionsCellOptions{}
		if err := tableActionsCellOptions.UnmarshalJSONStrict(raw); err != nil {
			return err
		}
	...
	case "color-text":
		...
		return nil
	case "data-links":
		tableDataLinksCellOptions := &TableDataLinksCellOptions{}
		if err := tableDataLinksCellOptions.UnmarshalJSONStrict(raw); err != nil {
			return err
		}
...
func (resource TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions) Equals(other TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions) bool {
	...
	if resource.TableActionsCellOptions == nil && other.TableActionsCellOptions != nil || resource.TableActionsCellOptions != nil && other.TableActionsCellOptions == nil {
		return false
	}

	if resource.TableActionsCellOptions != nil {
		if !resource.TableActionsCellOptions.Equals(*other.TableActionsCellOptions) {
			return false
		}
	}
...
func (resource TableAutoCellOptionsOrTableSparklineCellOptionsOrTableBarGaugeCellOptionsOrTableColoredBackgroundCellOptionsOrTableColorTextCellOptionsOrTableImageCellOptionsOrTableDataLinksCellOptionsOrTableActionsCellOptionsOrTableJsonViewCellOptions) Validate() error {
	var errs cog.BuildErrors
	if resource.TableAutoCellOptions != nil {
	...
	if resource.TableDataLinksCellOptions != nil {
		if err := resource.TableDataLinksCellOptions.Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("TableDataLinksCellOptions", err)...)
		}
	}
	if resource.TableActionsCellOptions != nil {
		if err := resource.TableActionsCellOptions.Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("TableActionsCellOptions", err)...)
		}
	}
	if resource.TableJsonViewCellOptions != nil {
