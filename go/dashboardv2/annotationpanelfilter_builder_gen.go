...
func (builder *AnnotationPanelFilterBuilder) Build() (AnnotationPanelFilter, error) {
	...
	if len(builder.errors) > 0 {
		return AnnotationPanelFilter{}, cog.MakeBuildErrors("dashboardv2.annotationPanelFilter", builder.errors)
	}
...
func (builder *AnnotationPanelFilterBuilder) Ids(ids []int32) *AnnotationPanelFilterBuilder {
