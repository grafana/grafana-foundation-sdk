...
func (builder *VariableValueSingleBuilder) Build() (VariableValueSingle, error) {
	...
	if len(builder.errors) > 0 {
		return VariableValueSingle{}, cog.MakeBuildErrors("dashboardv2.variableValueSingle", builder.errors)
	}

	return *builder.internal, nil
}

func (builder *VariableValueSingleBuilder) RecordError(path string, err error) *VariableValueSingleBuilder {
