...
func (resource *Dashboard) UnmarshalJSONStrict(raw []byte) error {
	...
	// Field "preferences"
	if fields["preferences"] != nil {
		if string(fields["preferences"]) != "null" {

			resource.Preferences = &Preferences{}
			if err := resource.Preferences.UnmarshalJSONStrict(fields["preferences"]); err != nil {
...
func (resource Dashboard) Equals(other Dashboard) bool {
	...
	if resource.Preferences == nil && other.Preferences != nil || resource.Preferences != nil && other.Preferences == nil {
		return false
	}

	if resource.Preferences != nil {
		if !resource.Preferences.Equals(*other.Preferences) {
			return false
		}
	}
...
func (resource Dashboard) Validate() error {
	...
	if resource.Preferences != nil {
		if err := resource.Preferences.Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("preferences", err)...)
		}
	}
...
func (resource *DataQueryKind) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["datasource"] != nil {
		if string(fields["datasource"]) != "null" {
			...
			resource.Datasource = &Dashboardv2DataQueryKindDatasource{}
...
func (resource *TransformationKind) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["spec"] != nil {
		if string(fields["spec"]) != "null" {
			...
			resource.Spec = TransformationSpec{}
			if err := resource.Spec.UnmarshalJSONStrict(fields["spec"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("spec", err)...)
			}
		} else {
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *TransformationSpec) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("TransformationSpec", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource TransformationSpec) Equals(other TransformationSpec) bool {
...
func (resource TransformationSpec) Validate() error {
	var errs cog.BuildErrors
	if resource.Filter != nil {
		if err := resource.Filter.Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("filter", err)...)
...
func (resource *FieldConfigSource) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["overrides"] != nil {
		if string(fields["overrides"]) != "null" {
			...
			for i1 := range partialArray {
				var result1 Dashboardv2FieldConfigSourceOverrides

				result1 = Dashboardv2FieldConfigSourceOverrides{}
				if err := result1.UnmarshalJSONStrict(partialArray[i1]); err != nil {
...
func (resource *RangeMap) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["options"] != nil {
		if string(fields["options"]) != "null" {
			...
			resource.Options = Dashboardv2RangeMapOptions{}
...
func (resource *RegexMap) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["options"] != nil {
		if string(fields["options"]) != "null" {
			...
			resource.Options = Dashboardv2RegexMapOptions{}
			if err := resource.Options.UnmarshalJSONStrict(fields["options"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("options", err)...)
			}
		} else {
...
func (resource *SpecialValueMap) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["options"] != nil {
		if string(fields["options"]) != "null" {
			...
			resource.Options = Dashboardv2SpecialValueMapOptions{}
			if err := resource.Options.UnmarshalJSONStrict(fields["options"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("options", err)...)
			}
		} else {
...
func (resource *Action) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["style"] != nil {
		if string(fields["style"]) != "null" {
			...
			resource.Style = &Dashboardv2ActionStyle{}
...
func (resource *GroupByVariableKind) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["datasource"] != nil {
		if string(fields["datasource"]) != "null" {
			...
			resource.Datasource = &Dashboardv2GroupByVariableKindDatasource{}
			if err := resource.Datasource.UnmarshalJSONStrict(fields["datasource"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("datasource", err)...)
			}
...
func (resource *AdhocVariableKind) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["datasource"] != nil {
		if string(fields["datasource"]) != "null" {
			...
			resource.Datasource = &Dashboardv2AdhocVariableKindDatasource{}
			if err := resource.Datasource.UnmarshalJSONStrict(fields["datasource"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("datasource", err)...)
			}
...
type Preferences struct {
	...
	Layout *AutoGridLayoutKindOrGridLayoutKind `json:"layout,omitempty"`
}
...
func (resource *Preferences) UnmarshalJSONStrict(raw []byte) error {
	...
	if fields["layout"] != nil {
		if string(fields["layout"]) != "null" {
			...
			resource.Layout = &AutoGridLayoutKindOrGridLayoutKind{}
			if err := resource.Layout.UnmarshalJSONStrict(fields["layout"]); err != nil {
				errs = append(errs, cog.MakeBuildErrors("layout", err)...)
			}
...
const DashboardAPIVersion = "dashboard.grafana.app/v2"
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2DataQueryKindDatasource) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2DataQueryKindDatasource", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2DataQueryKindDatasource) Equals(other Dashboardv2DataQueryKindDatasource) bool {
...
func (resource Dashboardv2DataQueryKindDatasource) Validate() error {
	return nil
}
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2FieldConfigSourceOverrides) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2FieldConfigSourceOverrides", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2FieldConfigSourceOverrides) Equals(other Dashboardv2FieldConfigSourceOverrides) bool {
...
func (resource Dashboardv2FieldConfigSourceOverrides) Validate() error {
	var errs cog.BuildErrors
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2RangeMapOptions) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2RangeMapOptions", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2RangeMapOptions) Equals(other Dashboardv2RangeMapOptions) bool {
...
func (resource Dashboardv2RangeMapOptions) Validate() error {
	var errs cog.BuildErrors
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2RegexMapOptions) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2RegexMapOptions", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2RegexMapOptions) Equals(other Dashboardv2RegexMapOptions) bool {
...
func (resource Dashboardv2RegexMapOptions) Validate() error {
	var errs cog.BuildErrors
	if err := resource.Result.Validate(); err != nil {
		errs = append(errs, cog.MakeBuildErrors("result", err)...)
	}
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2SpecialValueMapOptions) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2SpecialValueMapOptions", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2SpecialValueMapOptions) Equals(other Dashboardv2SpecialValueMapOptions) bool {
...
func (resource Dashboardv2SpecialValueMapOptions) Validate() error {
	var errs cog.BuildErrors
	if err := resource.Result.Validate(); err != nil {
		errs = append(errs, cog.MakeBuildErrors("result", err)...)
	}
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2ActionStyle) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2ActionStyle", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2ActionStyle) Equals(other Dashboardv2ActionStyle) bool {
...
func (resource Dashboardv2ActionStyle) Validate() error {
	return nil
}
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2GroupByVariableKindDatasource) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2GroupByVariableKindDatasource", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2GroupByVariableKindDatasource) Equals(other Dashboardv2GroupByVariableKindDatasource) bool {
	if resource.Name == nil && other.Name != nil || resource.Name != nil && other.Name == nil {
		return false
	}
...
func (resource Dashboardv2GroupByVariableKindDatasource) Validate() error {
	return nil
}
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *Dashboardv2AdhocVariableKindDatasource) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	var errs cog.BuildErrors
	...
	for field := range fields {
		errs = append(errs, cog.MakeBuildErrors("Dashboardv2AdhocVariableKindDatasource", fmt.Errorf("unexpected field '%s'", field))...)
	}
...
func (resource Dashboardv2AdhocVariableKindDatasource) Equals(other Dashboardv2AdhocVariableKindDatasource) bool {
	if resource.Name == nil && other.Name != nil || resource.Name != nil && other.Name == nil {
		return false
	}
...
func (resource Dashboardv2AdhocVariableKindDatasource) Validate() error {
	return nil
}
...
func (resource AutoGridLayoutKindOrGridLayoutKind) MarshalJSON() ([]byte, error) {
	if resource.AutoGridLayoutKind != nil {
		return json.Marshal(resource.AutoGridLayoutKind)
	}
	if resource.GridLayoutKind != nil {
...
func (resource *AutoGridLayoutKindOrGridLayoutKind) UnmarshalJSON(raw []byte) error {
	if raw == nil {
		return nil
	}
...
// Note: the unmarshalling done by this function is strict. It will fail over required fields being absent from the input, fields having an incorrect type, unexpected fields being present, …
func (resource *AutoGridLayoutKindOrGridLayoutKind) UnmarshalJSONStrict(raw []byte) error {
	if raw == nil {
		return nil
	}
	// FIXME: this is wasteful, we need to find a more efficient way to unmarshal this.
...
func (resource AutoGridLayoutKindOrGridLayoutKind) Equals(other AutoGridLayoutKindOrGridLayoutKind) bool {
	if resource.AutoGridLayoutKind == nil && other.AutoGridLayoutKind != nil || resource.AutoGridLayoutKind != nil && other.AutoGridLayoutKind == nil {
		return false
	}
...
func (resource AutoGridLayoutKindOrGridLayoutKind) Validate() error {
	var errs cog.BuildErrors
	if resource.AutoGridLayoutKind != nil {
		if err := resource.AutoGridLayoutKind.Validate(); err != nil {
			errs = append(errs, cog.MakeBuildErrors("AutoGridLayoutKind", err)...)
