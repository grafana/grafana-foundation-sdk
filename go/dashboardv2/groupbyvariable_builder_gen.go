...
func (builder *GroupByVariableBuilder) Build() (GroupByVariableKind, error) {
	...
	if len(builder.errors) > 0 {
		return GroupByVariableKind{}, cog.MakeBuildErrors("dashboardv2.groupByVariable", builder.errors)
	}
...
func (builder *GroupByVariableBuilder) Datasource(datasource cog.Builder[Dashboardv2GroupByVariableKindDatasource]) *GroupByVariableBuilder {
