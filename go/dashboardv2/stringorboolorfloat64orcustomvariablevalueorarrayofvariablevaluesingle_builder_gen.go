...
func (builder *StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingleBuilder) Build() (StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingle, error) {
	...
	if len(builder.errors) > 0 {
		return StringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingle{}, cog.MakeBuildErrors("dashboardv2.stringOrBoolOrFloat64OrCustomVariableValueOrArrayOfVariableValueSingle", builder.errors)
	}
