...
func (builder *AdhocVariableBuilder) Build() (AdhocVariableKind, error) {
	...
	if len(builder.errors) > 0 {
		return AdhocVariableKind{}, cog.MakeBuildErrors("dashboardv2.adhocVariable", builder.errors)
	}
...
func (builder *AdhocVariableBuilder) Datasource(datasource cog.Builder[Dashboardv2AdhocVariableKindDatasource]) *AdhocVariableBuilder {
