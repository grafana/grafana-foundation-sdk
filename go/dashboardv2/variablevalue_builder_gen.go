...
func (builder *VariableValueBuilder) Build() (VariableValue, error) {
	...
	if len(builder.errors) > 0 {
		return VariableValue{}, cog.MakeBuildErrors("dashboardv2.variableValue", builder.errors)
	}

	return *builder.internal, nil
}

func (builder *VariableValueBuilder) RecordError(path string, err error) *VariableValueBuilder {
