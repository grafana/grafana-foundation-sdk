...
func (builder *StringOrBoolOrFloat64OrCustomVariableValueBuilder) Build() (StringOrBoolOrFloat64OrCustomVariableValue, error) {
	...
	if len(builder.errors) > 0 {
		return StringOrBoolOrFloat64OrCustomVariableValue{}, cog.MakeBuildErrors("dashboardv2.stringOrBoolOrFloat64OrCustomVariableValue", builder.errors)
	}

	return *builder.internal, nil
}

func (builder *StringOrBoolOrFloat64OrCustomVariableValueBuilder) RecordError(path string, err error) *StringOrBoolOrFloat64OrCustomVariableValueBuilder {
