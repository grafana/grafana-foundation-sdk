...
func (builder *VizConfigKindBuilder) Build() (VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return VizConfigKind{}, cog.MakeBuildErrors("dashboardv2.vizConfigKind", builder.errors)
	}
...
func (builder *VizConfigKindBuilder) NullValueMode(nullValueMode NullValueMode) *VizConfigKindBuilder {
...
func (builder *VizConfigKindBuilder) Overrides(overrides []cog.Builder[Dashboardv2FieldConfigSourceOverrides]) *VizConfigKindBuilder {
	overridesResources := make([]Dashboardv2FieldConfigSourceOverrides, 0, len(overrides))
...
func (builder *VizConfigKindBuilder) Override(matcher MatcherConfig, properties []DynamicConfigValue) *VizConfigKindBuilder {
	builder.internal.Spec.FieldConfig.Overrides = append(builder.internal.Spec.FieldConfig.Overrides, Dashboardv2FieldConfigSourceOverrides{
		Matcher:    matcher,
