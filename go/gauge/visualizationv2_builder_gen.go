...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("gauge.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) ShowThresholdLabels(showThresholdLabels bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowThresholdLabels = showThresholdLabels

	return builder
}

func (builder *VisualizationV2Builder) ShowThresholdMarkers(showThresholdMarkers bool) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).ShowThresholdMarkers = showThresholdMarkers
