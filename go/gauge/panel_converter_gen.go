...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).ShowThresholdLabels != false {

		buffer.WriteString(`ShowThresholdLabels(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowThresholdLabels)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowThresholdMarkers != true {

		buffer.WriteString(`ShowThresholdMarkers(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowThresholdMarkers)
		buffer.WriteString(arg0)
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).Sizing)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).MinVizWidth != 75 {
	...
	if input.Options != nil && input.Options.(*Options).MinVizHeight != 75 {
