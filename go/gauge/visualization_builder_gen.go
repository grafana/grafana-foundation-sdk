...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("gauge.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) ShowThresholdLabels(showThresholdLabels bool) *VisualizationBuilder {
...
func (builder *VisualizationBuilder) ShowThresholdMarkers(showThresholdMarkers bool) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
