...
func NewVisualizationV2Builder() *VisualizationV2Builder {
	...
	builder.internal.Group = "piechart"
...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("piechart.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) PieType(pieType PieChartType) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).PieType = pieType

	return builder
}

func (builder *VisualizationV2Builder) DisplayLabels(displayLabels []PieChartLabels) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
	builder.internal.Spec.Options.(*Options).DisplayLabels = displayLabels
...
func (builder *VisualizationV2Builder) Legend(legend cog.Builder[PieChartLegendOptions]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
