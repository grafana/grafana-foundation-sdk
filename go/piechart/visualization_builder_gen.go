...
func (builder *VisualizationBuilder) Build() (dashboardv2beta1.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2beta1.VizConfigKind{}, cog.MakeBuildErrors("piechart.visualization", builder.errors)
	}
...
func (builder *VisualizationBuilder) PieType(pieType PieChartType) *VisualizationBuilder {
...
func (builder *VisualizationBuilder) DisplayLabels(displayLabels []PieChartLabels) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
...
func (builder *VisualizationBuilder) Legend(legend cog.Builder[PieChartLegendOptions]) *VisualizationBuilder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
