...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil {
		...
		arg0 := cog.Dump(input.Options.(*Options).PieType)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).DisplayLabels != nil && len(input.Options.(*Options).DisplayLabels) >= 1 {

		buffer.WriteString(`DisplayLabels(`)
		tmparg0 := []string{}
		for _, arg1 := range input.Options.(*Options).DisplayLabels {
