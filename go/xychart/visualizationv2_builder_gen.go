...
func (builder *VisualizationV2Builder) Build() (dashboardv2.VizConfigKind, error) {
	...
	if len(builder.errors) > 0 {
		return dashboardv2.VizConfigKind{}, cog.MakeBuildErrors("xychart.visualizationV2", builder.errors)
	}
...
func (builder *VisualizationV2Builder) Show(show XYShowMode) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) PointSize(pointSize cog.Builder[XychartFieldConfigPointSize]) *VisualizationV2Builder {
	if builder.internal.Spec.FieldConfig.Defaults.Custom == nil {
		builder.internal.Spec.FieldConfig.Defaults.Custom = NewFieldConfig()
	}
...
func (builder *VisualizationV2Builder) PointShape(pointShape PointShape) *VisualizationV2Builder {
	if builder.internal.Spec.FieldConfig.Defaults.Custom == nil {
		builder.internal.Spec.FieldConfig.Defaults.Custom = NewFieldConfig()
	}
...
func (builder *VisualizationV2Builder) Mapping(mapping SeriesMapping) *VisualizationV2Builder {
...
func (builder *VisualizationV2Builder) Series(series []cog.Builder[XYSeriesConfig]) *VisualizationV2Builder {
	if builder.internal.Spec.Options == nil {
		builder.internal.Spec.Options = NewOptions()
	}
