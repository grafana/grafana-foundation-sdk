...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).Show != nil {

		buffer.WriteString(`Show(`)
		arg0 := cog.Dump(*input.FieldConfig.Defaults.Custom.(*FieldConfig).Show)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).PointColor != nil {
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).LineColor != nil {
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).Label != nil {
	...
	if input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).LabelValue != nil {
	...
	if input.Options != nil && input.Options.(*Options).Series != nil && len(input.Options.(*Options).Series) >= 1 {
