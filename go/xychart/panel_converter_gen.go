...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).Show != nil {
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).PointStrokeWidth != nil {
		...
		arg0 := fmt.Sprintf("%#v", *input.FieldConfig.Defaults.Custom.(*FieldConfig).PointStrokeWidth)
		buffer.WriteString(arg0)
