...
func (builder *PanelBuilder) Actions(actions []cog.Builder[dashboard.Action]) *PanelBuilder {
	...
	actionsResources := make([]dashboard.Action, 0, len(actions))
...
func (builder *PanelBuilder) Show(show XYShowMode) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = dashboard.NewFieldConfigSource()
	}
...
func (builder *PanelBuilder) PointShape(pointShape PointShape) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = dashboard.NewFieldConfigSource()
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).PointShape = &pointShape
...
func (builder *PanelBuilder) PointStrokeWidth(pointStrokeWidth int32) *PanelBuilder {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).PointStrokeWidth = &pointStrokeWidth
...
func (builder *PanelBuilder) Mapping(mapping SeriesMapping) *PanelBuilder {
	if builder.internal.Options == nil {
		builder.internal.Options = NewOptions()
	}
	builder.internal.Options.(*Options).Mapping = mapping
