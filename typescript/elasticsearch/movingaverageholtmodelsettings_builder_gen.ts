...
export class MovingAverageHoltModelSettingsBuilder implements cog.OptionsBuilder<elasticsearch.MovingAverageHoltModelSettings> {
    private readonly internal: elasticsearch.MovingAverageHoltModelSettings;
