...
```typescript
data(data: cog.Builder<dashboardv2.QueryGroupKind>)
```
...
```typescript
links(links: cog.Builder<dashboardv2.DataLink>[])
```
...
```typescript
visualization(vizConfig: cog.Builder<dashboardv2.VizConfigKind>)
```
