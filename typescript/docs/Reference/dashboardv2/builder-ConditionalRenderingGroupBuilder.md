...
```typescript
item(item: cog.Builder<dashboardv2.ConditionalRenderingVariableKind> | cog.Builder<dashboardv2.ConditionalRenderingDataKind> | cog.Builder<dashboardv2.ConditionalRenderingTimeRangeSizeKind>)
```

### <span class="badge object-method"></span> items

```typescript
items(items: (cog.Builder<dashboardv2.ConditionalRenderingVariableKind> | cog.Builder<dashboardv2.ConditionalRenderingDataKind> | cog.Builder<dashboardv2.ConditionalRenderingTimeRangeSizeKind>)[])
```
