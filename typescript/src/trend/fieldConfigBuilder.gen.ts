...
export class FieldConfigBuilder implements cog.Builder<trend.FieldConfig> {
    protected readonly internal: trend.FieldConfig;

    constructor() {
        this.internal = trend.defaultFieldConfig();
    }

    /**
     * Builds the object.
     */
    build(): trend.FieldConfig {
