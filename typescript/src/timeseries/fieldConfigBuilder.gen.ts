...
export class FieldConfigBuilder implements cog.Builder<timeseries.FieldConfig> {
    protected readonly internal: timeseries.FieldConfig;

    constructor() {
        this.internal = timeseries.defaultFieldConfig();
    }

    /**
     * Builds the object.
     */
    build(): timeseries.FieldConfig {
