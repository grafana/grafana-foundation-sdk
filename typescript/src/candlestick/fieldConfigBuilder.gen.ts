...
export class FieldConfigBuilder implements cog.Builder<candlestick.FieldConfig> {
    protected readonly internal: candlestick.FieldConfig;

    constructor() {
        this.internal = candlestick.defaultFieldConfig();
    }

    /**
     * Builds the object.
     */
    build(): candlestick.FieldConfig {
