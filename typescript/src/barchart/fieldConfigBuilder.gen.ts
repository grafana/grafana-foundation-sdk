...
export class FieldConfigBuilder implements cog.Builder<barchart.FieldConfig> {
    protected readonly internal: barchart.FieldConfig;

    constructor() {
        this.internal = barchart.defaultFieldConfig();
    }

    /**
     * Builds the object.
     */
    build(): barchart.FieldConfig {
