...
export class MonitorQueryBuilder implements cog.Builder<cog.Dataquery> {
    protected readonly internal: azuremonitor.MonitorQuery;

    constructor() {
        this.internal = azuremonitor.defaultMonitorQuery();
    }

    /**
     * Builds the object.
     */
    build(): azuremonitor.MonitorQuery {
