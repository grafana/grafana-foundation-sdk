 ...
 */
export class LogsQueryBuilder implements cog.Builder<azuremonitor.LogsQuery> {
    protected readonly internal: azuremonitor.LogsQuery;

    constructor() {
        this.internal = azuremonitor.defaultLogsQuery();
    }

    /**
     * Builds the object.
     */
    build(): azuremonitor.LogsQuery {
