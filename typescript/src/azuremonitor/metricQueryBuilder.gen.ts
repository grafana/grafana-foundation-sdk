...
export class MetricQueryBuilder implements cog.Builder<azuremonitor.MetricQuery> {
    protected readonly internal: azuremonitor.MetricQuery;

    constructor() {
        this.internal = azuremonitor.defaultMetricQuery();
    }

    /**
     * Builds the object.
     */
    build(): azuremonitor.MetricQuery {
        return this.internal;
    }

    // Array of resource URIs to be queried.
    resources(resources: cog.Builder<azuremonitor.MonitorResource>[]): this {
    ...
    dimensionFilters(dimensionFilters: cog.Builder<azuremonitor.MetricDimension>[]): this {
