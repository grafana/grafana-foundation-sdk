...
export class AnnotationQueryBuilder implements cog.Builder<dashboardv2.AnnotationQueryKind> {
    protected readonly internal: dashboardv2.AnnotationQueryKind;

    constructor() {
        this.internal = dashboardv2.defaultAnnotationQueryKind();
     ...
     * Builds the object.
     */
    build(): dashboardv2.AnnotationQueryKind {
        return this.internal;
    }

    query(query: cog.Builder<dashboardv2.DataQueryKind>): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultAnnotationQuerySpec();
        }
    ...
    filter(filter: cog.Builder<dashboardv2.AnnotationPanelFilter>): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultAnnotationQuerySpec();
        }
    ...
    placement(placement: dashboardv2.AnnotationQueryPlacement): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultAnnotationQuerySpec();
        }
    ...
    mappings(mappings: Record<string, cog.Builder<dashboardv2.AnnotationEventFieldMapping>>): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultAnnotationQuerySpec();
        }
        const mappingsResource = (function() {
            let results1: Record<string, dashboardv2.AnnotationEventFieldMapping> = {};
