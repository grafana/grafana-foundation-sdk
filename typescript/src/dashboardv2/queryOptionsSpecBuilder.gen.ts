...
export class QueryOptionsSpecBuilder implements cog.Builder<dashboardv2.QueryOptionsSpec> {
    protected readonly internal: dashboardv2.QueryOptionsSpec;

    constructor() {
        this.internal = dashboardv2.defaultQueryOptionsSpec();
    }

    /**
     * Builds the object.
     */
    build(): dashboardv2.QueryOptionsSpec {
