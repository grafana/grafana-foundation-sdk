...
export class TimeSettingsBuilder implements cog.Builder<dashboardv2.TimeSettingsSpec> {
    protected readonly internal: dashboardv2.TimeSettingsSpec;

    constructor() {
        this.internal = dashboardv2.defaultTimeSettingsSpec();
    }

    /**
     * Builds the object.
     */
    build(): dashboardv2.TimeSettingsSpec {
    ...
    quickRanges(quickRanges: cog.Builder<dashboardv2.TimeRangeOption>[]): this {
