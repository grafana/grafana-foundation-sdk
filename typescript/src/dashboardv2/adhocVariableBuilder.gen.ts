...
// Adhoc variable kind
export class AdhocVariableBuilder implements cog.Builder<dashboardv2.AdhocVariableKind> {
    protected readonly internal: dashboardv2.AdhocVariableKind;
     ...
     * Builds the object.
     */
    build(): dashboardv2.AdhocVariableKind {
    ...
    baseFilters(baseFilters: cog.Builder<dashboardv2.AdHocFilterWithLabels>[]): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultAdhocVariableSpec();
        }
    ...
    filters(filters: cog.Builder<dashboardv2.AdHocFilterWithLabels>[]): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultAdhocVariableSpec();
        }
    ...
    defaultKeys(defaultKeys: cog.Builder<dashboardv2.MetricFindValue>[]): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultAdhocVariableSpec();
        }
