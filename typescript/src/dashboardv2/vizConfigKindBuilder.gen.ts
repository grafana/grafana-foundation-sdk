...
export class VizConfigKindBuilder implements cog.Builder<dashboardv2.VizConfigKind> {
    ...
    spec(spec: dashboardv2.VizConfigSpec): this {
    ...
    fieldConfig(fieldConfig: dashboardv2.FieldConfigSource): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultVizConfigSpec();
        }
    ...
    defaults(defaults: dashboardv2.FieldConfig): this {
        if (!this.internal.spec) {
            this.internal.spec = dashboardv2.defaultVizConfigSpec();
        }
        if (!this.internal.spec.fieldConfig) {
