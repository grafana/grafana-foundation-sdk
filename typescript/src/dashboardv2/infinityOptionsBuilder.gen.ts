...
export class InfinityOptionsBuilder implements cog.Builder<dashboardv2.InfinityOptions> {
    protected readonly internal: dashboardv2.InfinityOptions;

    constructor() {
        this.internal = dashboardv2.defaultInfinityOptions();
    }

    /**
     * Builds the object.
     */
    build(): dashboardv2.InfinityOptions {
