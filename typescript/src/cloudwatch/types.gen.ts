...
export const defaultQueryMode = (): QueryMode => (QueryMode.Metrics);
...
export type Request = MetricsQuery | LogsQuery | AnnotationQuery;

export const defaultRequest = (): Request => (defaultMetricsQuery());
