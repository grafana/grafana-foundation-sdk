...
export class AnnotationPanelFilterBuilder implements cog.Builder<dashboardv2beta1.AnnotationPanelFilter> {
    protected readonly internal: dashboardv2beta1.AnnotationPanelFilter;

    constructor() {
        this.internal = dashboardv2beta1.defaultAnnotationPanelFilter();
    }
