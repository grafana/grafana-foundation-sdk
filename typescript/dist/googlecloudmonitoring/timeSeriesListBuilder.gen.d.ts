...
export declare class TimeSeriesListBuilder implements cog.Builder<googlecloudmonitoring.TimeSeriesList> {
    protected readonly internal: googlecloudmonitoring.TimeSeriesList;
    constructor();
    /**
     * Builds the object.
     */
