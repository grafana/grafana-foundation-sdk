...
export class TimeSeriesListBuilder implements cog.OptionsBuilder<googlecloudmonitoring.TimeSeriesList> {
    private readonly internal: googlecloudmonitoring.TimeSeriesList;
