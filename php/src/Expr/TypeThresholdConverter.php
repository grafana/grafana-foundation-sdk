...
final class TypeThresholdConverter
{
    public static function convert(\Grafana\Foundation\Expr\TypeThreshold $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Expr\TypeThresholdBuilder())',
        ];
    ...
    $buffer = 'conditions(';
        ...
        $tmpconditionsarg1 = \Grafana\Foundation\Expr\ExprTypeThresholdConditionsConverter::convert($arg1);
    ...
    $buffer = 'resultAssertions(';
        $arg0 = \Grafana\Foundation\Expr\ExprTypeThresholdResultAssertionsConverter::convert($input->resultAssertions);
        $buffer .= $arg0;
    ...
    $buffer = 'timeRange(';
        $arg0 = \Grafana\Foundation\Expr\ExprTypeThresholdTimeRangeConverter::convert($input->timeRange);
        $buffer .= $arg0;
