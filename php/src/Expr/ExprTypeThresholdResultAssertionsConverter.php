...
final class ExprTypeThresholdResultAssertionsConverter
{
    public static function convert(\Grafana\Foundation\Expr\ExprTypeThresholdResultAssertions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Expr\ExprTypeThresholdResultAssertionsBuilder())',
        ];
