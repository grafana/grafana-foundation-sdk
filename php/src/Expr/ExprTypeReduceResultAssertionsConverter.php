...
final class ExprTypeReduceResultAssertionsConverter
{
    public static function convert(\Grafana\Foundation\Expr\ExprTypeReduceResultAssertions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Expr\ExprTypeReduceResultAssertionsBuilder())',
        ];
