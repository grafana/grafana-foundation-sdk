...
final class ExprTypeClassicConditionsConditionsOperatorType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    /**
     * @var array<string, ExprTypeClassicConditionsConditionsOperatorType>
     */
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum ExprTypeClassicConditionsConditionsOperatorType");
    }
