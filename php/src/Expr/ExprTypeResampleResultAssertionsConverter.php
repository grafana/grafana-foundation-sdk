...
final class ExprTypeResampleResultAssertionsConverter
{
    public static function convert(\Grafana\Foundation\Expr\ExprTypeResampleResultAssertions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Expr\ExprTypeResampleResultAssertionsBuilder())',
        ];
