...
final class TypeSqlConverter
{
    public static function convert(\Grafana\Foundation\Expr\TypeSql $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Expr\TypeSqlBuilder())',
        ];
    ...
    $buffer = 'resultAssertions(';
        $arg0 = \Grafana\Foundation\Expr\ExprTypeSqlResultAssertionsConverter::convert($input->resultAssertions);
        $buffer .= $arg0;
    ...
    $buffer = 'timeRange(';
        $arg0 = \Grafana\Foundation\Expr\ExprTypeSqlTimeRangeConverter::convert($input->timeRange);
        $buffer .= $arg0;
