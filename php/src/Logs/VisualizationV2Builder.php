...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Logs\Options);
        $this->internal->spec->options->showLabels = $showLabels;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Logs\Options);
        $this->internal->spec->options->showCommonLabels = $showCommonLabels;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Logs\Options);
        $this->internal->spec->options->showLogContextToggle = $showLogContextToggle;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Logs\Options);
        $this->internal->spec->options->prettifyLogMessage = $prettifyLogMessage;
