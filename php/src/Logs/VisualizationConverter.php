...
final class VisualizationConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Logs\Options && $input->spec->options->controlsStorageKey !== null && $input->spec->options->controlsStorageKey !== "") {
    
        
    $buffer = 'controlsStorageKey(';
        $arg0 =\var_export($input->spec->options->controlsStorageKey, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Logs\Options && $input->spec->options->onLogOptionsChange !== null) {
