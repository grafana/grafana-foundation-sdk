...
final class OptionsConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->logRowMenuIconsBefore !== null) {
    
        
    $buffer = 'logRowMenuIconsBefore(';
        $arg0 =\var_export($input->logRowMenuIconsBefore, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->logRowMenuIconsAfter !== null) {
    
        
    $buffer = 'logRowMenuIconsAfter(';
        $arg0 =\var_export($input->logRowMenuIconsAfter, true);
        $buffer .= $arg0;
