...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Text\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Text\Options) {
    
        
    $buffer = 'mode(';
        $arg0 ='\Grafana\Foundation\Text\TextMode::fromValue("'.$input->options->mode.'")';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Text\Options && $input->options->code !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Text\Options && $input->options->content !== "" && $input->options->content !== "# Title\n\nFor markdown syntax help: [commonmark.org/help](https://commonmark.org/help/)") {
    
        
    $buffer = 'content(';
        $arg0 =\var_export($input->options->content, true);
        $buffer .= $arg0;
