...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Bargauge\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->displayMode = $displayMode;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->valueMode = $valueMode;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->namePlacement = $namePlacement;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->showUnfilled = $showUnfilled;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->sizing = $sizing;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->minVizWidth = $minVizWidth;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->minVizHeight = $minVizHeight;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Bargauge\Options);
        $this->internal->spec->options->maxVizHeight = $maxVizHeight;
