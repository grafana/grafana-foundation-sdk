...
final class PanelConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Bargauge\Options && $input->options->minVizWidth !== 0) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Bargauge\Options && $input->options->minVizHeight !== 10) {
