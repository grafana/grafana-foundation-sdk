...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Annotationslist\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->onlyFromThisDashboard = $onlyFromThisDashboard;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->onlyInTimeRange = $onlyInTimeRange;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->limit = $limit;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->showUser = $showUser;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->showTags = $showTags;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->navigateToPanel = $navigateToPanel;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->navigateBefore = $navigateBefore;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Annotationslist\Options);
        $this->internal->spec->options->navigateAfter = $navigateAfter;
