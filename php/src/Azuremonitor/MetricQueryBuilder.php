...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Azuremonitor\MetricQuery>
 */
class MetricQueryBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Azuremonitor\MetricQuery $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Azuremonitor\MetricQuery();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Azuremonitor\MetricQuery
     */
     ...
     * @param array<\Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Azuremonitor\MonitorResource>> $resources
     */
     ...
     * @param array<\Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Azuremonitor\MetricDimension>> $dimensionFilters
     */
