...
final class TracesQueryConverter
{
    public static function convert(\Grafana\Foundation\Azuremonitor\TracesQuery $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Azuremonitor\TracesQueryBuilder())',
        ];
    ...
    $buffer = 'filters(';
        ...
        $tmpfiltersarg1 = \Grafana\Foundation\Azuremonitor\TracesFilterConverter::convert($arg1);
