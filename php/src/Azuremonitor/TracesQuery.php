 ...
 */
class TracesQuery implements \JsonSerializable
{
    /**
     ...
     * @var array<\Grafana\Foundation\Azuremonitor\TracesFilter>|null
     */
     ...
     * @param array<\Grafana\Foundation\Azuremonitor\TracesFilter>|null $filters
    ...
    $val = $input;
    	return \Grafana\Foundation\Azuremonitor\TracesFilter::fromArray($val);
    }), $data["filters"] ?? [])),
