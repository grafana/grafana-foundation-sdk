...
{
    public static function convert(\Grafana\Foundation\Azuremonitor\MetricQuery $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Azuremonitor\MetricQueryBuilder())',
        ];
    ...
    $buffer = 'resources(';
        ...
        $tmpresourcesarg1 = \Grafana\Foundation\Azuremonitor\MonitorResourceConverter::convert($arg1);
    ...
    $buffer = 'dimensionFilters(';
        ...
        $tmpdimensionFiltersarg1 = \Grafana\Foundation\Azuremonitor\MetricDimensionConverter::convert($arg1);
