...
class MetricQuery implements \JsonSerializable
{
     ...
     * @var array<\Grafana\Foundation\Azuremonitor\MonitorResource>|null
     */
     ...
     * @var array<\Grafana\Foundation\Azuremonitor\MetricDimension>|null
     */
    ...
    /**
     * @param array<\Grafana\Foundation\Azuremonitor\MonitorResource>|null $resources
     ...
     * @param array<\Grafana\Foundation\Azuremonitor\MetricDimension>|null $dimensionFilters
    ...
    $val = $input;
    	return \Grafana\Foundation\Azuremonitor\MonitorResource::fromArray($val);
    }), $data["resources"] ?? [])),
    ...
    $val = $input;
    	return \Grafana\Foundation\Azuremonitor\MetricDimension::fromArray($val);
