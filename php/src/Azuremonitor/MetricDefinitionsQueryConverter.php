...
final class MetricDefinitionsQueryConverter
{
    public static function convert(\Grafana\Foundation\Azuremonitor\MetricDefinitionsQuery $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Azuremonitor\MetricDefinitionsQueryBuilder())',
        ];
