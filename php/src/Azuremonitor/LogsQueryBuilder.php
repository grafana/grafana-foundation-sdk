 ...
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Azuremonitor\LogsQuery>
 */
class LogsQueryBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Azuremonitor\LogsQuery $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Azuremonitor\LogsQuery();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Azuremonitor\LogsQuery
     */
