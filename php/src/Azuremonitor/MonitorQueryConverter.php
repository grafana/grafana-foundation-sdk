...
final class MonitorQueryConverter
{
    public static function convert(\Grafana\Foundation\Cog\Dataquery $input): string
    {
        assert($input instanceof \Grafana\Foundation\Azuremonitor\MonitorQuery);
        $calls = [
            '(new \Grafana\Foundation\Azuremonitor\MonitorQueryBuilder())',
        ];
            if ($input->refId !== "") {
    ...
    $buffer = 'azureMonitor(';
        $arg0 = \Grafana\Foundation\Azuremonitor\MetricQueryConverter::convert($input->azureMonitor);
        $buffer .= $arg0;
    ...
    $buffer = 'azureLogAnalytics(';
        $arg0 = \Grafana\Foundation\Azuremonitor\LogsQueryConverter::convert($input->azureLogAnalytics);
        $buffer .= $arg0;
    ...
    $buffer = 'azureResourceGraph(';
        $arg0 = \Grafana\Foundation\Azuremonitor\ResourceGraphQueryConverter::convert($input->azureResourceGraph);
        $buffer .= $arg0;
    ...
    $buffer = 'azureTraces(';
        $arg0 = \Grafana\Foundation\Azuremonitor\TracesQueryConverter::convert($input->azureTraces);
        $buffer .= $arg0;
    ...
    $buffer = 'datasource(';
        $arg0 =\var_export($input->datasource, true);
        $buffer .= $arg0;
