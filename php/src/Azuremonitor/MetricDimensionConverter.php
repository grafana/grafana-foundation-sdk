...
final class MetricDimensionConverter
{
    public static function convert(\Grafana\Foundation\Azuremonitor\MetricDimension $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Azuremonitor\MetricDimensionBuilder())',
        ];
