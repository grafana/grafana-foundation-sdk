...
class AzureMonitorQuery implements \JsonSerializable, \Grafana\Foundation\Cog\Dataquery
{
    ...
    $val = $input;
    	...
    	/** @var array{query?: string, resultFormat?: string, resources?: array<string>, intersectTime?: bool, workspace?: string, resource?: string} */
    $val = $input;
