...
final class LogsQueryConverter
{
    public static function convert(\Grafana\Foundation\Azuremonitor\LogsQuery $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Azuremonitor\LogsQueryBuilder())',
        ];
    ...
    $calls[] = $buffer;
            ...
            if ($input->basicLogsQuery !== null) {
    
        
    $buffer = 'basicLogsQuery(';
        $arg0 =\var_export($input->basicLogsQuery, true);
        $buffer .= $arg0;
