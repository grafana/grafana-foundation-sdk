...
final class TracesFilterConverter
{
    public static function convert(\Grafana\Foundation\Azuremonitor\TracesFilter $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Azuremonitor\TracesFilterBuilder())',
        ];
            if ($input->property !== "") {
