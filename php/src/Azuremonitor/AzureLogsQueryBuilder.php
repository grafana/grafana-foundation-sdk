...
class AzureLogsQueryBuilder implements \Grafana\Foundation\Cog\Builder
{
     ...
     */
    public function mode(\Grafana\Foundation\Azuremonitor\LogsEditorMode $mode): static
    {
     ...
     */
    public function builderQuery(\Grafana\Foundation\Cog\Builder $builderQuery): static
    {
        $builderQueryResource = $builderQuery->build();
