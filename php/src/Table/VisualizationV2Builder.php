...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\VizConfigKind>
 */
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\VizConfigKind $internal;
    ...
    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\VizConfigKind
     */
     ...
     * @param array<\Grafana\Foundation\Dashboardv2\ValueMap|\Grafana\Foundation\Dashboardv2\RangeMap|\Grafana\Foundation\Dashboardv2\RegexMap|\Grafana\Foundation\Dashboardv2\SpecialValueMap> $mappings
     */
     ...
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\ThresholdsConfig> $thresholds
     */
     ...
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\FieldColor> $color
     */
     ...
     * @param array<\Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\Action>> $actions
     */
     ...
     */
    public function nullValueMode(\Grafana\Foundation\Dashboardv2\NullValueMode $nullValueMode): static
    {
     ...
     * @param array<\Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\Dashboardv2FieldConfigSourceOverrides>> $overrides
     */
    ...
    /**
     * Overrides are the options applied to specific fields overriding the defaults.
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\Dashboardv2FieldConfigSourceOverrides> $override
     */
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Table\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->spec->options->frameIndex = $frameIndex;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->spec->options->showHeader = $showHeader;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->spec->options->showTypeIcons = $showTypeIcons;
    ...
    {    
        ...
        $this->internal->spec->options->sortBy = $sortByResources;
    ...
    {    
        ...
        $this->internal->spec->options->footer = $footerResource;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Table\Options);
        $this->internal->spec->options->cellHeight = $cellHeight;
    ...
    {    
        if ($this->internal->spec->fieldConfig->defaults->custom === null) {
            $this->internal->spec->fieldConfig->defaults->custom = new \Grafana\Foundation\Table\FieldConfig();
        }
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->width = $width;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->minWidth = $minWidth;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->align = $align;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->displayMode = $displayMode;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->cellOptions = $cellOptions;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->hidden = $hidden;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->inspect = $inspect;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->filterable = $filterable;
    ...
    {    
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Table\FieldConfig);
        $this->internal->spec->fieldConfig->defaults->custom->hideHeader = $hideHeader;
    ...
    {
        $this->internal->spec->fieldConfig->overrides[] = new \Grafana\Foundation\Dashboardv2\Dashboardv2FieldConfigSourceOverrides(
            matcher: new \Grafana\Foundation\Dashboardv2\MatcherConfig(
            id: "byName",
            options: $name,
        ),
