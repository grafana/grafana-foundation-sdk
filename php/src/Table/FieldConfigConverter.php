...
{
    public static function convert(\Grafana\Foundation\Table\FieldConfig $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Table\FieldConfigBuilder())',
        ];
            if ($input->width !== null) {
