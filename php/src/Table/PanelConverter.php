    ...
    $buffer = 'cellOptions(';
        switch (true) {
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableAutoCellOptions:
                $disjunctioncellOptions = \Grafana\Foundation\Common\TableAutoCellOptionsConverter::convert($input->fieldConfig->defaults->custom->cellOptions);
            ...
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableColorTextCellOptions:
                $disjunctioncellOptions = \Grafana\Foundation\Common\TableColorTextCellOptionsConverter::convert($input->fieldConfig->defaults->custom->cellOptions);
                $arg0 = $disjunctioncellOptions;
                break;
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableImageCellOptions:
                $disjunctioncellOptions = \Grafana\Foundation\Common\TableImageCellOptionsConverter::convert($input->fieldConfig->defaults->custom->cellOptions);
                $arg0 = $disjunctioncellOptions;
                break;
