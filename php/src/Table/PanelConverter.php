    ...
    $buffer = 'cellOptions(';
        switch (true) {
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableAutoCellOptions:
                $disjunctioncellOptions ='(new \Grafana\Foundation\Common\TableAutoCellOptions(type: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->type, true).','.(($input->fieldConfig->defaults->custom->cellOptions->wrapText !== null) ? 'wrapText: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->wrapText, true).', ' : '').'))';
            ...
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableColoredBackgroundCellOptions:
                $disjunctioncellOptions ='(new \Grafana\Foundation\Common\TableColoredBackgroundCellOptions(type: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->type, true).','.(($input->fieldConfig->defaults->custom->cellOptions->mode !== null) ? 'mode: '.'\Grafana\Foundation\Common\TableCellBackgroundDisplayMode::fromValue("'.$input->fieldConfig->defaults->custom->cellOptions->mode.'")'.', ' : '').''.(($input->fieldConfig->defaults->custom->cellOptions->applyToRow !== null) ? 'applyToRow: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->applyToRow, true).', ' : '').''.(($input->fieldConfig->defaults->custom->cellOptions->wrapText !== null) ? 'wrapText: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->wrapText, true).', ' : '').'))';
                $arg0 = $disjunctioncellOptions;
                break;
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableColorTextCellOptions:
                $disjunctioncellOptions ='(new \Grafana\Foundation\Common\TableColorTextCellOptions(type: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->type, true).','.(($input->fieldConfig->defaults->custom->cellOptions->wrapText !== null) ? 'wrapText: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->wrapText, true).', ' : '').'))';
                $arg0 = $disjunctioncellOptions;
                break;
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableImageCellOptions:
                $disjunctioncellOptions ='(new \Grafana\Foundation\Common\TableImageCellOptions(type: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->type, true).','.(($input->fieldConfig->defaults->custom->cellOptions->alt !== null) ? 'alt: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->alt, true).', ' : '').''.(($input->fieldConfig->defaults->custom->cellOptions->title !== null) ? 'title: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->title, true).', ' : '').'))';
                $arg0 = $disjunctioncellOptions;
                break;
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableDataLinksCellOptions:
                ...
                $arg0 = $disjunctioncellOptions;
                break;
            case $input->fieldConfig->defaults->custom->cellOptions instanceof \Grafana\Foundation\Common\TableActionsCellOptions:
                $disjunctioncellOptions ='(new \Grafana\Foundation\Common\TableActionsCellOptions(type: '.\var_export($input->fieldConfig->defaults->custom->cellOptions->type, true).',))';
                $arg0 = $disjunctioncellOptions;
                break;
