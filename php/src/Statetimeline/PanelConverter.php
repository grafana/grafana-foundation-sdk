...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Statetimeline\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Statetimeline\Options) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Statetimeline\Options && $input->options->mergeValues !== null && $input->options->mergeValues !== true) {
    
        
    $buffer = 'mergeValues(';
        $arg0 =\var_export($input->options->mergeValues, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Statetimeline\Options && $input->options->timezone !== null && count($input->options->timezone) >= 1) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Statetimeline\Options && $input->options->alignValue !== null) {
    
        
    $buffer = 'alignValue(';
        $arg0 ='\Grafana\Foundation\Common\TimelineValueAlignment::fromValue("'.$input->options->alignValue.'")';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Statetimeline\FieldConfig && $input->fieldConfig->defaults->custom->lineWidth !== null && $input->fieldConfig->defaults->custom->lineWidth !== 0) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Statetimeline\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Statetimeline\FieldConfig && $input->fieldConfig->defaults->custom->fillOpacity !== null && $input->fieldConfig->defaults->custom->fillOpacity !== 70) {
