...
class Options implements \JsonSerializable
{
     ...
     */
    public function __construct(?\Grafana\Foundation\Common\BigValueGraphMode $graphMode = null, ?\Grafana\Foundation\Common\BigValueColorMode $colorMode = null, ?\Grafana\Foundation\Common\BigValueJustifyMode $justifyMode = null, ?\Grafana\Foundation\Common\BigValueTextMode $textMode = null, ?bool $wideLayout = null, ?\Grafana\Foundation\Common\ReduceDataOptions $reduceOptions = null, ?\Grafana\Foundation\Common\VizTextDisplayOptions $text = null, ?bool $showPercentChange = null, ?\Grafana\Foundation\Common\VizOrientation $orientation = null)
    {
    ...
    {
        /** @var array{graphMode?: string, colorMode?: string, justifyMode?: string, textMode?: string, wideLayout?: bool, reduceOptions?: mixed, text?: mixed, showPercentChange?: bool, orientation?: string} $inputData */
        $data = $inputData;
        return new self(
    ...
    public function jsonSerialize(): mixed
    {
        ...
        $data->wideLayout = $this->wideLayout;
        $data->reduceOptions = $this->reduceOptions;
        $data->showPercentChange = $this->showPercentChange;
