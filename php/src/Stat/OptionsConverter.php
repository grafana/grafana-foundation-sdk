...
final class OptionsConverter
{
    ...
    $buffer = 'wideLayout(';
        $arg0 =\var_export($input->wideLayout, true);
        $buffer .= $arg0;
    ...
    $buffer = 'showPercentChange(';
        $arg0 =\var_export($input->showPercentChange, true);
        $buffer .= $arg0;
    ...
    $buffer = 'percentChangeColorMode(';
        $arg0 ='\Grafana\Foundation\Common\PercentChangeColorMode::fromValue("'.$input->percentChangeColorMode.'")';
        $buffer .= $arg0;
