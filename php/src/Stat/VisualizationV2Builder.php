...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Stat\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Stat\Options);
        $this->internal->spec->options->graphMode = $graphMode;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Stat\Options);
        $this->internal->spec->options->colorMode = $colorMode;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Stat\Options);
        $this->internal->spec->options->justifyMode = $justifyMode;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Stat\Options);
        $this->internal->spec->options->textMode = $textMode;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Stat\Options);
        $this->internal->spec->options->wideLayout = $wideLayout;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Stat\Options);
        $this->internal->spec->options->showPercentChange = $showPercentChange;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Stat\Options);
        $this->internal->spec->options->percentChangeColorMode = $percentChangeColorMode;
