...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Xychart\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->show !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->pointSize !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->lineWidth !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisPlacement !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisColorMode !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisLabel !== null && $input->fieldConfig->defaults->custom->axisLabel !== "") {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisWidth !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisSoftMin !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisSoftMax !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisGridShow !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->scaleDistribution !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisCenteredZero !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Xychart\FieldConfig && $input->fieldConfig->defaults->custom->axisBorderShow !== null) {
    ...
    $buffer = 'dims(';
        $arg0 ='(new \Grafana\Foundation\Xychart\XYDimensionConfig(frame: '.\var_export($input->options->dims->frame, true).','.(($input->options->dims->x !== null) ? 'x: '.\var_export($input->options->dims->x, true).', ' : '').''.(($input->options->dims->exclude !== null) ? 'exclude: '.\var_export($input->options->dims->exclude, true).', ' : '').'))';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Xychart\Options && count($input->options->series) >= 1) {
    
        
    $buffer = 'series(';
        $tmparg0 = [];
        foreach ($input->options->series as $arg1) {
        $tmpseriesarg1 ='(new \Grafana\Foundation\Xychart\ScatterSeriesConfig('.(($arg1->x !== null) ? 'x: '.\var_export($arg1->x, true).', ' : '').''.(($arg1->y !== null) ? 'y: '.\var_export($arg1->y, true).', ' : '').''.(($arg1->name !== null) ? 'name: '.\var_export($arg1->name, true).', ' : '').''.(($arg1->show !== null) ? 'show: '.'\Grafana\Foundation\Xychart\ScatterShow::fromValue("'.$arg1->show.'")'.', ' : '').''.(($arg1->pointSize !== null) ? 'pointSize: '.'(new \Grafana\Foundation\Common\ScaleDimensionConfig(min: '.\var_export($arg1->pointSize->min, true).',max: '.\var_export($arg1->pointSize->max, true).','.(($arg1->pointSize->fixed !== null) ? 'fixed: '.\var_export($arg1->pointSize->fixed, true).', ' : '').''.(($arg1->pointSize->field !== null) ? 'field: '.\var_export($arg1->pointSize->field, true).', ' : '').''.(($arg1->pointSize->mode !== null) ? 'mode: '.'\Grafana\Foundation\Common\ScaleDimensionMode::fromValue("'.$arg1->pointSize->mode.'")'.', ' : '').'))'.', ' : '').''.(($arg1->pointColor !== null) ? 'pointColor: '.'(new \Grafana\Foundation\Common\ColorDimensionConfig('.(($arg1->pointColor->fixed !== null) ? 'fixed: '.\var_export($arg1->pointColor->fixed, true).', ' : '').''.(($arg1->pointColor->field !== null) ? 'field: '.\var_export($arg1->pointColor->field, true).', ' : '').'))'.', ' : '').''.(($arg1->lineColor !== null) ? 'lineColor: '.'(new \Grafana\Foundation\Common\ColorDimensionConfig('.(($arg1->lineColor->fixed !== null) ? 'fixed: '.\var_export($arg1->lineColor->fixed, true).', ' : '').''.(($arg1->lineColor->field !== null) ? 'field: '.\var_export($arg1->lineColor->field, true).', ' : '').'))'.', ' : '').''.(($arg1->lineWidth !== null) ? 'lineWidth: '.\var_export($arg1->lineWidth, true).', ' : '').''.(($arg1->lineStyle !== null) ? 'lineStyle: '.'(new \Grafana\Foundation\Common\LineStyle('.(($arg1->lineStyle->fill !== null) ? 'fill: '.'\Grafana\Foundation\Common\LineStyleFill::fromValue("'.$arg1->lineStyle->fill.'")'.', ' : '').''.(($arg1->lineStyle->dash !== null) ? 'dash: '.\var_export($arg1->lineStyle->dash, true).', ' : '').'))'.', ' : '').''.(($arg1->label !== null) ? 'label: '.'\Grafana\Foundation\Common\VisibilityMode::fromValue("'.$arg1->label.'")'.', ' : '').''.(($arg1->hideFrom !== null) ? 'hideFrom: '.'(new \Grafana\Foundation\Common\HideSeriesConfig(tooltip: '.\var_export($arg1->hideFrom->tooltip, true).',legend: '.\var_export($arg1->hideFrom->legend, true).',viz: '.\var_export($arg1->hideFrom->viz, true).',))'.', ' : '').''.(($arg1->axisPlacement !== null) ? 'axisPlacement: '.'\Grafana\Foundation\Common\AxisPlacement::fromValue("'.$arg1->axisPlacement.'")'.', ' : '').''.(($arg1->axisColorMode !== null) ? 'axisColorMode: '.'\Grafana\Foundation\Common\AxisColorMode::fromValue("'.$arg1->axisColorMode.'")'.', ' : '').''.(($arg1->axisLabel !== null) ? 'axisLabel: '.\var_export($arg1->axisLabel, true).', ' : '').''.(($arg1->axisWidth !== null) ? 'axisWidth: '.\var_export($arg1->axisWidth, true).', ' : '').''.(($arg1->axisSoftMin !== null) ? 'axisSoftMin: '.\var_export($arg1->axisSoftMin, true).', ' : '').''.(($arg1->axisSoftMax !== null) ? 'axisSoftMax: '.\var_export($arg1->axisSoftMax, true).', ' : '').''.(($arg1->axisGridShow !== null) ? 'axisGridShow: '.\var_export($arg1->axisGridShow, true).', ' : '').''.(($arg1->scaleDistribution !== null) ? 'scaleDistribution: '.'(new \Grafana\Foundation\Common\ScaleDistributionConfig(type: '.'\Grafana\Foundation\Common\ScaleDistribution::fromValue("'.$arg1->scaleDistribution->type.'")'.','.(($arg1->scaleDistribution->log !== null) ? 'log: '.\var_export($arg1->scaleDistribution->log, true).', ' : '').''.(($arg1->scaleDistribution->linearThreshold !== null) ? 'linearThreshold: '.\var_export($arg1->scaleDistribution->linearThreshold, true).', ' : '').'))'.', ' : '').''.(($arg1->axisCenteredZero !== null) ? 'axisCenteredZero: '.\var_export($arg1->axisCenteredZero, true).', ' : '').''.(($arg1->frame !== null) ? 'frame: '.\var_export($arg1->frame, true).', ' : '').''.(($arg1->labelValue !== null) ? 'labelValue: '.'(new \Grafana\Foundation\Common\TextDimensionConfig(mode: '.'\Grafana\Foundation\Common\TextDimensionMode::fromValue("'.$arg1->labelValue->mode.'")'.','.(($arg1->labelValue->field !== null) ? 'field: '.\var_export($arg1->labelValue->field, true).', ' : '').''.(($arg1->labelValue->fixed !== null) ? 'fixed: '.\var_export($arg1->labelValue->fixed, true).', ' : '').'))'.', ' : '').''.(($arg1->axisBorderShow !== null) ? 'axisBorderShow: '.\var_export($arg1->axisBorderShow, true).', ' : '').'))';
