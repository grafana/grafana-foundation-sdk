...
final class VisualizationV2Converter
{
    public static function convert(\Grafana\Foundation\Dashboardv2\VizConfigKind $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Debug\VisualizationV2Builder())',
        ];
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Debug\Options) {
    
        
    $buffer = 'mode(';
        $arg0 ='\Grafana\Foundation\Debug\DebugMode::fromValue("'.$input->spec->options->mode.'")';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Debug\Options && $input->spec->options->counters !== null) {
    
        
    $buffer = 'counters(';
        $arg0 = \Grafana\Foundation\Debug\UpdateConfigConverter::convert($input->spec->options->counters);
        $buffer .= $arg0;
