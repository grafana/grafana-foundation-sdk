...
{
    public static function convert(\Grafana\Foundation\Preferencesv1alpha1\NavbarPreference $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Preferencesv1alpha1\NavbarPreferenceBuilder())',
        ];
