...
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\AnnotationPanelFilter $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2beta1\AnnotationPanelFilterBuilder())',
        ];
