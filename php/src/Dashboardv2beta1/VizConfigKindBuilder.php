...
class VizConfigKindBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    public function spec(\Grafana\Foundation\Dashboardv2beta1\VizConfigSpec $spec): static
    {
    ...
    public function fieldConfig(\Grafana\Foundation\Dashboardv2beta1\FieldConfigSource $fieldConfig): static
    {
     ...
     */
    public function defaults(\Grafana\Foundation\Dashboardv2beta1\FieldConfig $defaults): static
    {
