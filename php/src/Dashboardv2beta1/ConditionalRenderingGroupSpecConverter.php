...
final class ConditionalRenderingGroupSpecConverter
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\ConditionalRenderingGroupSpec $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2beta1\ConditionalRenderingGroupSpecBuilder())',
        ];
            
    
        {
    $buffer = 'visibility(';
        $arg0 ='\Grafana\Foundation\Dashboardv2beta1\ConditionalRenderingGroupSpecVisibility::fromValue("'.$input->visibility.'")';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'condition(';
        $arg0 ='\Grafana\Foundation\Dashboardv2beta1\ConditionalRenderingGroupSpecCondition::fromValue("'.$input->condition.'")';
        $buffer .= $arg0;
