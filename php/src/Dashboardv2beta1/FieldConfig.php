...
class FieldConfig implements \JsonSerializable
{
     ...
     * @var array<\Grafana\Foundation\Dashboardv2beta1\ValueMap|\Grafana\Foundation\Dashboardv2beta1\RangeMap|\Grafana\Foundation\Dashboardv2beta1\RegexMap|\Grafana\Foundation\Dashboardv2beta1\SpecialValueMap>|null
     */
     ...
     */
    public ?\Grafana\Foundation\Dashboardv2beta1\ThresholdsConfig $thresholds;

    /**
     * Panel color configuration
     */
    public ?\Grafana\Foundation\Dashboardv2beta1\FieldColor $color;
     ...
     * @var array<\Grafana\Foundation\Dashboardv2beta1\Action>|null
     */
     ...
     * @param array<\Grafana\Foundation\Dashboardv2beta1\ValueMap|\Grafana\Foundation\Dashboardv2beta1\RangeMap|\Grafana\Foundation\Dashboardv2beta1\RegexMap|\Grafana\Foundation\Dashboardv2beta1\SpecialValueMap>|null $mappings
     * @param \Grafana\Foundation\Dashboardv2beta1\ThresholdsConfig|null $thresholds
     * @param \Grafana\Foundation\Dashboardv2beta1\FieldColor|null $color
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2beta1\ThresholdsConfig::fromArray($val);
    })($data["thresholds"]) : null,
            color: isset($data["color"]) ? (function($input) {
    	/** @var array{mode?: string, fixedColor?: string, seriesBy?: string} */
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2beta1\FieldColor::fromArray($val);
    })($data["color"]) : null,
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2beta1\Action::fromArray($val);
    }), $data["actions"] ?? [])),
