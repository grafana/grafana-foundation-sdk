...
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\FetchOptions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2beta1\FetchOptionsBuilder())',
        ];
