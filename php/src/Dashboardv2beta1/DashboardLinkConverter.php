...
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\DashboardLink $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2beta1\DashboardLinkBuilder())',
        ];
            if ($input->title !== "") {
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'type(';
        $arg0 ='\Grafana\Foundation\Dashboardv2beta1\DashboardLinkType::fromValue("'.$input->type.'")';
        $buffer .= $arg0;
    ...
    $buffer = 'placement(';
        $arg0 ='\Grafana\Foundation\Dashboardv2beta1\DashboardLinkPlacement::fromValue("'.$input->placement.'")';
        $buffer .= $arg0;
