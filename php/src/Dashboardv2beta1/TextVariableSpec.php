...
class TextVariableSpec implements \JsonSerializable
{
     ...
     */
    public function __construct(?string $name = null, ?\Grafana\Foundation\Dashboardv2beta1\VariableOption $current = null, ?string $query = null, ?string $label = null, ?\Grafana\Foundation\Dashboardv2beta1\VariableHide $hide = null, ?bool $skipUrlSync = null, ?string $description = null, ?\Grafana\Foundation\Dashboardv2beta1\ControlSourceRef $origin = null)
    {
        $this->name = $name ?: "";
