...
class FieldConfigSource implements \JsonSerializable
{
    ...
    public static function fromArray(array $inputData): self
    {
    	...
    	/** @var array{displayName?: string, displayNameFromDS?: string, description?: string, path?: string, writeable?: bool, filterable?: bool, unit?: string, decimals?: float, min?: float, max?: float, mappings?: array<mixed|mixed|mixed|mixed>, thresholds?: mixed, color?: mixed, links?: array<mixed>, actions?: array<mixed>, noValue?: string, custom?: mixed} */
    $val = $input;
