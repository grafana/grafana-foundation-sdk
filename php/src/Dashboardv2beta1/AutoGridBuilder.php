...
class AutoGridBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {
        $this->internal->spec->items[] = new \Grafana\Foundation\Dashboardv2beta1\AutoGridLayoutItemKind(
            spec: new \Grafana\Foundation\Dashboardv2beta1\AutoGridLayoutItemSpec(
            element: new \Grafana\Foundation\Dashboardv2beta1\ElementReference(
            name: $name,
        ),
        ),
        );
