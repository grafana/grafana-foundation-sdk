...
final class InfinityOptionsConverter
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\InfinityOptions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2beta1\InfinityOptionsBuilder())',
        ];
            
    
        {
    $buffer = 'method(';
        $arg0 ='\Grafana\Foundation\Dashboardv2beta1\HttpRequestMethod::fromValue("'.$input->method.'")';
        $buffer .= $arg0;
