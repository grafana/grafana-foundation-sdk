...
class DashboardLink implements \JsonSerializable
{
     ...
     */
    public ?\Grafana\Foundation\Dashboardv2beta1\DashboardLinkPlacement $placement;
     ...
     * @param \Grafana\Foundation\Dashboardv2beta1\DashboardLinkPlacement|null $placement
     * @param \Grafana\Foundation\Dashboardv2beta1\ControlSourceRef|null $origin
     */
    public function __construct(?string $title = null, ?\Grafana\Foundation\Dashboardv2beta1\DashboardLinkType $type = null, ?string $icon = null, ?string $tooltip = null, ?string $url = null, ?array $tags = null, ?bool $asDropdown = null, ?bool $targetBlank = null, ?bool $includeVars = null, ?bool $keepTime = null, ?\Grafana\Foundation\Dashboardv2beta1\DashboardLinkPlacement $placement = null, ?\Grafana\Foundation\Dashboardv2beta1\ControlSourceRef $origin = null)
    {
        $this->title = $title ?: "";
    ...
    public static function fromArray(array $inputData): self
    {
        ...
        return new self(
            ...
            placement: isset($data["placement"]) ? (function($input) { return \Grafana\Foundation\Dashboardv2beta1\DashboardLinkPlacement::fromValue($input); })($data["placement"]) : null,
