...
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\ValueMappingResult $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2beta1\ValueMappingResultBuilder())',
        ];
