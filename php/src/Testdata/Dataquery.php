...
class Dataquery implements \JsonSerializable, \Grafana\Foundation\Cog\Dataquery
{
     ...
     * The datasource
     */
    public ?\Grafana\Foundation\Testdata\Datasource $datasource;
     ...
     * @param \Grafana\Foundation\Testdata\Datasource|null $datasource
    ...
    $val = $input;
    	return \Grafana\Foundation\Testdata\Datasource::fromArray($val);
