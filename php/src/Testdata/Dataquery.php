...
class Dataquery implements \JsonSerializable, \Grafana\Foundation\Cog\Dataquery
{
    ...
    {
        /** @var array{alias?: string, scenarioId?: string, stringInput?: string, stream?: mixed, pulseWave?: mixed, sim?: mixed, csvWave?: array<mixed>, labels?: string, lines?: int, levelColumn?: bool, channel?: string, nodes?: mixed, csvFileName?: string, csvContent?: string, rawFrameContent?: string, seriesCount?: int, usa?: mixed, errorType?: string, spanCount?: int, points?: array<array<string|int>>, dropPercent?: float, refId?: string, hide?: bool, queryType?: string, datasource?: mixed} $inputData */
        $data = $inputData;
        return new self(
