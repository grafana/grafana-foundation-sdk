...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Candlestick\FieldConfig>
 */
class FieldConfigBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Candlestick\FieldConfig $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Candlestick\FieldConfig();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Candlestick\FieldConfig
     */
