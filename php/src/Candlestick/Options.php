...
class Options implements \JsonSerializable
{
     ...
     */
    public function __construct(?\Grafana\Foundation\Candlestick\VizDisplayMode $mode = null, ?\Grafana\Foundation\Candlestick\CandleStyle $candleStyle = null, ?\Grafana\Foundation\Candlestick\ColorStrategy $colorStrategy = null, ?\Grafana\Foundation\Candlestick\CandlestickFieldMap $fields = null, ?\Grafana\Foundation\Candlestick\CandlestickColors $colors = null, ?\Grafana\Foundation\Common\VizLegendOptions $legend = null, ?bool $includeAllFields = null)
    {
    ...
    {
        /** @var array{mode?: string, candleStyle?: string, colorStrategy?: string, fields?: mixed, colors?: mixed, legend?: mixed, includeAllFields?: bool} $inputData */
        $data = $inputData;
        return new self(
