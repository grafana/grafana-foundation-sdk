...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Gauge\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Gauge\Options && $input->options->showThresholdLabels !== false) {
    
        
    $buffer = 'showThresholdLabels(';
        $arg0 =\var_export($input->options->showThresholdLabels, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Gauge\Options && $input->options->showThresholdMarkers !== true) {
    
        
    $buffer = 'showThresholdMarkers(';
        $arg0 =\var_export($input->options->showThresholdMarkers, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Gauge\Options) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Gauge\Options && $input->options->minVizWidth !== 75) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Gauge\Options && $input->options->text !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Gauge\Options && $input->options->minVizHeight !== 75) {
