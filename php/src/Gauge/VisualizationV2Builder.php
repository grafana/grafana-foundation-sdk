...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Gauge\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Gauge\Options);
        $this->internal->spec->options->showThresholdLabels = $showThresholdLabels;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Gauge\Options);
        $this->internal->spec->options->showThresholdMarkers = $showThresholdMarkers;
