...
class VisualizationBuilder implements \Grafana\Foundation\Cog\Builder
{
     ...
     */
    public function layoutAlgorithm(\Grafana\Foundation\Nodegraph\LayoutAlgorithm $layoutAlgorithm): static
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Nodegraph\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Nodegraph\Options);
        $this->internal->spec->options->layoutAlgorithm = $layoutAlgorithm;
