...
final class VisualizationConverter
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\VizConfigKind $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Nodegraph\VisualizationBuilder())',
        ];
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Nodegraph\Options && $input->spec->options->layoutAlgorithm !== null) {
    
        
    $buffer = 'layoutAlgorithm(';
        $arg0 ='\Grafana\Foundation\Nodegraph\LayoutAlgorithm::fromValue("'.$input->spec->options->layoutAlgorithm.'")';
        $buffer .= $arg0;
