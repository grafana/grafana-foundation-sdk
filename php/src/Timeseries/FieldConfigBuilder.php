...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Timeseries\FieldConfig>
 */
class FieldConfigBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Timeseries\FieldConfig $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Timeseries\FieldConfig();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Timeseries\FieldConfig
     */
