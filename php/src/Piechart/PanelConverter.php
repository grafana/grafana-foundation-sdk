...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Piechart\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Piechart\Options) {
    
        
    $buffer = 'pieType(';
        $arg0 ='\Grafana\Foundation\Piechart\PieChartType::fromValue("'.$input->options->pieType.'")';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Piechart\Options && $input->options->displayLabels !== null && count($input->options->displayLabels) >= 1) {
    
        
    $buffer = 'displayLabels(';
        $tmparg0 = [];
        foreach ($input->options->displayLabels as $arg1) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Piechart\Options && $input->options->text !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Piechart\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
