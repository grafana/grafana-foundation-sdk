...
final class PanelConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Piechart\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
