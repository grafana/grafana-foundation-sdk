...
class Dataquery implements \JsonSerializable, \Grafana\Foundation\Cog\Dataquery
{
     ...
     * @param \Grafana\Foundation\Prometheus\PrometheusDataqueryScope|null $scope
    ...
    {
        /** @var array{expr?: string, instant?: bool, range?: bool, exemplar?: bool, editorMode?: string, format?: string, legendFormat?: string, intervalFactor?: float, scope?: mixed, refId?: string, hide?: bool, queryType?: string, datasource?: mixed, interval?: string} $inputData */
        $data = $inputData;
        return new self(
            expr: $data["expr"] ?? null,
    	...
    	/** @var array{matchers?: string} */
    $val = $input;
    	return \Grafana\Foundation\Prometheus\PrometheusDataqueryScope::fromArray($val);
    })($data["scope"]) : null,
