...
{
    public static function convert(\Grafana\Foundation\Prometheus\ResultAssertions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Prometheus\ResultAssertionsBuilder())',
        ];
    ...
    $buffer = 'type(';
        $arg0 ='\Grafana\Foundation\Prometheus\ResultAssertionsType::fromValue("'.$input->type.'")';
        $buffer .= $arg0;
