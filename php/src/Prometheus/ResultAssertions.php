...
class ResultAssertions implements \JsonSerializable
{
     ...
     *  - `"log-lines"` 
     */
    public ?\Grafana\Foundation\Prometheus\ResultAssertionsType $type;
     ...
     * @param \Grafana\Foundation\Prometheus\ResultAssertionsType|null $type
     * @param array<int>|null $typeVersion
     */
    public function __construct(?int $maxFrames = null, ?\Grafana\Foundation\Prometheus\ResultAssertionsType $type = null, ?array $typeVersion = null)
    {
    ...
    public static function fromArray(array $inputData): self
    {
        ...
        return new self(
            ...
            type: isset($data["type"]) ? (function($input) { return \Grafana\Foundation\Prometheus\ResultAssertionsType::fromValue($input); })($data["type"]) : null,
