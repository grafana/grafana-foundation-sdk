...
final class ScopesFiltersConverter
{
    public static function convert(\Grafana\Foundation\Prometheus\ScopesFilters $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Prometheus\ScopesFiltersBuilder())',
        ];
            if ($input->key !== "") {
