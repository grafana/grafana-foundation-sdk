...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    public function bucketCount(int $bucketCount): static
    {
        ...
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Histogram\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Histogram\Options);
        $this->internal->spec->options->bucketCount = $bucketCount;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Histogram\Options);
        $this->internal->spec->options->bucketSize = $bucketSize;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Histogram\Options);
        $this->internal->spec->options->bucketOffset = $bucketOffset;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Histogram\Options);
        $this->internal->spec->options->combine = $combine;
    ...
    public function lineWidth(int $lineWidth): static
    {
        ...
        if ($this->internal->spec->fieldConfig->defaults->custom === null) {
            $this->internal->spec->fieldConfig->defaults->custom = new \Grafana\Foundation\Histogram\FieldConfig();
        }
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig);
