...
final class PanelConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Histogram\Options && $input->options->bucketCount !== null && $input->options->bucketCount !== 30) {
    
        
    $buffer = 'bucketCount(';
        $arg0 =\var_export($input->options->bucketCount, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->lineWidth !== null && $input->fieldConfig->defaults->custom->lineWidth !== 1) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->fillOpacity !== null && $input->fieldConfig->defaults->custom->fillOpacity !== 80) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisPlacement !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisColorMode !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisLabel !== null && $input->fieldConfig->defaults->custom->axisLabel !== "") {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisWidth !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisSoftMin !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisSoftMax !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisGridShow !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->scaleDistribution !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisCenteredZero !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->stacking !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->gradientMode !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Histogram\FieldConfig && $input->fieldConfig->defaults->custom->axisBorderShow !== null) {
