...
class FieldConfig implements \JsonSerializable
{
    ...
    {
        /** @var array{lineWidth?: int, fillOpacity?: int, axisPlacement?: string, axisColorMode?: string, axisLabel?: string, axisWidth?: float, axisSoftMin?: float, axisSoftMax?: float, axisGridShow?: bool, scaleDistribution?: mixed, axisCenteredZero?: bool, hideFrom?: mixed, gradientMode?: string, axisBorderShow?: bool} $inputData */
        $data = $inputData;
        return new self(
