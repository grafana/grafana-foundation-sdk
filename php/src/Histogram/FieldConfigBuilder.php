...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Histogram\FieldConfig>
 */
class FieldConfigBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Histogram\FieldConfig $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Histogram\FieldConfig();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Histogram\FieldConfig
     */
