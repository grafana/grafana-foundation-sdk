...
class Playlist implements \JsonSerializable
{
    ...
    /**
     * @var array<\Grafana\Foundation\Playlistv1\Item>
     */
    public array $items;
     ...
     * @param array<\Grafana\Foundation\Playlistv1\Item>|null $items
     */
    ...
    $val = $input;
    	return \Grafana\Foundation\Playlistv1\Item::fromArray($val);
    }), $data["items"] ?? [])),
        );
    }
