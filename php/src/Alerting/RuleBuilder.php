...
class RuleBuilder implements \Grafana\Foundation\Cog\Builder
{
     ...
     */
    public function notificationSettings(\Grafana\Foundation\Cog\Builder $notificationSettings): static
    {
        $notificationSettingsResource = $notificationSettings->build();
     ...
     */
    public function record(\Grafana\Foundation\Cog\Builder $record): static
    {
        $recordResource = $record->build();
