...
class NotificationPolicy implements \JsonSerializable
{
     ...
     * @param array<string, mixed>|null $matchRe
    ...
    {
        /** @var array{continue?: bool, group_by?: array<string>, group_interval?: string, group_wait?: string, match?: array<string, string>, match_re?: array<string, mixed>, matchers?: array<mixed>, mute_time_intervals?: array<string>, object_matchers?: array<mixed>, provenance?: string, receiver?: string, repeat_interval?: string, routes?: array<mixed>} $inputData */
        $data = $inputData;
        return new self(
    ...
    $val = $input;
    	...
    	/** @var array{continue?: bool, group_by?: array<string>, group_interval?: string, group_wait?: string, match?: array<string, string>, match_re?: array<string, mixed>, matchers?: array<mixed>, mute_time_intervals?: array<string>, object_matchers?: array<mixed>, provenance?: string, receiver?: string, repeat_interval?: string, routes?: array<mixed>} */
    $val = $input;
