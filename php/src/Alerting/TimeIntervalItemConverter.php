...
final class TimeIntervalItemConverter
{
    public static function convert(\Grafana\Foundation\Alerting\TimeIntervalItem $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Alerting\TimeIntervalItemBuilder())',
        ];
    ...
    $buffer = 'times(';
        ...
        $tmptimesarg1 = \Grafana\Foundation\Alerting\TimeIntervalTimeRangeConverter::convert($arg1);
