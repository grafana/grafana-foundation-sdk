...
final class RuleConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->notificationSettings !== null) {
    
        
    $buffer = 'notificationSettings(';
        $arg0 = \Grafana\Foundation\Alerting\NotificationSettingsConverter::convert($input->notificationSettings);
        $buffer .= $arg0;
    ...
    $buffer = 'record(';
        $arg0 = \Grafana\Foundation\Alerting\RecordRuleConverter::convert($input->record);
        $buffer .= $arg0;
