...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Trend\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Trend\Options);
    ...
    {    
        if ($this->internal->spec->fieldConfig->defaults->custom === null) {
            $this->internal->spec->fieldConfig->defaults->custom = new \Grafana\Foundation\Trend\FieldConfig();
        }
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Trend\FieldConfig);
