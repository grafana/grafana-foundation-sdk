...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Trend\FieldConfig>
 */
class FieldConfigBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Trend\FieldConfig $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Trend\FieldConfig();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Trend\FieldConfig
     */
