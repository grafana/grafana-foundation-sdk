...
class GraphFieldConfig implements \JsonSerializable
{
     ...
     */
    public function __construct(?\Grafana\Foundation\Common\GraphDrawStyle $drawStyle = null, ?\Grafana\Foundation\Common\GraphGradientMode $gradientMode = null, ?\Grafana\Foundation\Common\GraphThresholdsStyleConfig $thresholdsStyle = null, ?string $lineColor = null, ?float $lineWidth = null, ?\Grafana\Foundation\Common\LineInterpolation $lineInterpolation = null, ?\Grafana\Foundation\Common\LineStyle $lineStyle = null, ?string $fillColor = null, ?float $fillOpacity = null, ?\Grafana\Foundation\Common\VisibilityMode $showPoints = null, ?float $pointSize = null, ?string $pointColor = null, ?\Grafana\Foundation\Common\AxisPlacement $axisPlacement = null, ?\Grafana\Foundation\Common\AxisColorMode $axisColorMode = null, ?string $axisLabel = null, ?float $axisWidth = null, ?float $axisSoftMin = null, ?float $axisSoftMax = null, ?bool $axisGridShow = null, ?\Grafana\Foundation\Common\ScaleDistributionConfig $scaleDistribution = null, ?\Grafana\Foundation\Common\BarAlignment $barAlignment = null, ?float $barWidthFactor = null, ?\Grafana\Foundation\Common\StackingConfig $stacking = null, ?\Grafana\Foundation\Common\HideSeriesConfig $hideFrom = null, ?\Grafana\Foundation\Common\GraphTransform $transform = null,  $spanNulls = null, ?string $fillBelowTo = null, ?string $pointSymbol = null, ?bool $axisCenteredZero = null, ?float $barMaxWidth = null,  $insertNulls = null)
    {
