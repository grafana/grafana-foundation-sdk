...
class GraphFieldConfig implements \JsonSerializable
{
     ...
     * @param bool|float|null $insertNulls
    ...
    {
        /** @var array{drawStyle?: string, gradientMode?: string, thresholdsStyle?: mixed, transform?: string, lineColor?: string, lineWidth?: float, lineInterpolation?: string, lineStyle?: mixed, fillColor?: string, fillOpacity?: float, showPoints?: string, pointSize?: float, pointColor?: string, axisPlacement?: string, axisColorMode?: string, axisLabel?: string, axisWidth?: float, axisSoftMin?: float, axisSoftMax?: float, axisGridShow?: bool, scaleDistribution?: mixed, axisCenteredZero?: bool, barAlignment?: int, barWidthFactor?: float, stacking?: mixed, hideFrom?: mixed, insertNulls?: bool|float, spanNulls?: bool|float, fillBelowTo?: string, pointSymbol?: string, axisBorderShow?: bool, barMaxWidth?: float} $inputData */
        $data = $inputData;
        return new self(
