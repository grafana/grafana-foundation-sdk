...
final class AxisConfigConverter
{
    public static function convert(\Grafana\Foundation\Common\AxisConfig $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Common\AxisConfigBuilder())',
        ];
