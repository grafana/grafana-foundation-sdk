...
class TableFieldOptions implements \JsonSerializable
{
    ...
    {
        /** @var array{width?: float, minWidth?: float, align?: string, displayMode?: string, cellOptions?: mixed|mixed|mixed|mixed|mixed|mixed|mixed, hidden?: bool, inspect?: bool, filterable?: bool, hideHeader?: bool} $inputData */
        $data = $inputData;
        return new self(
