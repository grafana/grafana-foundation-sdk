...
final class TableSparklineCellOptionsConverter
{
    public static function convert(\Grafana\Foundation\Common\TableSparklineCellOptions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Common\TableSparklineCellOptionsBuilder())',
        ];
    ...
    $calls[] = $buffer;
            ...
            if ($input->hideValue !== null) {
    
        
    $buffer = 'hideValue(';
        $arg0 =\var_export($input->hideValue, true);
        $buffer .= $arg0;
    ...
    $buffer = 'insertNulls(';
        switch (true) {
            case is_bool($input->insertNulls):
                ...
                break;
            case is_float($input->insertNulls):
                $disjunctioninsertNulls =\var_export($input->insertNulls, true);
                $arg0 = $disjunctioninsertNulls;
                break;
            default:
