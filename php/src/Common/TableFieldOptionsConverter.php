    ...
    $buffer = 'cellOptions(';
        switch (true) {
            case $input->cellOptions instanceof \Grafana\Foundation\Common\TableAutoCellOptions:
                $disjunctioncellOptions = \Grafana\Foundation\Common\TableAutoCellOptionsConverter::convert($input->cellOptions);
            ...
            case $input->cellOptions instanceof \Grafana\Foundation\Common\TableColorTextCellOptions:
                $disjunctioncellOptions = \Grafana\Foundation\Common\TableColorTextCellOptionsConverter::convert($input->cellOptions);
                $arg0 = $disjunctioncellOptions;
                break;
            case $input->cellOptions instanceof \Grafana\Foundation\Common\TableImageCellOptions:
                $disjunctioncellOptions = \Grafana\Foundation\Common\TableImageCellOptionsConverter::convert($input->cellOptions);
                $arg0 = $disjunctioncellOptions;
                break;
