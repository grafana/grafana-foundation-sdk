    ...
    $buffer = 'cellOptions(';
        switch (true) {
            ...
            case $input->cellOptions instanceof \Grafana\Foundation\Common\TableColoredBackgroundCellOptions:
                $disjunctioncellOptions ='(new \Grafana\Foundation\Common\TableColoredBackgroundCellOptions(type: '.\var_export($input->cellOptions->type, true).','.(($input->cellOptions->mode !== null) ? 'mode: '.'\Grafana\Foundation\Common\TableCellBackgroundDisplayMode::fromValue("'.$input->cellOptions->mode.'")'.', ' : '').'))';
                $arg0 = $disjunctioncellOptions;
                break;
