...
class QueryBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec === null) {
            $this->internal->spec = new \Grafana\Foundation\Grafanapyroscope\Dataquery();
        }
        assert($this->internal->spec instanceof \Grafana\Foundation\Grafanapyroscope\Dataquery);
