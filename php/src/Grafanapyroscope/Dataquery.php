...
class Dataquery implements \JsonSerializable, \Grafana\Foundation\Cog\Dataquery
{
     ...
     */
    public function __construct(?string $labelSelector = null, ?string $profileTypeId = null, ?array $groupBy = null, ?int $maxNodes = null, ?string $refId = null, ?bool $hide = null, ?string $queryType = null, ?\Grafana\Foundation\Dashboard\DataSourceRef $datasource = null)
    {
    ...
    {
        /** @var array{labelSelector?: string, profileTypeId?: string, groupBy?: array<string>, maxNodes?: int, refId?: string, hide?: bool, queryType?: string, datasource?: mixed} $inputData */
        $data = $inputData;
        return new self(
