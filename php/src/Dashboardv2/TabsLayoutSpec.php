...
{
    /**
     * @var array<\Grafana\Foundation\Dashboardv2\TabsLayoutTabKind>
     */
    public array $tabs;

    /**
     * @param array<\Grafana\Foundation\Dashboardv2\TabsLayoutTabKind>|null $tabs
     */
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\TabsLayoutTabKind::fromArray($val);
    }), $data["tabs"] ?? [])),
        );
    }
