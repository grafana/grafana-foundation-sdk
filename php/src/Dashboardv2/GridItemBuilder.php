...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\GridLayoutItemKind>
 */
class GridItemBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\GridLayoutItemKind $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\GridLayoutItemKind();
    ...
    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\GridLayoutItemKind
     */
    ...
    /**
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\RepeatOptions> $repeat
     */
