...
class AnnotationQuerySpec implements \JsonSerializable
{
    ...
    public ?\Grafana\Foundation\Dashboardv2\AnnotationPanelFilter $filter;

    /**
     * Placement can be used to display the annotation query somewhere else on the dashboard other than the default location.
     */
    public ?\Grafana\Foundation\Dashboardv2\AnnotationQueryPlacement $placement;

    /**
     * Mappings define how to convert data frame fields to annotation event fields.
     * @var array<string, \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping>|null
     */
     ...
     * @param \Grafana\Foundation\Dashboardv2\AnnotationPanelFilter|null $filter
     * @param \Grafana\Foundation\Dashboardv2\AnnotationQueryPlacement|null $placement
     * @param array<string, \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping>|null $mappings
     * @param array<string, mixed>|null $legacyOptions
     */
    public function __construct(?\Grafana\Foundation\Dashboardv2\DataQueryKind $query = null, ?bool $enable = null, ?bool $hide = null, ?string $iconColor = null, ?string $name = null, ?bool $builtIn = null, ?\Grafana\Foundation\Dashboardv2\AnnotationPanelFilter $filter = null, ?\Grafana\Foundation\Dashboardv2\AnnotationQueryPlacement $placement = null, ?array $mappings = null, ?array $legacyOptions = null)
    {
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\AnnotationPanelFilter::fromArray($val);
    })($data["filter"]) : null,
            placement: isset($data["placement"]) ? (function($input) { return \Grafana\Foundation\Dashboardv2\AnnotationQueryPlacement::fromValue($input); })($data["placement"]) : null,
            mappings: isset($data["mappings"]) ? (function($input) {
        /** @var array<string, \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping> $results */
        $results = [];
        foreach ($input as $key => $val) {
            $results[$key] = isset($val) ? (function($input) {
    	/** @var array{source?: string, value?: string, regex?: string} */
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping::fromArray($val);
    })($val) : null;
        }
