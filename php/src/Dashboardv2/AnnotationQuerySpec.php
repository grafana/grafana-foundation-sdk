...
class AnnotationQuerySpec implements \JsonSerializable
{
     ...
     */
    public function __construct(?\Grafana\Foundation\Dashboardv2\DataQueryKind $query = null, ?bool $enable = null, ?bool $hide = null, ?string $iconColor = null, ?string $name = null, ?bool $builtIn = null, ?\Grafana\Foundation\Dashboardv2\AnnotationPanelFilter $filter = null, ?array $mappings = null, ?array $legacyOptions = null)
    {
        ...
        $this->filter = $filter;
        $this->placement = \Grafana\Foundation\Dashboardv2\Constants::ANNOTATION_QUERY_PLACEMENT;
