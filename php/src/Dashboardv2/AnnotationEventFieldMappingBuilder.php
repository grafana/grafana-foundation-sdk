 ...
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping>
 */
class AnnotationEventFieldMappingBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping
     */
