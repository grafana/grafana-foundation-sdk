...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\TimeSettingsSpec $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\TimeSettingsBuilder())',
        ];
    ...
    $buffer = 'quickRanges(';
        ...
        $tmpquickRangesarg1 = \Grafana\Foundation\Dashboardv2\TimeRangeOptionConverter::convert($arg1);
    ...
    $buffer = 'weekStart(';
        $arg0 ='\Grafana\Foundation\Dashboardv2\TimeSettingsSpecWeekStart::fromValue("'.$input->weekStart.'")';
        $buffer .= $arg0;
