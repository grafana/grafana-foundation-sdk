...
final class TextVariableConverter
{
    public static function convert(\Grafana\Foundation\Dashboardv2\TextVariableKind $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\TextVariableBuilder('.\var_export($input->spec->name, true).'))',
        ];
            if ($input->spec->name !== "") {
