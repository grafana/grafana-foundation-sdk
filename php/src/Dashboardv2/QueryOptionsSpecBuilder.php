...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\QueryOptionsSpec>
 */
class QueryOptionsSpecBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\QueryOptionsSpec $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\QueryOptionsSpec();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\QueryOptionsSpec
     */
