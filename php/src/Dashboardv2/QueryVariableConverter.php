...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\QueryVariableKind $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\QueryVariableBuilder('.\var_export($input->spec->name, true).'))',
        ];
            if ($input->spec->name !== "") {
    ...
    $buffer = 'regexApplyTo(';
        $arg0 ='\Grafana\Foundation\Dashboardv2\VariableRegexApplyTo::fromValue("'.$input->spec->regexApplyTo.'")';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'sort(';
        $arg0 ='\Grafana\Foundation\Dashboardv2\VariableSort::fromValue("'.$input->spec->sort.'")';
        $buffer .= $arg0;
    ...
    $buffer = 'staticOptions(';
        ...
        $tmpstaticOptionsarg1 ='(new \Grafana\Foundation\Dashboardv2\VariableOption('.(($arg1->selected !== null) ? 'selected: '.\var_export($arg1->selected, true).', ' : '').'text: '.\var_export($arg1->text, true).',value: '.\var_export($arg1->value, true).','.(($arg1->properties !== null) ? 'properties: '.\var_export($arg1->properties, true).', ' : '').'))';
    ...
    $buffer = 'staticOptionsOrder(';
        $arg0 ='\Grafana\Foundation\Dashboardv2\QueryVariableSpecStaticOptionsOrder::fromValue("'.$input->spec->staticOptionsOrder.'")';
        $buffer .= $arg0;
