...
/**
 * Adhoc variable kind
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\AdhocVariableKind>
 */
class AdhocVariableBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\AdhocVariableKind $internal;

    public function __construct(string $name)
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\AdhocVariableKind();
    ...
    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\AdhocVariableKind
     */
