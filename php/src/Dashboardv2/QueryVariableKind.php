...
class QueryVariableKind implements \JsonSerializable
{
    ...
    public \Grafana\Foundation\Dashboardv2\QueryVariableSpec $spec;

    /**
     * @param \Grafana\Foundation\Dashboardv2\QueryVariableSpec|null $spec
     */
    public function __construct(?\Grafana\Foundation\Dashboardv2\QueryVariableSpec $spec = null)
    {
        $this->kind = "QueryVariable";
    
        $this->spec = $spec ?: new \Grafana\Foundation\Dashboardv2\QueryVariableSpec();
    }
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\QueryVariableSpec::fromArray($val);
    })($data["spec"]) : null,
        );
    }
