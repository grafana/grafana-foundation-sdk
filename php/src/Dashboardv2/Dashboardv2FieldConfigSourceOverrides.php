...
class Dashboardv2FieldConfigSourceOverrides implements \JsonSerializable
{
     ...
     * @param \Grafana\Foundation\Dashboardv2\MatcherConfig|null $matcher
     * @param array<\Grafana\Foundation\Dashboardv2\DynamicConfigValue>|null $properties
     */
    public function __construct(?string $systemRef = null, ?\Grafana\Foundation\Dashboardv2\MatcherConfig $matcher = null, ?array $properties = null)
    {
        $this->systemRef = $systemRef;
        $this->matcher = $matcher ?: new \Grafana\Foundation\Dashboardv2\MatcherConfig();
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\DynamicConfigValue::fromArray($val);
    }), $data["properties"] ?? [])),
        );
    }
