...
{
    /**
     * @var array<\Grafana\Foundation\Dashboardv2\AnnotationQueryKind>
     */
     ...
     */
    public \Grafana\Foundation\Dashboardv2\DashboardCursorSync $cursorSync;
    ...
    /**
     * @var array<string, \Grafana\Foundation\Dashboardv2\PanelKind|\Grafana\Foundation\Dashboardv2\LibraryPanelKind>
     */
     ...
     * @var array<\Grafana\Foundation\Dashboardv2\DashboardLink>
     */
    public array $links;
    ...
    public \Grafana\Foundation\Dashboardv2\TimeSettingsSpec $timeSettings;
     ...
     * @param array<\Grafana\Foundation\Dashboardv2\DashboardLink>|null $links
     * @param bool|null $liveNow
     * @param bool|null $preload
     * @param int|null $revision
     * @param array<string>|null $tags
     * @param \Grafana\Foundation\Dashboardv2\TimeSettingsSpec|null $timeSettings
     ...
     * @param \Grafana\Foundation\Dashboardv2\Preferences|null $preferences
     */
    public function __construct(?array $annotations = null, ?\Grafana\Foundation\Dashboardv2\DashboardCursorSync $cursorSync = null, ?string $description = null, ?bool $editable = null, ?array $elements = null,  $layout = null, ?array $links = null, ?bool $liveNow = null, ?bool $preload = null, ?int $revision = null, ?array $tags = null, ?\Grafana\Foundation\Dashboardv2\TimeSettingsSpec $timeSettings = null, ?string $title = null, ?array $variables = null, ?\Grafana\Foundation\Dashboardv2\Preferences $preferences = null)
    {
        $this->annotations = $annotations ?: [];
        $this->cursorSync = $cursorSync ?: \Grafana\Foundation\Dashboardv2\DashboardCursorSync::off();
        ...
        $this->tags = $tags ?: [];
        $this->timeSettings = $timeSettings ?: new \Grafana\Foundation\Dashboardv2\TimeSettingsSpec();
        $this->title = $title ?: "";
    ...
    {
        /** @var array{annotations?: array<mixed>, cursorSync?: string, description?: string, editable?: bool, elements?: array<string, mixed|mixed>, layout?: mixed|mixed|mixed|mixed, links?: array<mixed>, liveNow?: bool, preload?: bool, revision?: int, tags?: array<string>, timeSettings?: mixed, title?: string, variables?: array<mixed|mixed|mixed|mixed|mixed|mixed|mixed|mixed|mixed>, preferences?: mixed} $inputData */
        $data = $inputData;
        return new self(
            annotations: array_filter(array_map((function($input) {
    	/** @var array{kind?: string, spec?: mixed} */
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\AnnotationQueryKind::fromArray($val);
    }), $data["annotations"] ?? [])),
            cursorSync: isset($data["cursorSync"]) ? (function($input) { return \Grafana\Foundation\Dashboardv2\DashboardCursorSync::fromValue($input); })($data["cursorSync"]) : null,
            description: $data["description"] ?? null,
            editable: $data["editable"] ?? null,
            elements: isset($data["elements"]) ? (function($input) {
        /** @var array<string, \Grafana\Foundation\Dashboardv2\PanelKind|\Grafana\Foundation\Dashboardv2\LibraryPanelKind> $results */
        $results = [];
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\DashboardLink::fromArray($val);
    }), $data["links"] ?? [])),
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\TimeSettingsSpec::fromArray($val);
        ...
        default:
            ...
            preferences: isset($data["preferences"]) ? (function($input) {
    	/** @var array{layout?: mixed|mixed} */
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\Preferences::fromArray($val);
