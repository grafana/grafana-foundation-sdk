...
class DatasourceVariableSpec implements \JsonSerializable
{
     ...
     */
    public function __construct(?string $name = null, ?string $pluginId = null, ?\Grafana\Foundation\Dashboardv2\VariableRefresh $refresh = null, ?string $regex = null, ?\Grafana\Foundation\Dashboardv2\VariableOption $current = null, ?array $options = null, ?bool $multi = null, ?bool $includeAll = null, ?string $allValue = null, ?string $label = null, ?\Grafana\Foundation\Dashboardv2\VariableHide $hide = null, ?bool $skipUrlSync = null, ?string $description = null, ?bool $allowCustomValue = null, ?\Grafana\Foundation\Dashboardv2\ControlSourceRef $origin = null)
    {
        $this->name = $name ?: "";
