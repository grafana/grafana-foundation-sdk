...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\AdHocFilterWithLabels $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\AdHocFilterWithLabelsBuilder())',
        ];
            if ($input->key !== "") {
