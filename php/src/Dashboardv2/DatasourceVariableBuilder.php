 ...
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\DatasourceVariableKind>
 */
class DatasourceVariableBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\DatasourceVariableKind $internal;

    public function __construct(string $name)
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\DatasourceVariableKind();
    ...
    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\DatasourceVariableKind
     */
