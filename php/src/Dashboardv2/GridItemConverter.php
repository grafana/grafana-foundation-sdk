...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\GridLayoutItemKind $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\GridItemBuilder())',
        ];
    ...
    $buffer = 'repeat(';
        $arg0 = \Grafana\Foundation\Dashboardv2\RepeatOptionsConverter::convert($input->spec->repeat);
        $buffer .= $arg0;
