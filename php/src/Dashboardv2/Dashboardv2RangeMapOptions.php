...
class Dashboardv2RangeMapOptions implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(?float $from = null, ?float $to = null, ?\Grafana\Foundation\Dashboardv2\ValueMappingResult $result = null)
    {
        $this->from = $from;
        $this->to = $to;
