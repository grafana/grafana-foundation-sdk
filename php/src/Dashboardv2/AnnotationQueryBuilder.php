...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\AnnotationQueryKind>
 */
class AnnotationQueryBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\AnnotationQueryKind $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\AnnotationQueryKind();
    $this->internal->kind = "AnnotationQuery";
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\AnnotationQueryKind
     */
    ...
    /**
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\AnnotationPanelFilter> $filter
     */
     ...
     */
    public function placement(\Grafana\Foundation\Dashboardv2\AnnotationQueryPlacement $placement): static
    {
     ...
     * @param array<string, \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping>> $mappings
     */
