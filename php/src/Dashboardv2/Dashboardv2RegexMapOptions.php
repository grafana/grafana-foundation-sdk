...
class Dashboardv2RegexMapOptions implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(?string $pattern = null, ?\Grafana\Foundation\Dashboardv2\ValueMappingResult $result = null)
    {
