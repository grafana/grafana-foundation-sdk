...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\AnnotationPanelFilter $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\AnnotationPanelFilterBuilder())',
        ];
