...
class ValueMap implements \JsonSerializable
{
     ...
     * @var array<string, \Grafana\Foundation\Dashboardv2\ValueMappingResult>
     */
    public array $options;

    /**
     * @param array<string, \Grafana\Foundation\Dashboardv2\ValueMappingResult>|null $options
     */
    ...
    public static function fromArray(array $inputData): self
    {
        ...
        /** @var array<string, \Grafana\Foundation\Dashboardv2\ValueMappingResult> $results */
        $results = [];
