...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\ValueMappingResult $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\ValueMappingResultBuilder())',
        ];
