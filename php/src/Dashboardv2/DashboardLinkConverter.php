...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\DashboardLink $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\DashboardLinkBuilder())',
        ];
            if ($input->title !== "") {
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'type(';
        $arg0 ='\Grafana\Foundation\Dashboardv2\DashboardLinkType::fromValue("'.$input->type.'")';
        $buffer .= $arg0;
    ...
    $buffer = 'origin(';
        $arg0 = \Grafana\Foundation\Dashboardv2\ControlSourceRefConverter::convert($input->origin);
        $buffer .= $arg0;
