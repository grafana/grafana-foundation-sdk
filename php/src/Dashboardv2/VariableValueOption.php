...
class VariableValueOption implements \JsonSerializable
{
    ...
    /**
     * @var string|bool|float|\Grafana\Foundation\Dashboardv2\CustomVariableValue
     */
    public $value;
     ...
     * @param string|bool|float|\Grafana\Foundation\Dashboardv2\CustomVariableValue|null $value
    ...
    public static function fromArray(array $inputData): self
    {
        ...
        default:
            ...
            return \Grafana\Foundation\Dashboardv2\CustomVariableValue::fromArray($input);
    }
    })($data["value"]) : null,
