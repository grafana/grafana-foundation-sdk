 ...
 */
class VizConfigKindBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    public function spec(\Grafana\Foundation\Dashboardv2\VizConfigSpec $spec): static
    {
    ...
    public function fieldConfig(\Grafana\Foundation\Dashboardv2\FieldConfigSource $fieldConfig): static
    {
     ...
     */
    public function defaults(\Grafana\Foundation\Dashboardv2\FieldConfig $defaults): static
    {
