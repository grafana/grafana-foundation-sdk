...
class VizConfigKind implements \JsonSerializable
{
    ...
    public \Grafana\Foundation\Dashboardv2\VizConfigSpec $spec;

    /**
     * @param string|null $group
     * @param string|null $version
     * @param \Grafana\Foundation\Dashboardv2\VizConfigSpec|null $spec
     */
    public function __construct(?string $group = null, ?string $version = null, ?\Grafana\Foundation\Dashboardv2\VizConfigSpec $spec = null)
    {
        $this->kind = "VizConfig";
    
        $this->group = $group ?: "";
        $this->version = $version ?: "";
        $this->spec = $spec ?: new \Grafana\Foundation\Dashboardv2\VizConfigSpec();
    }
