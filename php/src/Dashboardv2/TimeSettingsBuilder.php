 ...
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\TimeSettingsSpec>
 */
class TimeSettingsBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\TimeSettingsSpec $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\TimeSettingsSpec();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\TimeSettingsSpec
     */
     ...
     * @param array<\Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\TimeRangeOption>> $quickRanges
     */
     ...
     */
    public function weekStart(\Grafana\Foundation\Dashboardv2\TimeSettingsSpecWeekStart $weekStart): static
    {
