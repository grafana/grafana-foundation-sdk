...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\AnnotationEventFieldMapping $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\AnnotationEventFieldMappingBuilder())',
        ];
