...
/**
 * Query variable kind
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\QueryVariableKind>
 */
class QueryVariableBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\QueryVariableKind $internal;

    public function __construct(string $name)
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\QueryVariableKind();
    ...
    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\QueryVariableKind
     */
    ...
    public function current(\Grafana\Foundation\Dashboardv2\VariableOption $current): static
    {
    ...
    public function hide(\Grafana\Foundation\Dashboardv2\VariableHide $hide): static
    {
    ...
    public function refresh(\Grafana\Foundation\Dashboardv2\VariableRefresh $refresh): static
    {
    ...
    /**
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\DataQueryKind> $query
     */
    ...
    public function regexApplyTo(\Grafana\Foundation\Dashboardv2\VariableRegexApplyTo $regexApplyTo): static
    {
    ...
    public function sort(\Grafana\Foundation\Dashboardv2\VariableSort $sort): static
    {
    ...
    /**
     * @param array<\Grafana\Foundation\Dashboardv2\VariableOption> $staticOptions
     */
    ...
    public function staticOptionsOrder(\Grafana\Foundation\Dashboardv2\QueryVariableSpecStaticOptionsOrder $staticOptionsOrder): static
    {
