...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\TabsLayoutTabKind $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\TabBuilder())',
        ];
    ...
    $buffer = 'repeat(';
        $arg0 = \Grafana\Foundation\Dashboardv2\TabRepeatOptionsConverter::convert($input->spec->repeat);
        $buffer .= $arg0;
