...
class DashboardLink implements \JsonSerializable
{
     ...
     */
    public \Grafana\Foundation\Dashboardv2\DashboardLinkType $type;
     ...
     * @param \Grafana\Foundation\Dashboardv2\DashboardLinkType|null $type
    ...
    public static function fromArray(array $inputData): self
    {
        ...
        return new self(
            ...
            type: isset($data["type"]) ? (function($input) { return \Grafana\Foundation\Dashboardv2\DashboardLinkType::fromValue($input); })($data["type"]) : null,
            icon: $data["icon"] ?? null,
