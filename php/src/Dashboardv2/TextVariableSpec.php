...
class TextVariableSpec implements \JsonSerializable
{
     ...
     */
    public function __construct(?string $name = null, ?\Grafana\Foundation\Dashboardv2\VariableOption $current = null, ?string $query = null, ?string $label = null, ?\Grafana\Foundation\Dashboardv2\VariableHide $hide = null, ?bool $skipUrlSync = null, ?string $description = null, ?\Grafana\Foundation\Dashboardv2\ControlSourceRef $origin = null)
    {
        $this->name = $name ?: "";
    ...
    {
        /** @var array{name?: string, current?: mixed, query?: string, label?: string, hide?: string, skipUrlSync?: bool, description?: string, origin?: mixed} $inputData */
        $data = $inputData;
        return new self(
            name: $data["name"] ?? null,
