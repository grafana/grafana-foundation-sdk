...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\PanelQueryKind>
 */
class TargetBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\PanelQueryKind $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\PanelQueryKind();
    $this->internal->kind = "PanelQuery";
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\PanelQueryKind
     */
