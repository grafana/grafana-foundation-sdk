...
class CustomVariableSpec implements \JsonSerializable
{
    ...
    public ?\Grafana\Foundation\Dashboardv2\CustomVariableSpecValuesFormat $valuesFormat;
     ...
     * @param \Grafana\Foundation\Dashboardv2\CustomVariableSpecValuesFormat|null $valuesFormat
     * @param \Grafana\Foundation\Dashboardv2\ControlSourceRef|null $origin
     */
    public function __construct(?string $name = null, ?string $query = null, ?\Grafana\Foundation\Dashboardv2\VariableOption $current = null, ?array $options = null, ?bool $multi = null, ?bool $includeAll = null, ?string $allValue = null, ?string $label = null, ?\Grafana\Foundation\Dashboardv2\VariableHide $hide = null, ?bool $skipUrlSync = null, ?string $description = null, ?bool $allowCustomValue = null, ?\Grafana\Foundation\Dashboardv2\CustomVariableSpecValuesFormat $valuesFormat = null, ?\Grafana\Foundation\Dashboardv2\ControlSourceRef $origin = null)
    {
        $this->name = $name ?: "";
        $this->query = $query ?: "";
        $this->current = $current ?: new \Grafana\Foundation\Dashboardv2\VariableOption();
    ...
    {
        /** @var array{name?: string, query?: string, current?: mixed, options?: array<mixed>, multi?: bool, includeAll?: bool, allValue?: string, label?: string, hide?: string, skipUrlSync?: bool, description?: string, allowCustomValue?: bool, valuesFormat?: string, origin?: mixed} $inputData */
        $data = $inputData;
        return new self(
            name: $data["name"] ?? null,
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\VariableOption::fromArray($val);
            ...
            valuesFormat: isset($data["valuesFormat"]) ? (function($input) { return \Grafana\Foundation\Dashboardv2\CustomVariableSpecValuesFormat::fromValue($input); })($data["valuesFormat"]) : null,
