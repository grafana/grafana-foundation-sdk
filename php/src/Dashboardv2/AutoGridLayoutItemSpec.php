...
{
    public \Grafana\Foundation\Dashboardv2\ElementReference $element;

    public ?\Grafana\Foundation\Dashboardv2\AutoGridRepeatOptions $repeat;

    public ?\Grafana\Foundation\Dashboardv2\ConditionalRenderingGroupKind $conditionalRendering;

    /**
     * @param \Grafana\Foundation\Dashboardv2\ElementReference|null $element
     * @param \Grafana\Foundation\Dashboardv2\AutoGridRepeatOptions|null $repeat
     * @param \Grafana\Foundation\Dashboardv2\ConditionalRenderingGroupKind|null $conditionalRendering
     */
    public function __construct(?\Grafana\Foundation\Dashboardv2\ElementReference $element = null, ?\Grafana\Foundation\Dashboardv2\AutoGridRepeatOptions $repeat = null, ?\Grafana\Foundation\Dashboardv2\ConditionalRenderingGroupKind $conditionalRendering = null)
    {
        $this->element = $element ?: new \Grafana\Foundation\Dashboardv2\ElementReference();
        $this->repeat = $repeat;
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\ElementReference::fromArray($val);
    })($data["element"]) : null,
            repeat: isset($data["repeat"]) ? (function($input) {
    	/** @var array{mode?: "variable", value?: string} */
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\AutoGridRepeatOptions::fromArray($val);
    })($data["repeat"]) : null,
