...
class DatasourceVariableKind implements \JsonSerializable
{
    ...
    public \Grafana\Foundation\Dashboardv2\DatasourceVariableSpec $spec;

    /**
     * @param \Grafana\Foundation\Dashboardv2\DatasourceVariableSpec|null $spec
     */
    public function __construct(?\Grafana\Foundation\Dashboardv2\DatasourceVariableSpec $spec = null)
    {
        $this->kind = "DatasourceVariable";
    
        $this->spec = $spec ?: new \Grafana\Foundation\Dashboardv2\DatasourceVariableSpec();
    }
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\DatasourceVariableSpec::fromArray($val);
    })($data["spec"]) : null,
        );
    }
