...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\PanelKind $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\PanelBuilder())',
        ];
    ...
    $buffer = 'links(';
        ...
        $tmplinksarg1 = \Grafana\Foundation\Dashboardv2\DataLinkConverter::convert($arg1);
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'data(';
        $arg0 = \Grafana\Foundation\Dashboardv2\QueryGroupConverter::convert($input->spec->data);
        $buffer .= $arg0;
