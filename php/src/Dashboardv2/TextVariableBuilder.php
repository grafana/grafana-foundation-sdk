...
/**
 * Text variable kind
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\TextVariableKind>
 */
class TextVariableBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\TextVariableKind $internal;

    public function __construct(string $name)
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\TextVariableKind();
    ...
    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\TextVariableKind
     */
