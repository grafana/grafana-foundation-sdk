 ...
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\AdHocFilterWithLabels>
 */
class AdHocFilterWithLabelsBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\AdHocFilterWithLabels $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\AdHocFilterWithLabels();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\AdHocFilterWithLabels
     */
