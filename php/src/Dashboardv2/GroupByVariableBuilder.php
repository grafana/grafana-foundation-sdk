...
/**
 * Group variable kind
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboardv2\GroupByVariableKind>
 */
class GroupByVariableBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboardv2\GroupByVariableKind $internal;

    public function __construct(string $name)
    {
    	$this->internal = new \Grafana\Foundation\Dashboardv2\GroupByVariableKind();
    ...
    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboardv2\GroupByVariableKind
     */
    ...
    public function defaultValue(\Grafana\Foundation\Dashboardv2\VariableOption $defaultValue): static
    {
