...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\InfinityOptions $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\InfinityOptionsBuilder())',
        ];
            
    
        {
    $buffer = 'method(';
        $arg0 ='\Grafana\Foundation\Dashboardv2\HttpRequestMethod::fromValue("'.$input->method.'")';
        $buffer .= $arg0;
