...
{
    public static function convert(\Grafana\Foundation\Dashboardv2\Dashboard $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Dashboardv2\DashboardBuilder('.\var_export($input->title, true).'))',
        ];
    ...
    $buffer = 'annotations(';
        ...
        $tmpannotationsarg1 = \Grafana\Foundation\Dashboardv2\AnnotationQueryConverter::convert($arg1);
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'cursorSync(';
        $arg0 ='\Grafana\Foundation\Dashboardv2\DashboardCursorSync::fromValue("'.$input->cursorSync.'")';
        $buffer .= $arg0;
    ...
    $buffer = 'elements(';
        ...
        foreach ($input->elements as $key => $arg1) {
            switch (true) {
            case $arg1 instanceof \Grafana\Foundation\Dashboardv2\PanelKind:
                $disjunctionarg1 = \Grafana\Foundation\Dashboardv2\PanelConverter::convert($arg1);
                $tmpelementsarg1 = $disjunctionarg1;
                break;
            case $arg1 instanceof \Grafana\Foundation\Dashboardv2\LibraryPanelKind:
                $disjunctionarg1 = \Grafana\Foundation\Dashboardv2\LibraryPanelConverter::convert($arg1);
                $tmpelementsarg1 = $disjunctionarg1;
                break;
            default:
    ...
    $buffer = 'element(';
        ...
        $buffer .= ', ';
        switch (true) {
            case $value instanceof \Grafana\Foundation\Dashboardv2\PanelKind:
                $disjunctionvalue = \Grafana\Foundation\Dashboardv2\PanelConverter::convert($value);
                $arg1 = $disjunctionvalue;
                break;
            case $value instanceof \Grafana\Foundation\Dashboardv2\LibraryPanelKind:
                $disjunctionvalue = \Grafana\Foundation\Dashboardv2\LibraryPanelConverter::convert($value);
                $arg1 = $disjunctionvalue;
                break;
            default:
                throw new \ValueError('disjunction branch not handled');
    ...
    $buffer = 'layout(';
        switch (true) {
            case $input->layout instanceof \Grafana\Foundation\Dashboardv2\GridLayoutKind:
                ...
                break;
            case $input->layout instanceof \Grafana\Foundation\Dashboardv2\RowsLayoutKind:
                $disjunctionlayout = \Grafana\Foundation\Dashboardv2\RowsConverter::convert($input->layout);
                $arg0 = $disjunctionlayout;
                break;
            case $input->layout instanceof \Grafana\Foundation\Dashboardv2\AutoGridLayoutKind:
                ...
                $arg0 = $disjunctionlayout;
                break;
            case $input->layout instanceof \Grafana\Foundation\Dashboardv2\TabsLayoutKind:
                $disjunctionlayout = \Grafana\Foundation\Dashboardv2\TabsConverter::convert($input->layout);
                $arg0 = $disjunctionlayout;
                break;
            default:
                throw new \ValueError('disjunction branch not handled');
    ...
    $buffer = 'links(';
        ...
        $tmplinksarg1 = \Grafana\Foundation\Dashboardv2\DashboardLinkConverter::convert($arg1);
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'timeSettings(';
        $arg0 = \Grafana\Foundation\Dashboardv2\TimeSettingsConverter::convert($input->timeSettings);
        $buffer .= $arg0;
    ...
    $buffer = 'preferences(';
        $arg0 = \Grafana\Foundation\Dashboardv2\PreferencesConverter::convert($input->preferences);
        $buffer .= $arg0;
