...
class FieldConfigSource implements \JsonSerializable
{
     ...
     */
    public \Grafana\Foundation\Dashboardv2\FieldConfig $defaults;

    /**
     * Overrides are the options applied to specific fields overriding the defaults.
     * @var array<\Grafana\Foundation\Dashboardv2\Dashboardv2FieldConfigSourceOverrides>
     */
    public array $overrides;

    /**
     * @param \Grafana\Foundation\Dashboardv2\FieldConfig|null $defaults
     * @param array<\Grafana\Foundation\Dashboardv2\Dashboardv2FieldConfigSourceOverrides>|null $overrides
     */
    public function __construct(?\Grafana\Foundation\Dashboardv2\FieldConfig $defaults = null, ?array $overrides = null)
    {
        $this->defaults = $defaults ?: new \Grafana\Foundation\Dashboardv2\FieldConfig();
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\FieldConfig::fromArray($val);
    })($data["defaults"]) : null,
            overrides: array_filter(array_map((function($input) {
    	/** @var array{__systemRef?: string, matcher?: mixed, properties?: array<mixed>} */
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\Dashboardv2FieldConfigSourceOverrides::fromArray($val);
    }), $data["overrides"] ?? [])),
        );
    }
