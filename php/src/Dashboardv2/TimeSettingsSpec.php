...
class TimeSettingsSpec implements \JsonSerializable
{
     ...
     * @var array<\Grafana\Foundation\Dashboardv2\TimeRangeOption>|null
     */
     ...
     */
    public ?\Grafana\Foundation\Dashboardv2\TimeSettingsSpecWeekStart $weekStart;
     ...
     * @param array<\Grafana\Foundation\Dashboardv2\TimeRangeOption>|null $quickRanges
     * @param bool|null $hideTimepicker
     * @param \Grafana\Foundation\Dashboardv2\TimeSettingsSpecWeekStart|null $weekStart
     * @param int|null $fiscalYearStartMonth
     * @param string|null $nowDelay
     */
    public function __construct(?string $timezone = null, ?string $from = null, ?string $to = null, ?string $autoRefresh = null, ?array $autoRefreshIntervals = null, ?array $quickRanges = null, ?bool $hideTimepicker = null, ?\Grafana\Foundation\Dashboardv2\TimeSettingsSpecWeekStart $weekStart = null, ?int $fiscalYearStartMonth = null, ?string $nowDelay = null)
    {
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\TimeRangeOption::fromArray($val);
    }), $data["quickRanges"] ?? [])),
            hideTimepicker: $data["hideTimepicker"] ?? null,
            weekStart: isset($data["weekStart"]) ? (function($input) { return \Grafana\Foundation\Dashboardv2\TimeSettingsSpecWeekStart::fromValue($input); })($data["weekStart"]) : null,
