...
class FieldConfig implements \JsonSerializable
{
     ...
     * @var array<\Grafana\Foundation\Dashboardv2\ValueMap|\Grafana\Foundation\Dashboardv2\RangeMap|\Grafana\Foundation\Dashboardv2\RegexMap|\Grafana\Foundation\Dashboardv2\SpecialValueMap>|null
     */
     ...
     */
    public ?\Grafana\Foundation\Dashboardv2\ThresholdsConfig $thresholds;

    /**
     * Panel color configuration
     */
    public ?\Grafana\Foundation\Dashboardv2\FieldColor $color;
     ...
     * @var array<\Grafana\Foundation\Dashboardv2\Action>|null
     */
     ...
     */
    public ?\Grafana\Foundation\Dashboardv2\NullValueMode $nullValueMode;
     ...
     * @param array<\Grafana\Foundation\Dashboardv2\ValueMap|\Grafana\Foundation\Dashboardv2\RangeMap|\Grafana\Foundation\Dashboardv2\RegexMap|\Grafana\Foundation\Dashboardv2\SpecialValueMap>|null $mappings
     * @param \Grafana\Foundation\Dashboardv2\ThresholdsConfig|null $thresholds
     * @param \Grafana\Foundation\Dashboardv2\FieldColor|null $color
     * @param array<mixed>|null $links
     * @param array<\Grafana\Foundation\Dashboardv2\Action>|null $actions
     * @param string|null $noValue
     * @param mixed|null $custom
     * @param bool|null $fieldMinMax
     * @param \Grafana\Foundation\Dashboardv2\NullValueMode|null $nullValueMode
     */
    public function __construct(?string $displayName = null, ?string $displayNameFromDS = null, ?string $description = null, ?string $path = null, ?bool $writeable = null, ?bool $filterable = null, ?string $unit = null, ?float $decimals = null, ?float $min = null, ?float $max = null, ?array $mappings = null, ?\Grafana\Foundation\Dashboardv2\ThresholdsConfig $thresholds = null, ?\Grafana\Foundation\Dashboardv2\FieldColor $color = null, ?array $links = null, ?array $actions = null, ?string $noValue = null,  $custom = null, ?bool $fieldMinMax = null, ?\Grafana\Foundation\Dashboardv2\NullValueMode $nullValueMode = null)
    {
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\ThresholdsConfig::fromArray($val);
    })($data["thresholds"]) : null,
            color: isset($data["color"]) ? (function($input) {
    	/** @var array{mode?: string, fixedColor?: string, seriesBy?: string} */
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\FieldColor::fromArray($val);
    })($data["color"]) : null,
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboardv2\Action::fromArray($val);
    }), $data["actions"] ?? [])),
            noValue: $data["noValue"] ?? null,
            custom: $data["custom"] ?? null,
            fieldMinMax: $data["fieldMinMax"] ?? null,
            nullValueMode: isset($data["nullValueMode"]) ? (function($input) { return \Grafana\Foundation\Dashboardv2\NullValueMode::fromValue($input); })($data["nullValueMode"]) : null,
        );
    }
