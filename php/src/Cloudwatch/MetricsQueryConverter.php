...
final class MetricsQueryConverter
{
    public static function convert(\Grafana\Foundation\Cloudwatch\MetricsQuery $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Cloudwatch\MetricsQueryBuilder())',
        ];
            
    
        {
    $buffer = 'queryMode(';
        $arg0 ='\Grafana\Foundation\Cloudwatch\QueryMode::fromValue("'.$input->queryMode.'")';
        $buffer .= $arg0;
