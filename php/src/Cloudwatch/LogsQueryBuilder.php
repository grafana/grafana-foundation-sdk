 ...
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Cloudwatch\LogsQuery>
 */
class LogsQueryBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Cloudwatch\LogsQuery $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Cloudwatch\LogsQuery();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Cloudwatch\LogsQuery
     */
