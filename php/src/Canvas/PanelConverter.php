...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Canvas\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Canvas\Options && $input->options->inlineEditing !== true) {
    
        
    $buffer = 'inlineEditing(';
        $arg0 =\var_export($input->options->inlineEditing, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Canvas\Options && $input->options->showAdvancedTypes !== true) {
    
        
    $buffer = 'showAdvancedTypes(';
        $arg0 =\var_export($input->options->showAdvancedTypes, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Canvas\Options && $input->options->panZoom !== true) {
    
        
    $buffer = 'panZoom(';
        $arg0 =\var_export($input->options->panZoom, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Canvas\Options && $input->options->infinitePan !== true) {
    
        
    $buffer = 'infinitePan(';
        $arg0 =\var_export($input->options->infinitePan, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Canvas\Options) {
