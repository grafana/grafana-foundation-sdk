...
class Placement implements \JsonSerializable
{
     ...
     */
    public function __construct(?float $top = null, ?float $left = null, ?float $right = null, ?float $bottom = null, ?float $width = null, ?float $height = null)
    {
        $this->top = $top;
        $this->left = $left;
        $this->right = $right;
    ...
    {
        /** @var array{top?: float, left?: float, right?: float, bottom?: float, width?: float, height?: float} $inputData */
        $data = $inputData;
        return new self(
            top: $data["top"] ?? null,
            left: $data["left"] ?? null,
