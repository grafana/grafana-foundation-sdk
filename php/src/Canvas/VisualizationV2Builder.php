...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Canvas\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Canvas\Options);
    ...
    {    
        ...
        $this->internal->spec->options->root = $rootResource;
