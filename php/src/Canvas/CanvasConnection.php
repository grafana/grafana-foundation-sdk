...
class CanvasConnection implements \JsonSerializable
{
    ...
    {
        /** @var array{source?: mixed, target?: mixed, targetName?: string, path?: "straight", color?: mixed, size?: mixed, vertices?: array<mixed>, sourceOriginal?: mixed, targetOriginal?: mixed} $inputData */
        $data = $inputData;
        return new self(
