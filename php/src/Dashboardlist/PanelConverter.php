...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Dashboardlist\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->keepTime !== false) {
    
        
    $buffer = 'keepTime(';
        $arg0 =\var_export($input->options->keepTime, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->includeVars !== false) {
    
        
    $buffer = 'includeVars(';
        $arg0 =\var_export($input->options->includeVars, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->showStarred !== true) {
    
        
    $buffer = 'showStarred(';
        $arg0 =\var_export($input->options->showStarred, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->showRecentlyViewed !== false) {
    
        
    $buffer = 'showRecentlyViewed(';
        $arg0 =\var_export($input->options->showRecentlyViewed, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->showSearch !== false) {
    
        
    $buffer = 'showSearch(';
        $arg0 =\var_export($input->options->showSearch, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->showHeadings !== true) {
    
        
    $buffer = 'showHeadings(';
        $arg0 =\var_export($input->options->showHeadings, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->showFolderNames !== true) {
    
        
    $buffer = 'showFolderNames(';
        $arg0 =\var_export($input->options->showFolderNames, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->maxItems !== 10) {
    
        
    $buffer = 'maxItems(';
        $arg0 =\var_export($input->options->maxItems, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->query !== "") {
    
        
    $buffer = 'query(';
        $arg0 =\var_export($input->options->query, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && count($input->options->tags) >= 1) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->folderId !== null) {
    
        
    $buffer = 'folderId(';
        $arg0 =\var_export($input->options->folderId, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Dashboardlist\Options && $input->options->folderUID !== null && $input->options->folderUID !== "") {
    
        
    $buffer = 'folderUID(';
        $arg0 =\var_export($input->options->folderUID, true);
        $buffer .= $arg0;
