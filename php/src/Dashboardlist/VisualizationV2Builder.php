...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Dashboardlist\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Dashboardlist\Options);
