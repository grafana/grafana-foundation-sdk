...
final class DateHistogramSettingsConverter
{
    public static function convert(\Grafana\Foundation\Elasticsearch\DateHistogramSettings $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Elasticsearch\DateHistogramSettingsBuilder())',
        ];
