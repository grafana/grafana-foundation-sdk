...
final class TermsSettingsConverter
{
    public static function convert(\Grafana\Foundation\Elasticsearch\TermsSettings $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Elasticsearch\TermsSettingsBuilder())',
        ];
            if ($input->order !== null) {
