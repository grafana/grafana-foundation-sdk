...
class SerialDiff implements \JsonSerializable
{
     ...
     * @param \Grafana\Foundation\Elasticsearch\ElasticsearchSerialDiffSettings|null $settings
     * @param bool|null $hide
     */
    public function __construct(?string $pipelineAgg = null, ?string $field = null, ?string $id = null, ?\Grafana\Foundation\Elasticsearch\ElasticsearchSerialDiffSettings $settings = null, ?bool $hide = null)
    {
    ...
    {
        /** @var array{pipelineAgg?: string, field?: string, type?: "serial_diff", id?: string, settings?: mixed, hide?: bool} $inputData */
        $data = $inputData;
        return new self(
    	...
    	/** @var array{lag?: string} */
    $val = $input;
    	return \Grafana\Foundation\Elasticsearch\ElasticsearchSerialDiffSettings::fromArray($val);
    })($data["settings"]) : null,
            hide: $data["hide"] ?? null,
        );
    }
