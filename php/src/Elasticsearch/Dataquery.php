...
class Dataquery implements \JsonSerializable, \Grafana\Foundation\Cog\Dataquery
{
     ...
     */
    public function __construct(?string $alias = null, ?string $query = null, ?string $timeField = null, ?array $bucketAggs = null, ?array $metrics = null, ?string $refId = null, ?bool $hide = null, ?string $queryType = null,  $datasource = null)
    {
        $this->alias = $alias;
        $this->query = $query;
