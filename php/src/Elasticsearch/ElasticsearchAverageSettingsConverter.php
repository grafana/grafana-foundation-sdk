...
final class ElasticsearchAverageSettingsConverter
{
    public static function convert(\Grafana\Foundation\Elasticsearch\ElasticsearchAverageSettings $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Elasticsearch\ElasticsearchAverageSettingsBuilder())',
        ];
