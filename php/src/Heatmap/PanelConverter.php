...
final class PanelConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Heatmap\Options && $input->options->selectionMode !== null) {
    
        
    $buffer = 'selectionMode(';
        $arg0 ='\Grafana\Foundation\Heatmap\HeatmapSelectionMode::fromValue("'.$input->options->selectionMode.'")';
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Heatmap\FieldConfig && $input->fieldConfig->defaults->custom->scaleDistribution !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Heatmap\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
