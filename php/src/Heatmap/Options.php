...
class Options implements \JsonSerializable
{
    ...
    {
        /** @var array{calculate?: bool, calculation?: mixed, color?: mixed, filterValues?: mixed, rowsFrame?: mixed, showValue?: string, cellGap?: int, cellRadius?: float, cellValues?: mixed, yAxis?: mixed, legend?: mixed, tooltip?: mixed, exemplars?: mixed, selectionMode?: string} $inputData */
        $data = $inputData;
        return new self(
    ...
    $val = $input;
    	...
    	/** @var array{mode?: string, maxHeight?: float, maxWidth?: float, yHistogram?: bool, showColorScale?: bool} */
    $val = $input;
    ...
    $val = $input;
    	return \Grafana\Foundation\Heatmap\ExemplarConfig::fromArray($val);
            ...
            selectionMode: isset($data["selectionMode"]) ? (function($input) { return \Grafana\Foundation\Heatmap\HeatmapSelectionMode::fromValue($input); })($data["selectionMode"]) : null,
        );
    }
