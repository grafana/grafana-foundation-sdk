...
class YAxisConfig implements \JsonSerializable
{
     ...
     */
    public function __construct(?string $unit = null, ?bool $reverse = null, ?float $decimals = null, ?float $min = null, ?\Grafana\Foundation\Common\AxisPlacement $axisPlacement = null, ?\Grafana\Foundation\Common\AxisColorMode $axisColorMode = null, ?string $axisLabel = null, ?float $axisWidth = null, ?float $axisSoftMin = null, ?float $axisSoftMax = null, ?bool $axisGridShow = null, ?\Grafana\Foundation\Common\ScaleDistributionConfig $scaleDistribution = null, ?bool $axisCenteredZero = null, ?float $max = null, ?bool $axisBorderShow = null)
    {
        $this->unit = $unit;
    ...
    {
        /** @var array{unit?: string, reverse?: bool, decimals?: float, min?: float, axisPlacement?: string, axisColorMode?: string, axisLabel?: string, axisWidth?: float, axisSoftMin?: float, axisSoftMax?: float, axisGridShow?: bool, scaleDistribution?: mixed, axisCenteredZero?: bool, max?: float, axisBorderShow?: bool} $inputData */
        $data = $inputData;
        return new self(
            unit: $data["unit"] ?? null,
