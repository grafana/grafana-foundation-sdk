...
final class PanelConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Statushistory\FieldConfig && $input->fieldConfig->defaults->custom->lineWidth !== null && $input->fieldConfig->defaults->custom->lineWidth !== 1) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Statushistory\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Statushistory\FieldConfig && $input->fieldConfig->defaults->custom->fillOpacity !== null && $input->fieldConfig->defaults->custom->fillOpacity !== 70) {
