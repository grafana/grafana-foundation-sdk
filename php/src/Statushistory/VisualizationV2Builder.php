...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    public function rowHeight(float $rowHeight): static
    {
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Statushistory\Options);
    ...
    public function colWidth(float $colWidth): static
    {
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Statushistory\Options);
        $this->internal->spec->options->colWidth = $colWidth;
    ...
    public function lineWidth(int $lineWidth): static
    {
        ...
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Statushistory\FieldConfig);
