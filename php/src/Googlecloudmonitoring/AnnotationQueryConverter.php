...
{
    public static function convert(\Grafana\Foundation\Googlecloudmonitoring\AnnotationQuery $input): string
    {
        
        $calls = [
            '(new \Grafana\Foundation\Googlecloudmonitoring\AnnotationQueryBuilder())',
        ];
