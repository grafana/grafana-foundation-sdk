...
class TimeSeriesList implements \JsonSerializable
{
     ...
     */
    public function __construct(?string $projectName = null, ?string $crossSeriesReducer = null, ?string $alignmentPeriod = null, ?string $perSeriesAligner = null, ?array $groupBys = null, ?array $filters = null, ?string $view = null, ?string $title = null, ?string $text = null, ?string $secondaryCrossSeriesReducer = null, ?string $secondaryAlignmentPeriod = null, ?string $secondaryPerSeriesAligner = null, ?array $secondaryGroupBys = null, ?\Grafana\Foundation\Googlecloudmonitoring\PreprocessorType $preprocessor = null)
    {
