...
class CloudMonitoringQuery implements \JsonSerializable, \Grafana\Foundation\Cog\Dataquery
{
    ...
    {
        /** @var array{refId?: string, hide?: bool, queryType?: string, aliasBy?: string, timeSeriesList?: mixed, timeSeriesQuery?: mixed, sloQuery?: mixed, datasource?: mixed, intervalMs?: float} $inputData */
        $data = $inputData;
        return new self(
