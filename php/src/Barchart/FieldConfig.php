...
class FieldConfig implements \JsonSerializable
{
     ...
     */
    public function __construct(?int $lineWidth = null, ?int $fillOpacity = null, ?\Grafana\Foundation\Common\GraphGradientMode $gradientMode = null, ?\Grafana\Foundation\Common\AxisPlacement $axisPlacement = null, ?\Grafana\Foundation\Common\AxisColorMode $axisColorMode = null, ?string $axisLabel = null, ?float $axisWidth = null, ?float $axisSoftMin = null, ?float $axisSoftMax = null, ?bool $axisGridShow = null, ?\Grafana\Foundation\Common\ScaleDistributionConfig $scaleDistribution = null, ?bool $axisCenteredZero = null, ?\Grafana\Foundation\Common\HideSeriesConfig $hideFrom = null, ?\Grafana\Foundation\Common\GraphThresholdsStyleConfig $thresholdsStyle = null, ?bool $axisBorderShow = null)
    {
    ...
    {
        /** @var array{lineWidth?: int, fillOpacity?: int, gradientMode?: string, axisPlacement?: string, axisColorMode?: string, axisLabel?: string, axisWidth?: float, axisSoftMin?: float, axisSoftMax?: float, axisGridShow?: bool, scaleDistribution?: mixed, axisCenteredZero?: bool, hideFrom?: mixed, thresholdsStyle?: mixed, axisBorderShow?: bool} $inputData */
        $data = $inputData;
        return new self(
