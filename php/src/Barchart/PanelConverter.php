...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Barchart\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Barchart\Options && $input->options->xField !== null && $input->options->xField !== "") {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Barchart\Options && $input->options->colorByField !== null && $input->options->colorByField !== "") {
    
        
    $buffer = 'colorByField(';
        $arg0 =\var_export($input->options->colorByField, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Barchart\Options) {
    ...
    $buffer = 'barRadius(';
        $arg0 =\var_export($input->options->barRadius, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Barchart\Options && $input->options->xTickLabelRotation !== 0) {
    
        
    $buffer = 'xTickLabelRotation(';
        $arg0 =\var_export($input->options->xTickLabelRotation, true);
        $buffer .= $arg0;
    ...
    $buffer = 'xTickLabelMaxLength(';
        $arg0 =\var_export($input->options->xTickLabelMaxLength, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Barchart\Options && $input->options->xTickLabelSpacing !== null && $input->options->xTickLabelSpacing !== 0) {
    
        
    $buffer = 'xTickLabelSpacing(';
        $arg0 =\var_export($input->options->xTickLabelSpacing, true);
        $buffer .= $arg0;
    ...
    $buffer = 'stacking(';
        $arg0 ='\Grafana\Foundation\Common\StackingMode::fromValue("'.$input->options->stacking.'")';
        $buffer .= $arg0;
    ...
    $buffer = 'barWidth(';
        $arg0 =\var_export($input->options->barWidth, true);
        $buffer .= $arg0;
    ...
    $buffer = 'groupWidth(';
        $arg0 =\var_export($input->options->groupWidth, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Barchart\Options && $input->options->text !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Barchart\Options && $input->options->fullHighlight !== false) {
    
        
    $buffer = 'fullHighlight(';
        $arg0 =\var_export($input->options->fullHighlight, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->lineWidth !== null && $input->fieldConfig->defaults->custom->lineWidth !== 1) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->fillOpacity !== null && $input->fieldConfig->defaults->custom->fillOpacity !== 80) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->gradientMode !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisPlacement !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisColorMode !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisLabel !== null && $input->fieldConfig->defaults->custom->axisLabel !== "") {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisWidth !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisSoftMin !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisSoftMax !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisGridShow !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->scaleDistribution !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisCenteredZero !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->hideFrom !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->thresholdsStyle !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->fieldConfig !== null && $input->fieldConfig->defaults->custom !== null && $input->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig && $input->fieldConfig->defaults->custom->axisBorderShow !== null) {
