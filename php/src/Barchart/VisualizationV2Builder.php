...
class VisualizationV2Builder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Barchart\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->xField = $xField;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->colorByField = $colorByField;
    ...
    public function barRadius(float $barRadius): static
    {
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->barRadius = $barRadius;
    ...
    public function xTickLabelRotation(int $xTickLabelRotation): static
    {
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->xTickLabelRotation = $xTickLabelRotation;
    ...
    public function xTickLabelMaxLength(int $xTickLabelMaxLength): static
    {
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->xTickLabelMaxLength = $xTickLabelMaxLength;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->xTickLabelSpacing = $xTickLabelSpacing;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->stacking = $stacking;
    ...
    public function barWidth(float $barWidth): static
    {
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->barWidth = $barWidth;
    ...
    public function groupWidth(float $groupWidth): static
    {
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->groupWidth = $groupWidth;
    ...
    {    
        ...
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Barchart\Options);
        $this->internal->spec->options->fullHighlight = $fullHighlight;
    ...
    public function lineWidth(int $lineWidth): static
    {
        ...
        if ($this->internal->spec->fieldConfig->defaults->custom === null) {
            $this->internal->spec->fieldConfig->defaults->custom = new \Grafana\Foundation\Barchart\FieldConfig();
        }
        assert($this->internal->spec->fieldConfig->defaults->custom instanceof \Grafana\Foundation\Barchart\FieldConfig);
