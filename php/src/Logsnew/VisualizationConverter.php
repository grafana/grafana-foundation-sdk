...
final class VisualizationConverter
{
    public static function convert(\Grafana\Foundation\Dashboardv2beta1\VizConfigKind $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Logsnew\VisualizationBuilder())',
        ];
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Logsnew\Options) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Logsnew\Options && $input->spec->options->grammar !== null) {
    
        
    $buffer = 'grammar(';
        $arg0 =\var_export($input->spec->options->grammar, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Logsnew\Options && $input->spec->options->enableInfiniteScrolling !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Logsnew\Options && $input->spec->options->onLogOptionsChange !== null) {
    
        
    $buffer = 'onLogOptionsChange(';
        $arg0 =\var_export($input->spec->options->onLogOptionsChange, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->spec->options !== null && $input->spec->options instanceof \Grafana\Foundation\Logsnew\Options && $input->spec->options->onNewLogsReceived !== null) {
