...
class VisualizationBuilder implements \Grafana\Foundation\Cog\Builder
{
    ...
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Logsnew\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Logsnew\Options);
     ...
     * @param mixed $grammar
     */
    public function grammar( $grammar): static
    {    
        if ($this->internal->spec->options === null) {
            $this->internal->spec->options = new \Grafana\Foundation\Logsnew\Options();
        }
        assert($this->internal->spec->options instanceof \Grafana\Foundation\Logsnew\Options);
        $this->internal->spec->options->grammar = $grammar;
