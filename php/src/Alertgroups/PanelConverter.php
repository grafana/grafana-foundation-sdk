...
final class PanelConverter
{
    public static function convert(\Grafana\Foundation\Dashboard\Panel $input): string
    {
        ...
        $calls = [
            '(new \Grafana\Foundation\Alertgroups\PanelBuilder())',
        ];
            if ($input->id !== null) {
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Alertgroups\Options && $input->options->labels !== "") {
    
        
    $buffer = 'labels(';
        $arg0 =\var_export($input->options->labels, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Alertgroups\Options && $input->options->alertmanager !== "") {
    
        
    $buffer = 'alertmanager(';
        $arg0 =\var_export($input->options->alertmanager, true);
        $buffer .= $arg0;
    ...
    $calls[] = $buffer;
            ...
            if ($input->options !== null && $input->options instanceof \Grafana\Foundation\Alertgroups\Options) {
    
        
    $buffer = 'expandAll(';
        $arg0 =\var_export($input->options->expandAll, true);
        $buffer .= $arg0;
