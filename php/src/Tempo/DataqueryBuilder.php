...
/**
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Tempo\Dataquery>
 */
class DataqueryBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Tempo\Dataquery $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Tempo\Dataquery();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Tempo\Dataquery
     */
