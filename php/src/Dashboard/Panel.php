...
class Panel implements \JsonSerializable
{
     ...
     */
    public function __construct(?string $type = null, ?int $id = null, ?string $pluginVersion = null, ?array $tags = null, ?array $targets = null, ?string $title = null, ?string $description = null, ?bool $transparent = null, ?\Grafana\Foundation\Common\DataSourceRef $datasource = null, ?\Grafana\Foundation\Dashboard\GridPos $gridPos = null, ?array $links = null, ?string $repeat = null, ?\Grafana\Foundation\Dashboard\PanelRepeatDirection $repeatDirection = null, ?float $maxPerRow = null, ?float $maxDataPoints = null, ?array $transformations = null, ?string $interval = null, ?string $timeFrom = null, ?string $timeShift = null, ?bool $hideTimeOverride = null, ?\Grafana\Foundation\Dashboard\LibraryPanelRef $libraryPanel = null,  $options = null, ?\Grafana\Foundation\Dashboard\FieldConfigSource $fieldConfig = null)
    {
        $this->type = $type ?: "";
        $this->id = $id;
