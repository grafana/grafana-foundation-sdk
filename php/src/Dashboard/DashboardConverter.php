...
final class DashboardConverter
{
    ...
    $calls[] = $buffer;
            ...
            if ($input->refresh !== null && $input->refresh !== "") {
    
        
    $buffer = 'refresh(';
        $arg0 =\var_export($input->refresh, true);
        $buffer .= $arg0;
    ...
    $buffer = 'variables(';
        ...
        if ($arg1->type === \Grafana\Foundation\Dashboard\VariableType::fromValue("constant") && $arg1->hide !== null && $arg1->hide === \Grafana\Foundation\Dashboard\VariableHide::fromValue(0x2)) {
