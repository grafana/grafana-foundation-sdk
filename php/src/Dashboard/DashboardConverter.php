...
final class DashboardConverter
{
    ...
    $calls[] = $buffer;
        ...
        {
    $buffer = 'style(';
        $arg0 ='\Grafana\Foundation\Dashboard\DashboardStyle::fromValue("'.$input->style.'")';
        $buffer .= $arg0;
    ...
    $buffer = 'variables(';
        ...
        if ($arg1->type === \Grafana\Foundation\Dashboard\VariableType::fromValue("constant") && $arg1->hide === \Grafana\Foundation\Dashboard\VariableHide::fromValue(2)) {
