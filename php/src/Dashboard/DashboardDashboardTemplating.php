...
class DashboardDashboardTemplating implements \JsonSerializable
{
    ...
    public static function fromArray(array $inputData): self
    {
    	...
    	/** @var array{type?: string, name?: string, label?: string, hide?: int, skipUrlSync?: bool, description?: string, query?: string|array<string, mixed>, datasource?: mixed, current?: mixed, multi?: bool, allowCustomValue?: bool, options?: array<mixed>, refresh?: int, sort?: int, includeAll?: bool, allValue?: string, regex?: string, auto?: bool, auto_min?: string, auto_count?: int} */
    $val = $input;
