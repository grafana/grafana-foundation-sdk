...
class DashboardMeta implements \JsonSerializable
{
     ...
     * @param string|null $publicDashboardAccessToken
     * @param bool|null $publicDashboardEnabled
     * @param string|null $publicDashboardUid
     ...
     */
    public function __construct(?\Grafana\Foundation\Dashboard\AnnotationPermission $annotationsPermissions = null, ?bool $canAdmin = null, ?bool $canDelete = null, ?bool $canEdit = null, ?bool $canSave = null, ?bool $canStar = null, ?string $created = null, ?string $createdBy = null, ?string $expires = null, ?int $folderId = null, ?string $folderTitle = null, ?string $folderUid = null, ?string $folderUrl = null, ?bool $hasAcl = null, ?bool $isFolder = null, ?bool $isSnapshot = null, ?bool $isStarred = null, ?bool $provisioned = null, ?string $provisionedExternalId = null, ?string $publicDashboardAccessToken = null, ?bool $publicDashboardEnabled = null, ?string $publicDashboardUid = null, ?string $slug = null, ?string $type = null, ?string $updated = null, ?string $updatedBy = null, ?string $url = null, ?int $version = null)
    {
    ...
    $val = $input;
    	return \Grafana\Foundation\Dashboard\AnnotationPermission::fromArray($val);
            ...
            publicDashboardAccessToken: $data["publicDashboardAccessToken"] ?? null,
            publicDashboardEnabled: $data["publicDashboardEnabled"] ?? null,
            publicDashboardUid: $data["publicDashboardUid"] ?? null,
            slug: $data["slug"] ?? null,
            type: $data["type"] ?? null,
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->publicDashboardAccessToken)) {
            $data->publicDashboardAccessToken = $this->publicDashboardAccessToken;
        }
        if (isset($this->publicDashboardEnabled)) {
            $data->publicDashboardEnabled = $this->publicDashboardEnabled;
        }
        if (isset($this->publicDashboardUid)) {
            $data->publicDashboardUid = $this->publicDashboardUid;
        }
        if (isset($this->slug)) {
            $data->slug = $this->slug;
        }
