...
class FetchOptions implements \JsonSerializable
{
     ...
     */
    public function __construct(?\Grafana\Foundation\Dashboard\HttpRequestMethod $method = null, ?string $url = null, ?string $body = null, ?array $queryParams = null, ?array $headers = null)
    {
