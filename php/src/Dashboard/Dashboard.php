...
class Dashboard implements \JsonSerializable
{
    ...
    $val = $input;
    	...
    	/** @var array{hidden?: bool, refresh_intervals?: array<string>, time_options?: array<string>} */
    $val = $input;
