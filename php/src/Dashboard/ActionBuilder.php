...
/**
 * Dashboard action
 * @implements \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboard\Action>
 */
class ActionBuilder implements \Grafana\Foundation\Cog\Builder
{
    protected \Grafana\Foundation\Dashboard\Action $internal;

    public function __construct()
    {
    	$this->internal = new \Grafana\Foundation\Dashboard\Action();
    }

    /**
     * Builds the object.
     * @return \Grafana\Foundation\Dashboard\Action
     */
    ...
    public function type(\Grafana\Foundation\Dashboard\ActionType $type): static
    {
    ...
    /**
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboard\FetchOptions> $fetch
     */
    ...
    /**
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboard\InfinityOptions> $infinity
     */
    ...
    /**
     * @param array<\Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboard\ActionVariable>> $variables
     */
    ...
    /**
     * @param \Grafana\Foundation\Cog\Builder<\Grafana\Foundation\Dashboard\DashboardActionStyle> $style
     */
