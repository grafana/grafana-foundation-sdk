...
class AnnotationContainer implements \JsonSerializable
{
    ...
    public static function fromArray(array $inputData): self
    {
    	...
    	/** @var array{name?: string, datasource?: mixed, enable?: bool, hide?: bool, iconColor?: string, filter?: mixed, target?: mixed, type?: string, builtIn?: float, placement?: "inControlsMenu", expr?: string, textFormat?: string, titleFormat?: string, tagKeys?: string, step?: string, useValueForTime?: bool, mappings?: array<string, mixed>} */
    $val = $input;
