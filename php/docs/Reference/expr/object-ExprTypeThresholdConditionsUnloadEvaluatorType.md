...
```php
final class ExprTypeThresholdConditionsUnloadEvaluatorType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    /**
     * @var array<string, ExprTypeThresholdConditionsUnloadEvaluatorType>
     */
