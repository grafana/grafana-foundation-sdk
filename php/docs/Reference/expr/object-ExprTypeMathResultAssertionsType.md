---
title: <span class="badge object-type-enum"></span> ExprTypeMathResultAssertionsType
---
# <span class="badge object-type-enum"></span> ExprTypeMathResultAssertionsType

## Definition

```php
final class ExprTypeMathResultAssertionsType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    /**
     * @var array<string, ExprTypeMathResultAssertionsType>
     */
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum ExprTypeMathResultAssertionsType");
    }
