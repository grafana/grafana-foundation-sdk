...
```php
final class ExprTypeClassicConditionsResultAssertionsType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    /**
     * @var array<string, ExprTypeClassicConditionsResultAssertionsType>
     */
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum ExprTypeClassicConditionsResultAssertionsType");
    }
