---
title: <span class="badge object-type-enum"></span> ExprTypeSqlResultAssertionsType
---
# <span class="badge object-type-enum"></span> ExprTypeSqlResultAssertionsType

## Definition

```php
final class ExprTypeSqlResultAssertionsType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    /**
     * @var array<string, ExprTypeSqlResultAssertionsType>
     */
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum ExprTypeSqlResultAssertionsType");
    }
