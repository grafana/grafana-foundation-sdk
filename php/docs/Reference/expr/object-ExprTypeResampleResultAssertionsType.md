---
title: <span class="badge object-type-enum"></span> ExprTypeResampleResultAssertionsType
---
# <span class="badge object-type-enum"></span> ExprTypeResampleResultAssertionsType

## Definition

```php
final class ExprTypeResampleResultAssertionsType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    /**
     * @var array<string, ExprTypeResampleResultAssertionsType>
     */
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum ExprTypeResampleResultAssertionsType");
    }
