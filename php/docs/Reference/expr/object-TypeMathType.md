---
title: <span class="badge object-type-enum"></span> TypeMathType
---
# <span class="badge object-type-enum"></span> TypeMathType

## Definition

```php
final class TypeMathType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum TypeMathType");
    }
