...
```php
final class TypeSqlType implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum TypeSqlType");
    }
