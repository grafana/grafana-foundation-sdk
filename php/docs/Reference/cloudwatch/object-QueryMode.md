...
```php
final class QueryMode implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum QueryMode");
    }
