...
```php
final class VariableModelStaticOptionsOrder implements \JsonSerializable, \Stringable {
    /**
     * @var string
     */
    private $value;
    ...
    /**
     * @var array<string, VariableModelStaticOptionsOrder>
     */
    ...
    public static function fromValue(string $value): self
    {
        ...
        throw new \UnexpectedValueException("Value '$value' is not part of the enum VariableModelStaticOptionsOrder");
    }
