---
title: <span class="badge object-type-class"></span> Dashboardv2
---
# <span class="badge object-type-class"></span> Dashboardv2

## Definition

```php
class Dashboardv2 implements \JsonSerializable
{
}
```
## Methods
...
```php
static manifest(string $name, \Grafana\Foundation\Cog\Builder $spec)
```
