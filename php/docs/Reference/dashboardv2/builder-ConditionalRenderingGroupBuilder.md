...
```php
condition(\Grafana\Foundation\Dashboardv2\ConditionalRenderingGroupSpecCondition $condition)
```
...
```php
visibility(\Grafana\Foundation\Dashboardv2\ConditionalRenderingGroupSpecVisibility $visibility)
```
