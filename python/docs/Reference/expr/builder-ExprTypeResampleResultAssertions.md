---
title: <span class="badge builder"></span> ExprTypeResampleResultAssertions
---
# <span class="badge builder"></span> ExprTypeResampleResultAssertions
...
```python
def build() -> expr.ExprTypeResampleResultAssertions
```
