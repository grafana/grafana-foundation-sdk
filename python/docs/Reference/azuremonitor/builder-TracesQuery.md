---
title: <span class="badge builder"></span> TracesQuery
---
...
```python
def build() -> azuremonitor.TracesQuery
```
...
```python
def filters(filters: list[cogbuilder.Builder[azuremonitor.TracesFilter]]) -> typing.Self
```
