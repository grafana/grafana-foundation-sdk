...
class MonitorQuery(cogvariants.Dataquery):
    ...
    azure_monitor: typing.Optional[azuremonitor.MetricQuery]
    # Azure Monitor Logs sub-query properties.
    azure_log_analytics: typing.Optional[azuremonitor.LogsQuery]
    # Azure Resource Graph sub-query properties.
    azure_resource_graph: typing.Optional[azuremonitor.ResourceGraphQuery]
    # Application Insights Traces sub-query properties.
    azure_traces: typing.Optional[azuremonitor.TracesQuery]
