---
title: <span class="badge builder"></span> ResultAssertions
---
# <span class="badge builder"></span> ResultAssertions
...
```python
def build() -> prometheus.ResultAssertions
```
...
```python
def type_val(type_val: prometheus.ResultAssertionsType) -> typing.Self
```
