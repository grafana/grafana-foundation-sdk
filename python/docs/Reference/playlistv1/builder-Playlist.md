...
```python
def item(item: cogbuilder.Builder[playlistv1.Item]) -> typing.Self
```

### <span class="badge object-method"></span> items

```python
def items(items: list[cogbuilder.Builder[playlistv1.Item]]) -> typing.Self
```
