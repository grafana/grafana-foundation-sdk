...
```python
def defaults(defaults: dashboardv2beta1.FieldConfig) -> typing.Self
```
...
```python
def field_config(field_config: dashboardv2beta1.FieldConfigSource) -> typing.Self
```
...
```python
def spec(spec: dashboardv2beta1.VizConfigSpec) -> typing.Self
```
