---
title: <span class="badge builder"></span> SwitchVariable
---
# <span class="badge builder"></span> SwitchVariable
...
```python
def build() -> dashboardv2beta1.SwitchVariableKind
```
...
### <span class="badge object-method"></span> disabled_value

```python
def disabled_value(disabled_value: str) -> typing.Self
```

### <span class="badge object-method"></span> enabled_value
