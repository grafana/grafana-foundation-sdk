...
class FieldConfig:
    ...
    mappings: typing.Optional[list[dashboardv2beta1.ValueMapping]]
    # Map numeric values to states
    thresholds: typing.Optional[dashboardv2beta1.ThresholdsConfig]
    # Panel color configuration
    color: typing.Optional[dashboardv2beta1.FieldColor]
    # The behavior when clicking on a result
    links: typing.Optional[list[object]]
    # Define interactive HTTP requests that can be triggered from data visualizations.
    actions: typing.Optional[list[dashboardv2beta1.Action]]
