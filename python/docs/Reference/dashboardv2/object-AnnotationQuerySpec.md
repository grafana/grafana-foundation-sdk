...
class AnnotationQuerySpec:
    ...
    filter_val: typing.Optional[dashboardv2.AnnotationPanelFilter]
    # Placement can be used to display the annotation query somewhere else on the dashboard other than the default location.
    placement: typing.Optional[dashboardv2.AnnotationQueryPlacement]
    # Mappings define how to convert data frame fields to annotation event fields.
    mappings: typing.Optional[dict[str, dashboardv2.AnnotationEventFieldMapping]]
