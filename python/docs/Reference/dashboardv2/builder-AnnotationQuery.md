...
```python
def build() -> dashboardv2.AnnotationQueryKind
```
...
```python
def filter_val(filter_val: cogbuilder.Builder[dashboardv2.AnnotationPanelFilter]) -> typing.Self
```
...
```python
def mappings(mappings: dict[str, cogbuilder.Builder[dashboardv2.AnnotationEventFieldMapping]]) -> typing.Self
```
...
```python
def placement(placement: dashboardv2.AnnotationQueryPlacement) -> typing.Self
```

### <span class="badge object-method"></span> query

```python
def query(query: cogbuilder.Builder[dashboardv2.DataQueryKind]) -> typing.Self
```
