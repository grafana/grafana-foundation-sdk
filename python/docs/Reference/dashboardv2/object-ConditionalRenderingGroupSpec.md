...
class ConditionalRenderingGroupSpec:
    ...
    items: list[typing.Union[dashboardv2.ConditionalRenderingVariableKind, dashboardv2.ConditionalRenderingDataKind, dashboardv2.ConditionalRenderingTimeRangeSizeKind]]
```
## Methods
