---
title: <span class="badge builder"></span> VizConfigKind
---
# <span class="badge builder"></span> VizConfigKind
...
```python
def build() -> dashboardv2.VizConfigKind
```
...
```python
def actions(actions: list[cogbuilder.Builder[dashboardv2.Action]]) -> typing.Self
```
...
```python
def color_scheme(color: cogbuilder.Builder[dashboardv2.FieldColor]) -> typing.Self
```
...
```python
def defaults(defaults: dashboardv2.FieldConfig) -> typing.Self
```
...
```python
def field_config(field_config: dashboardv2.FieldConfigSource) -> typing.Self
```
...
```python
def mappings(mappings: list[dashboardv2.ValueMapping]) -> typing.Self
```
...
```python
def null_value_mode(null_value_mode: dashboardv2.NullValueMode) -> typing.Self
```
...
```python
def override(override: cogbuilder.Builder[dashboardv2.Dashboardv2FieldConfigSourceOverrides]) -> typing.Self
```
...
```python
def override_by_field_type(field_type: str, properties: list[dashboardv2.DynamicConfigValue]) -> typing.Self
```
...
```python
def override_by_name(name: str, properties: list[dashboardv2.DynamicConfigValue]) -> typing.Self
```

### <span class="badge object-method"></span> override_by_query

```python
def override_by_query(query_ref_id: str, properties: list[dashboardv2.DynamicConfigValue]) -> typing.Self
```
...
```python
def override_by_regexp(regexp: str, properties: list[dashboardv2.DynamicConfigValue]) -> typing.Self
```
...
```python
def overrides(overrides: list[cogbuilder.Builder[dashboardv2.Dashboardv2FieldConfigSourceOverrides]]) -> typing.Self
```
...
```python
def spec(spec: dashboardv2.VizConfigSpec) -> typing.Self
```
...
```python
def thresholds(thresholds: cogbuilder.Builder[dashboardv2.ThresholdsConfig]) -> typing.Self
```
...
```python
def writeable(writeable: bool) -> typing.Self
```
