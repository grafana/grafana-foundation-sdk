...
class FieldConfig:
    ...
    mappings: typing.Optional[list[dashboardv2.ValueMapping]]
    # Map numeric values to states
    thresholds: typing.Optional[dashboardv2.ThresholdsConfig]
    # Panel color configuration
    color: typing.Optional[dashboardv2.FieldColor]
    # The behavior when clicking on a result
    links: typing.Optional[list[object]]
    # Define interactive HTTP requests that can be triggered from data visualizations.
    actions: typing.Optional[list[dashboardv2.Action]]
    ...
    null_value_mode: typing.Optional[dashboardv2.NullValueMode]
```
## Methods
