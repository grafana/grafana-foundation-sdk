...
```python
def fetch(fetch: cogbuilder.Builder[dashboardv2.FetchOptions]) -> typing.Self
```

### <span class="badge object-method"></span> infinity

```python
def infinity(infinity: cogbuilder.Builder[dashboardv2.InfinityOptions]) -> typing.Self
```
...
```python
def style(style: cogbuilder.Builder[dashboardv2.Dashboardv2ActionStyle]) -> typing.Self
```
...
```python
def type_val(type_val: dashboardv2.ActionType) -> typing.Self
```

### <span class="badge object-method"></span> variables

```python
def variables(variables: list[cogbuilder.Builder[dashboardv2.ActionVariable]]) -> typing.Self
```
