---
title: <span class="badge builder"></span> VariableValueOption
---
...
```python
def build() -> dashboardv2.VariableValueOption
```
...
```python
def value(value: dashboardv2.VariableValueSingle) -> typing.Self
```
