...
```python
def build() -> dashboardv2.FieldColor
```
...
```python
def mode(mode: dashboardv2.FieldColorModeId) -> typing.Self
```
...
```python
def series_by(series_by: dashboardv2.FieldColorSeriesByMode) -> typing.Self
```
