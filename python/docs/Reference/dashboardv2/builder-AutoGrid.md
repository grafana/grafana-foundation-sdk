---
title: <span class="badge builder"></span> AutoGrid
---
# <span class="badge builder"></span> AutoGrid
...
```python
def build() -> dashboardv2.AutoGridLayoutKind
```
...
```python
def item(item: cogbuilder.Builder[dashboardv2.AutoGridLayoutItemKind]) -> typing.Self
```

### <span class="badge object-method"></span> items

```python
def items(items: list[cogbuilder.Builder[dashboardv2.AutoGridLayoutItemKind]]) -> typing.Self
```
...
### <span class="badge object-method"></span> with_item
