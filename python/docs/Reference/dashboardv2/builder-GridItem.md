---
title: <span class="badge builder"></span> GridItem
---
# <span class="badge builder"></span> GridItem
...
```python
def build() -> dashboardv2.GridLayoutItemKind
```
...
```python
def repeat(repeat: cogbuilder.Builder[dashboardv2.RepeatOptions]) -> typing.Self
```
