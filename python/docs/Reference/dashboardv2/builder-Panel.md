...
```python
def build() -> dashboardv2.PanelKind
```

### <span class="badge object-method"></span> data

```python
def data(data: cogbuilder.Builder[dashboardv2.QueryGroupKind]) -> typing.Self
```
...
```python
def links(links: list[cogbuilder.Builder[dashboardv2.DataLink]]) -> typing.Self
```
...
```python
def visualization(viz_config: cogbuilder.Builder[dashboardv2.VizConfigKind]) -> typing.Self
```
