...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def keep_time(self, keep_time: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.keep_time = keep_time
    ...
    def include_vars(self, include_vars: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.include_vars = include_vars
    ...
    def show_starred(self, show_starred: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.show_starred = show_starred
    ...
    def show_recently_viewed(self, show_recently_viewed: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.show_recently_viewed = show_recently_viewed
    ...
    def show_search(self, show_search: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.show_search = show_search
    ...
    def show_headings(self, show_headings: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.show_headings = show_headings
    ...
    def show_folder_names(self, show_folder_names: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.show_folder_names = show_folder_names
    ...
    def max_items(self, max_items: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.max_items = max_items
    ...
    def query(self, query: str) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.query = query
    ...
    def tags(self, tags: list[str]) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.tags = tags
    ...
    def folder_id(self, folder_id: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.folder_id = folder_id
    ...
    def folder_uid(self, folder_uid: str) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = dashboardlist.Options()
        assert isinstance(self._internal.spec.options, dashboardlist.Options)
        self._internal.spec.options.folder_uid = folder_uid
