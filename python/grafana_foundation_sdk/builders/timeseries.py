...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def __init__(self) -> None:
        ...
        self._internal.group = "timeseries"
    ...
    def timezone(self, timezone: list[common.TimeZone]) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = timeseries.Options()
        assert isinstance(self._internal.spec.options, timeseries.Options)
    ...
    def draw_style(self, draw_style: common.GraphDrawStyle) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = timeseries.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, timeseries.FieldConfig)
