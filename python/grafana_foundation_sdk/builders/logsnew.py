...
class Panel(cogbuilder.Builder[dashboard.Panel]):    
    ...
    def grammar(self, grammar: object) -> typing.Self:    
        if self._internal.options is None:
            self._internal.options = logsnew.Options()
        assert isinstance(self._internal.options, logsnew.Options)
        self._internal.options.grammar = grammar
...
class Visualization(cogbuilder.Builder[dashboardv2beta1.VizConfigKind]):
    ...
    def grammar(self, grammar: object) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = logsnew.Options()
        assert isinstance(self._internal.spec.options, logsnew.Options)
        self._internal.spec.options.grammar = grammar
