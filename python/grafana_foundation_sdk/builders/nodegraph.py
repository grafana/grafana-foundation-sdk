...
class Panel(cogbuilder.Builder[dashboard.Panel]):    
    ...
    def layout_algorithm(self, layout_algorithm: nodegraph.LayoutAlgorithm) -> typing.Self:    
        """
        ...
        if self._internal.options is None:
            self._internal.options = nodegraph.Options()
        assert isinstance(self._internal.options, nodegraph.Options)
        self._internal.options.layout_algorithm = layout_algorithm
...
class Visualization(cogbuilder.Builder[dashboardv2beta1.VizConfigKind]):
    ...
    def __init__(self) -> None:
        ...
        self._internal.group = "nodeGraph"
    ...
    def layout_algorithm(self, layout_algorithm: nodegraph.LayoutAlgorithm) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = nodegraph.Options()
        assert isinstance(self._internal.spec.options, nodegraph.Options)
        self._internal.spec.options.layout_algorithm = layout_algorithm
