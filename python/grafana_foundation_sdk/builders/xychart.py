...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def show(self, show: xychart.XYShowMode) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = xychart.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, xychart.FieldConfig)
        self._internal.spec.field_config.defaults.custom.show = show
    ...
    def point_size(self, point_size: cogbuilder.Builder[xychart.XychartFieldConfigPointSize]) -> typing.Self:    
        ...
        assert isinstance(self._internal.spec.field_config.defaults.custom, xychart.FieldConfig)
        point_size_resource = point_size.build()
        self._internal.spec.field_config.defaults.custom.point_size = point_size_resource
    ...
    def point_shape(self, point_shape: xychart.PointShape) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = xychart.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, xychart.FieldConfig)
        self._internal.spec.field_config.defaults.custom.point_shape = point_shape
    ...
    def point_stroke_width(self, point_stroke_width: int) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = xychart.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, xychart.FieldConfig)
        self._internal.spec.field_config.defaults.custom.point_stroke_width = point_stroke_width
    ...
    def mapping(self, mapping: xychart.SeriesMapping) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = xychart.Options()
        assert isinstance(self._internal.spec.options, xychart.Options)
        self._internal.spec.options.mapping = mapping
    ...
    def series(self, series: list[cogbuilder.Builder[xychart.XYSeriesConfig]]) -> typing.Self:    
        ...
        assert isinstance(self._internal.spec.options, xychart.Options)
        series_resources = [r1.build() for r1 in series]
        self._internal.spec.options.series = series_resources
