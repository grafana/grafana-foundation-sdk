...
class Options(cogbuilder.Builder[trend.Options]):    
    """
    Identical to timeseries... except it does not have timezone settings
    """
    
    _internal: trend.Options

    def __init__(self) -> None:
        self._internal = trend.Options()

    def build(self) -> trend.Options:
        """
        Builds the object.
        """
...
class FieldConfig(cogbuilder.Builder[trend.FieldConfig]):
    _internal: trend.FieldConfig

    def __init__(self) -> None:
        self._internal = trend.FieldConfig()

    def build(self) -> trend.FieldConfig:
        """
        Builds the object.
        """
        return self._internal    
