...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def legend(self, legend: cogbuilder.Builder[common.VizLegendOptions]) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = trend.Options()
        assert isinstance(self._internal.spec.options, trend.Options)
        legend_resource = legend.build()
    ...
    def draw_style(self, draw_style: common.GraphDrawStyle) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = trend.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, trend.FieldConfig)
