...
class Panel(cogbuilder.Builder[dashboard.Panel]):    
    ...
    def fill_opacity(self, fill_opacity: int) -> typing.Self:    
        ...
        if not fill_opacity >= 0:
            raise ValueError("fill_opacity must be >= 0")
...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def x_field(self, x_field: str) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.x_field = x_field
    ...
    def color_by_field(self, color_by_field: str) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.color_by_field = color_by_field
    ...
    def bar_radius(self, bar_radius: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.bar_radius = bar_radius
    ...
    def x_tick_label_rotation(self, x_tick_label_rotation: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.x_tick_label_rotation = x_tick_label_rotation
    ...
    def x_tick_label_max_length(self, x_tick_label_max_length: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.x_tick_label_max_length = x_tick_label_max_length
    ...
    def x_tick_label_spacing(self, x_tick_label_spacing: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.x_tick_label_spacing = x_tick_label_spacing
    ...
    def stacking(self, stacking: common.StackingMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.stacking = stacking
    ...
    def bar_width(self, bar_width: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.bar_width = bar_width
    ...
    def group_width(self, group_width: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.group_width = group_width
    ...
    def full_highlight(self, full_highlight: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = barchart.Options()
        assert isinstance(self._internal.spec.options, barchart.Options)
        self._internal.spec.options.full_highlight = full_highlight
    ...
    def line_width(self, line_width: int) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = barchart.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, barchart.FieldConfig)
