...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def only_from_this_dashboard(self, only_from_this_dashboard: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.only_from_this_dashboard = only_from_this_dashboard
    ...
    def only_in_time_range(self, only_in_time_range: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.only_in_time_range = only_in_time_range
    ...
    def limit(self, limit: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.limit = limit
    ...
    def show_user(self, show_user: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.show_user = show_user
    ...
    def show_tags(self, show_tags: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.show_tags = show_tags
    ...
    def navigate_to_panel(self, navigate_to_panel: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.navigate_to_panel = navigate_to_panel
    ...
    def navigate_before(self, navigate_before: str) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.navigate_before = navigate_before
    ...
    def navigate_after(self, navigate_after: str) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = annotationslist.Options()
        assert isinstance(self._internal.spec.options, annotationslist.Options)
        self._internal.spec.options.navigate_after = navigate_after
