...
class NodesQuery(cogbuilder.Builder[testdata.NodesQuery]):
    ...
    def type(self, type_val: typing.Literal["random", "random edges", "response_medium", "response_small", "feature_showcase"]) -> typing.Self:    
        """
...
class StreamingQuery(cogbuilder.Builder[testdata.StreamingQuery]):
    ...
    def type(self, type_val: typing.Literal["fetch", "logs", "signal", "traces"]) -> typing.Self:    
        """
        Possible enum values:
         - `"fetch"` 
         - `"logs"` 
...
class Dataquery(cogbuilder.Builder[testdata.Dataquery]):
    ...
    def scenario_id(self, scenario_id: typing.Literal["annotations", "arrow", "csv_content", "csv_file", "csv_metric_values", "datapoints_outside_range", "error_with_source", "exponential_heatmap_bucket_data", "flame_graph", "grafana_api", "linear_heatmap_bucket_data", "live", "logs", "manual_entry", "no_data_points", "node_graph", "predictable_csv_wave", "predictable_pulse", "random_walk", "random_walk_table", "random_walk_with_error", "raw_frame", "server_error_500", "steps", "simulation", "slow_query", "streaming_client", "table_static", "trace", "usa", "variables-query"]) -> typing.Self:    
        """
        Possible enum values:
         - `"annotations"` 
         - `"arrow"` 
