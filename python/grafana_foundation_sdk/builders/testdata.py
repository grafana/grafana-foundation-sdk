...
class StreamingQuery(cogbuilder.Builder[testdata.StreamingQuery]):
    ...
    def type(self, type_val: typing.Literal["signal", "logs", "fetch", "traces"]) -> typing.Self:    
...
class NodesQuery(cogbuilder.Builder[testdata.NodesQuery]):
    ...
    def type(self, type_val: typing.Literal["random", "response_small", "response_medium", "random edges"]) -> typing.Self:    
        self._internal.type_val = type_val
