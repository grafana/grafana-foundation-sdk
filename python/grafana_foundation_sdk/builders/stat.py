...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def graph_mode(self, graph_mode: common.BigValueGraphMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = stat.Options()
        assert isinstance(self._internal.spec.options, stat.Options)
        self._internal.spec.options.graph_mode = graph_mode
    ...
    def color_mode(self, color_mode: common.BigValueColorMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = stat.Options()
        assert isinstance(self._internal.spec.options, stat.Options)
        self._internal.spec.options.color_mode = color_mode
    ...
    def justify_mode(self, justify_mode: common.BigValueJustifyMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = stat.Options()
        assert isinstance(self._internal.spec.options, stat.Options)
        self._internal.spec.options.justify_mode = justify_mode
    ...
    def text_mode(self, text_mode: common.BigValueTextMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = stat.Options()
        assert isinstance(self._internal.spec.options, stat.Options)
        self._internal.spec.options.text_mode = text_mode
    ...
    def wide_layout(self, wide_layout: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = stat.Options()
        assert isinstance(self._internal.spec.options, stat.Options)
        self._internal.spec.options.wide_layout = wide_layout
    ...
    def show_percent_change(self, show_percent_change: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = stat.Options()
        assert isinstance(self._internal.spec.options, stat.Options)
        self._internal.spec.options.show_percent_change = show_percent_change
    ...
    def percent_change_color_mode(self, percent_change_color_mode: common.PercentChangeColorMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = stat.Options()
        assert isinstance(self._internal.spec.options, stat.Options)
        self._internal.spec.options.percent_change_color_mode = percent_change_color_mode
