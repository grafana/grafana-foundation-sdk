...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def __init__(self) -> None:
        ...
        self._internal.group = "status-history"
    ...
    def row_height(self, row_height: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = statushistory.Options()
        assert isinstance(self._internal.spec.options, statushistory.Options)
        self._internal.spec.options.row_height = row_height
    ...
    def col_width(self, col_width: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = statushistory.Options()
        assert isinstance(self._internal.spec.options, statushistory.Options)
        self._internal.spec.options.col_width = col_width
    ...
    def timezone(self, timezone: list[common.TimeZone]) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = statushistory.Options()
        assert isinstance(self._internal.spec.options, statushistory.Options)
        self._internal.spec.options.timezone = timezone
    ...
    def per_page(self, per_page: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = statushistory.Options()
        assert isinstance(self._internal.spec.options, statushistory.Options)
        self._internal.spec.options.per_page = per_page
    ...
    def line_width(self, line_width: int) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = statushistory.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, statushistory.FieldConfig)
