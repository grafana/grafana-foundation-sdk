...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def frame_index(self, frame_index: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = table.Options()
        assert isinstance(self._internal.spec.options, table.Options)
        self._internal.spec.options.frame_index = frame_index
    ...
    def show_header(self, show_header: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = table.Options()
        assert isinstance(self._internal.spec.options, table.Options)
        self._internal.spec.options.show_header = show_header
    ...
    def show_type_icons(self, show_type_icons: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = table.Options()
        assert isinstance(self._internal.spec.options, table.Options)
        self._internal.spec.options.show_type_icons = show_type_icons
    ...
    def sort_by(self, sort_by: list[cogbuilder.Builder[common.TableSortByFieldState]]) -> typing.Self:    
        ...
        assert isinstance(self._internal.spec.options, table.Options)
        sort_by_resources = [r1.build() for r1 in sort_by]
        self._internal.spec.options.sort_by = sort_by_resources
    ...
    def footer(self, footer: cogbuilder.Builder[common.TableFooterOptions]) -> typing.Self:    
        ...
        assert isinstance(self._internal.spec.options, table.Options)
        footer_resource = footer.build()
        self._internal.spec.options.footer = footer_resource
    ...
    def cell_height(self, cell_height: common.TableCellHeight) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = table.Options()
        assert isinstance(self._internal.spec.options, table.Options)
        self._internal.spec.options.cell_height = cell_height
    ...
    def width(self, width: float) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.width = width
    ...
    def min_width(self, min_width: float) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.min_width = min_width
    ...
    def align(self, align: common.FieldTextAlignment) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.align = align
    ...
    def display_mode(self, display_mode: common.TableCellDisplayMode) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.display_mode = display_mode
    ...
    def cell_options(self, cell_options: common.TableCellOptions) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.cell_options = cell_options
    ...
    def hidden(self, hidden: bool) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.hidden = hidden
    ...
    def inspect(self, inspect: bool) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.inspect = inspect
    ...
    def filterable(self, filterable: bool) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.filterable = filterable
    ...
    def hide_header(self, hide_header: bool) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = table.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, table.FieldConfig)
        self._internal.spec.field_config.defaults.custom.hide_header = hide_header
