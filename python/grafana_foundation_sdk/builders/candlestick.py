...
class Options(cogbuilder.Builder[candlestick.Options]):
    _internal: candlestick.Options

    def __init__(self) -> None:
        self._internal = candlestick.Options()

    def build(self) -> candlestick.Options:
        """
        Builds the object.
        """
        return self._internal    
    ...
    def candle_style(self, candle_style: candlestick.CandleStyle) -> typing.Self:    
        ...
        self._internal.candle_style = candle_style
    ...
    def color_strategy(self, color_strategy: candlestick.ColorStrategy) -> typing.Self:    
        ...
        self._internal.color_strategy = color_strategy
    ...
    def fields(self, fields: cogbuilder.Builder[candlestick.CandlestickFieldMap]) -> typing.Self:    
        ...
        self._internal.fields = fields_resource
    ...
    def colors(self, colors: cogbuilder.Builder[candlestick.CandlestickColors]) -> typing.Self:    
        ...
        self._internal.colors = colors_resource
    ...
    def include_all_fields(self, include_all_fields: bool) -> typing.Self:    
        ...
        self._internal.include_all_fields = include_all_fields
    
        return self
    


class FieldConfig(cogbuilder.Builder[candlestick.FieldConfig]):
    _internal: candlestick.FieldConfig

    def __init__(self) -> None:
        self._internal = candlestick.FieldConfig()

    def build(self) -> candlestick.FieldConfig:
        """
        Builds the object.
        """
        return self._internal    
