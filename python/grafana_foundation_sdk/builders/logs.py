...
class Visualization(cogbuilder.Builder[dashboardv2beta1.VizConfigKind]):
    ...
    def show_labels(self, show_labels: bool) -> typing.Self:    
        ...
        self._internal.spec.options.show_labels = show_labels
    ...
    def show_common_labels(self, show_common_labels: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = logs.Options()
        assert isinstance(self._internal.spec.options, logs.Options)
        self._internal.spec.options.show_common_labels = show_common_labels
    ...
    def show_log_context_toggle(self, show_log_context_toggle: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = logs.Options()
        assert isinstance(self._internal.spec.options, logs.Options)
        self._internal.spec.options.show_log_context_toggle = show_log_context_toggle
    ...
    def controls_storage_key(self, controls_storage_key: str) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = logs.Options()
        assert isinstance(self._internal.spec.options, logs.Options)
        self._internal.spec.options.controls_storage_key = controls_storage_key
    ...
    def prettify_log_message(self, prettify_log_message: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = logs.Options()
        assert isinstance(self._internal.spec.options, logs.Options)
        self._internal.spec.options.prettify_log_message = prettify_log_message
    ...
    def on_log_options_change(self, on_log_options_change: object) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = logs.Options()
        assert isinstance(self._internal.spec.options, logs.Options)
        self._internal.spec.options.on_log_options_change = on_log_options_change
