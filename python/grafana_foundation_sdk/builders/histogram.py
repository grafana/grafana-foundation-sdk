...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def __init__(self) -> None:
        ...
        self._internal.group = "histogram"
    ...
    def bucket_count(self, bucket_count: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = histogram.Options()
        assert isinstance(self._internal.spec.options, histogram.Options)
        self._internal.spec.options.bucket_count = bucket_count
    ...
    def bucket_size(self, bucket_size: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = histogram.Options()
        assert isinstance(self._internal.spec.options, histogram.Options)
        self._internal.spec.options.bucket_size = bucket_size
    ...
    def bucket_offset(self, bucket_offset: float) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = histogram.Options()
        assert isinstance(self._internal.spec.options, histogram.Options)
        self._internal.spec.options.bucket_offset = bucket_offset
    ...
    def combine(self, combine: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = histogram.Options()
        assert isinstance(self._internal.spec.options, histogram.Options)
        self._internal.spec.options.combine = combine
    ...
    def line_width(self, line_width: int) -> typing.Self:    
        ...
        if self._internal.spec.field_config.defaults.custom is None:
            self._internal.spec.field_config.defaults.custom = histogram.FieldConfig()
        assert isinstance(self._internal.spec.field_config.defaults.custom, histogram.FieldConfig)
