...
class VisualizationV2(cogbuilder.Builder[dashboardv2.VizConfigKind]):
    ...
    def display_mode(self, display_mode: common.BarGaugeDisplayMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = bargauge.Options()
        assert isinstance(self._internal.spec.options, bargauge.Options)
        self._internal.spec.options.display_mode = display_mode
    ...
    def value_mode(self, value_mode: common.BarGaugeValueMode) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = bargauge.Options()
        assert isinstance(self._internal.spec.options, bargauge.Options)
        self._internal.spec.options.value_mode = value_mode
    ...
    def name_placement(self, name_placement: common.BarGaugeNamePlacement) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = bargauge.Options()
        assert isinstance(self._internal.spec.options, bargauge.Options)
        self._internal.spec.options.name_placement = name_placement
    ...
    def show_unfilled(self, show_unfilled: bool) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = bargauge.Options()
        assert isinstance(self._internal.spec.options, bargauge.Options)
        self._internal.spec.options.show_unfilled = show_unfilled
    ...
    def max_viz_height(self, max_viz_height: int) -> typing.Self:    
        ...
        if self._internal.spec.options is None:
            self._internal.spec.options = bargauge.Options()
        assert isinstance(self._internal.spec.options, bargauge.Options)
        self._internal.spec.options.max_viz_height = max_viz_height
