...
class TimeOption(cogbuilder.Builder[dashboard.TimeOption]):    
    """
...
class AnnotationQuery(cogbuilder.Builder[dashboard.AnnotationQuery]):    
    ...
    def filter(self, filter_val: cogbuilder.Builder[dashboard.AnnotationPanelFilter]) -> typing.Self:    
        """
...
class DashboardDashboardTemplating(cogbuilder.Builder[dashboard.DashboardDashboardTemplating]):
    ...
    def list(self, list_val: list[cogbuilder.Builder[dashboard.VariableModel]]) -> typing.Self:    
        """
...
class TimePicker(cogbuilder.Builder[dashboard.TimePickerConfig]):    
    ...
    def quick_ranges(self, quick_ranges: list[cogbuilder.Builder[dashboard.TimeOption]]) -> typing.Self:    
        """
...
class DashboardLink(cogbuilder.Builder[dashboard.DashboardLink]):    
    ...
    def type(self, type_val: dashboard.DashboardLinkType) -> typing.Self:    
        """
...
class DatasourceVariable(cogbuilder.Builder[dashboard.VariableModel]):    
    ...
    def type(self, query: typing.Union[str, dict[str, object]]) -> typing.Self:    
        """
        Query used to fetch values for a variable
        """
