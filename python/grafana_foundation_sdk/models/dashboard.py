...
class TimePickerConfig:
    ...
    def __init__(self, hidden: typing.Optional[bool] = False, refresh_intervals: typing.Optional[list[str]] = None, quick_ranges: typing.Optional[list['TimeOption']] = None, now_delay: typing.Optional[str] = None) -> None:
        self.hidden = hidden
...
class TimeOption:
    ...
    def __init__(self, display: str = "", from_val: str = "", to: str = "") -> None:
...
DataSourceRef: typing.TypeAlias = common.DataSourceRef
...
class RowPanel:
    ...
    def __init__(self, collapsed: bool = False, title: typing.Optional[str] = None, datasource: typing.Optional[common.DataSourceRef] = None, grid_pos: typing.Optional['GridPos'] = None, id_val: int = 0, panels: typing.Optional[list['Panel']] = None, repeat: typing.Optional[str] = None) -> None:
        self.type_val = "row"
