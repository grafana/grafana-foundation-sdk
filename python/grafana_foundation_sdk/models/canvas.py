...
class Placement:
    ...
    def __init__(self, top: typing.Optional[float] = None, left: typing.Optional[float] = None, right: typing.Optional[float] = None, bottom: typing.Optional[float] = None, width: typing.Optional[float] = None, height: typing.Optional[float] = None, rotation: typing.Optional[float] = None) -> None:
        self.top = top
        self.left = left
        self.right = right
        self.bottom = bottom
...
class LineConfig:
    ...
    def __init__(self, color: typing.Optional[common.ColorDimensionConfig] = None, width: typing.Optional[float] = None, radius: typing.Optional[float] = None) -> None:
        self.color = color
        self.width = width
        self.radius = radius
...
class CanvasConnection:
    ...
    def __init__(self, source: typing.Optional['ConnectionCoordinates'] = None, target: typing.Optional['ConnectionCoordinates'] = None, target_name: typing.Optional[str] = None, color: typing.Optional[common.ColorDimensionConfig] = None, size: typing.Optional[common.ScaleDimensionConfig] = None, vertices: typing.Optional[list['ConnectionCoordinates']] = None, source_original: typing.Optional['ConnectionCoordinates'] = None, target_original: typing.Optional['ConnectionCoordinates'] = None) -> None:
