...
class Preferences:
    ...
    def to_json(self) -> dict[str, object]:
        ...
        if self.regional_format is not None:
            payload["regionalFormat"] = self.regional_format
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "regionalFormat" in data:
            args["regional_format"] = data["regionalFormat"]
