...
class Dashboard:
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "preferences" in data:
            args["preferences"] = Preferences.from_json(data["preferences"])        
...
class DataQueryKind:
    ...
    datasource: typing.Optional['Dashboardv2DataQueryKindDatasource']
    spec: typing.Optional[object]

    def __init__(self, group: str = "", version: str = "v0", labels: typing.Optional[dict[str, str]] = None, datasource: typing.Optional['Dashboardv2DataQueryKindDatasource'] = None, spec: typing.Optional[object] = None) -> None:
        self.kind = "DataQuery"
        self.group = group
...
class PanelSpec:
    ...
    def __init__(self, id_val: int = 0, title: str = "", description: str = "", links: typing.Optional[list['DataLink']] = None, data: typing.Optional['QueryGroupKind'] = None, viz_config: typing.Optional['VizConfigKind'] = None, transparent: typing.Optional[bool] = None) -> None:
        self.id_val = id_val
        self.title = title
        self.description = description
        self.links = links if links is not None else []
...
class PanelQuerySpec:
    ...
    def __init__(self, query: typing.Optional['DataQueryKind'] = None, ref_id: str = "", hidden: bool = False) -> None:
        self.query = query if query is not None else DataQueryKind()
        self.ref_id = ref_id
        self.hidden = hidden
...
class TransformationKind:
    ...
    def __init__(self, group: str = "", spec: typing.Optional['TransformationSpec'] = None) -> None:
        self.kind = "Transformation"
        self.group = group
        self.spec = spec if spec is not None else TransformationSpec()
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "group" in data:
            args["group"] = data["group"]
        if "spec" in data:
            args["spec"] = TransformationSpec.from_json(data["spec"])        
...
class TransformationSpec:
    ...
    def __init__(self, disabled: typing.Optional[bool] = None, filter_val: typing.Optional['MatcherConfig'] = None, topic: typing.Optional['DataTopic'] = None, options: object = None) -> None:
...
class FieldConfigSource:
    ...
    overrides: list['Dashboardv2FieldConfigSourceOverrides']

    def __init__(self, defaults: typing.Optional['FieldConfig'] = None, overrides: typing.Optional[list['Dashboardv2FieldConfigSourceOverrides']] = None) -> None:
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "overrides" in data:
            args["overrides"] = [Dashboardv2FieldConfigSourceOverrides.from_json(item) for item in data["overrides"]]        
...
class RangeMap:
    ...
    def __init__(self, options: typing.Optional['Dashboardv2RangeMapOptions'] = None) -> None:
        self.type_val = MappingType.RANGE
        self.options = options if options is not None else Dashboardv2RangeMapOptions()
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "options" in data:
            args["options"] = Dashboardv2RangeMapOptions.from_json(data["options"])        
...
class RegexMap:
    ...
    def __init__(self, options: typing.Optional['Dashboardv2RegexMapOptions'] = None) -> None:
        self.type_val = MappingType.REGEX
        self.options = options if options is not None else Dashboardv2RegexMapOptions()
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "options" in data:
            args["options"] = Dashboardv2RegexMapOptions.from_json(data["options"])        
...
class SpecialValueMap:
    ...
    def __init__(self, options: typing.Optional['Dashboardv2SpecialValueMapOptions'] = None) -> None:
        self.type_val = MappingType.SPECIAL
        self.options = options if options is not None else Dashboardv2SpecialValueMapOptions()
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "options" in data:
            args["options"] = Dashboardv2SpecialValueMapOptions.from_json(data["options"])        
...
class Action:
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "style" in data:
            args["style"] = Dashboardv2ActionStyle.from_json(data["style"])        
...
class LibraryPanelKindSpec:
    ...
    def __init__(self, id_val: int = 0, title: str = "", library_panel: typing.Optional['LibraryPanelRef'] = None) -> None:
        self.id_val = id_val
        self.title = title
...
class GroupByVariableKind:
    ...
    group: str
    labels: typing.Optional[dict[str, str]]
    datasource: typing.Optional['Dashboardv2GroupByVariableKindDatasource']
    spec: 'GroupByVariableSpec'

    def __init__(self, group: str = "", labels: typing.Optional[dict[str, str]] = None, datasource: typing.Optional['Dashboardv2GroupByVariableKindDatasource'] = None, spec: typing.Optional['GroupByVariableSpec'] = None) -> None:
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "labels" in data:
            args["labels"] = data["labels"]
        if "datasource" in data:
            args["datasource"] = Dashboardv2GroupByVariableKindDatasource.from_json(data["datasource"])
        if "spec" in data:
...
class AdhocVariableKind:
    ...
    group: str
    labels: typing.Optional[dict[str, str]]
    datasource: typing.Optional['Dashboardv2AdhocVariableKindDatasource']
    spec: 'AdhocVariableSpec'

    def __init__(self, group: str = "", labels: typing.Optional[dict[str, str]] = None, datasource: typing.Optional['Dashboardv2AdhocVariableKindDatasource'] = None, spec: typing.Optional['AdhocVariableSpec'] = None) -> None:
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "labels" in data:
            args["labels"] = data["labels"]
        if "datasource" in data:
            args["datasource"] = Dashboardv2AdhocVariableKindDatasource.from_json(data["datasource"])
        if "spec" in data:
...
class Preferences:
    ...
    layout: typing.Optional[typing.Union['AutoGridLayoutKind', 'GridLayoutKind']]

    def __init__(self, layout: typing.Optional[typing.Union['AutoGridLayoutKind', 'GridLayoutKind']] = None) -> None:
        self.layout = layout
    ...
    def from_json(cls, data: dict[str, typing.Any]) -> typing.Self:
        ...
        if "layout" in data:
            decoding_map_layout_union: dict[str, typing.Union[typing.Type[AutoGridLayoutKind], typing.Type[GridLayoutKind]]] = {"AutoGridLayout": AutoGridLayoutKind, "GridLayout": GridLayoutKind}
            args["layout"] = decoding_map_layout_union[data["layout"]["kind"]].from_json(data["layout"])        
...
DashboardAPIVersion: typing.Literal["dashboard.grafana.app/v2"] = "dashboard.grafana.app/v2"


DashboardKind: typing.Literal["Dashboard"] = "Dashboard"


class Dashboardv2DataQueryKindDatasource:
...
class Dashboardv2FieldConfigSourceOverrides:
...
class Dashboardv2GroupByVariableKindDatasource:
    name: typing.Optional[str]
...
class Dashboardv2AdhocVariableKindDatasource:
    name: typing.Optional[str]
