...
class GraphThresholdsStyleConfig:
    ...
    def __init__(self, mode: typing.Optional['GraphThresholdsStyleMode'] = None) -> None:
...
class VizTextDisplayOptions:
    ...
    def __init__(self, title_size: typing.Optional[float] = None, value_size: typing.Optional[float] = None, percent_size: typing.Optional[float] = None) -> None:
...
class VizTooltipOptions:
    ...
    def __init__(self, mode: typing.Optional['TooltipDisplayMode'] = None, sort: typing.Optional['SortOrder'] = None, max_width: typing.Optional[float] = None, max_height: typing.Optional[float] = None, hide_zeros: typing.Optional[bool] = None) -> None:
...
class TableAutoCellOptions:
    ...
    def __init__(self, wrap_text: typing.Optional[bool] = None) -> None:
...
class TableImageCellOptions:
    ...
    def __init__(self, alt: typing.Optional[str] = None, title: typing.Optional[str] = None) -> None:
...
class TableColoredBackgroundCellOptions:
    ...
    def __init__(self, mode: typing.Optional['TableCellBackgroundDisplayMode'] = None, apply_to_row: typing.Optional[bool] = None, wrap_text: typing.Optional[bool] = None) -> None:
