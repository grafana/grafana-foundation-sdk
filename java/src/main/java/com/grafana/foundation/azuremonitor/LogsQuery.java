...
public class LogsQuery {
    ...
    public LogsQuery(String query,ResultFormat resultFormat,List<String> resources,Boolean dashboardTime,String timeColumn,Boolean basicLogsQuery,String workspace,String resource,Boolean intersectTime) {
        this.query = query;
