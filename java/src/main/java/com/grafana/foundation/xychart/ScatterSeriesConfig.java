...
public class ScatterSeriesConfig {
    ...
    public ScatterSeriesConfig(String x,String y,ScatterShow show,ScaleDimensionConfig pointSize,ColorDimensionConfig pointColor,ColorDimensionConfig lineColor,Integer lineWidth,LineStyle lineStyle,VisibilityMode label,HideSeriesConfig hideFrom,AxisPlacement axisPlacement,AxisColorMode axisColorMode,String axisLabel,Double axisWidth,Double axisSoftMin,Double axisSoftMax,Boolean axisGridShow,ScaleDistributionConfig scaleDistribution,Boolean axisCenteredZero,String name,TextDimensionConfig labelValue,Boolean axisBorderShow) {
        this.x = x;
        this.y = y;
        this.show = show;
