...
public class CustomVariableSpec {
    ...
    public CustomVariableSpec(String name,String query,VariableOption current,List<VariableOption> options,Boolean multi,Boolean includeAll,String allValue,String label,VariableHide hide,Boolean skipUrlSync,String description,Boolean allowCustomValue) {
        this.name = name;
        this.query = query;
