...
public class GroupByVariableKind {
    ...
    public GroupByVariableKind(String kind,String group,Map<String, String> labels,Dashboardv2beta1GroupByVariableKindDatasource datasource,GroupByVariableSpec spec) {
        this.kind = kind;
        this.group = group;
        this.labels = labels;
