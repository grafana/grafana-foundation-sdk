...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public PanelBuilder pieType(PieChartType pieType) {
        ...
        optionsResource.pieType = pieType;
    ...
    public PanelBuilder displayLabels(List<PieChartLabels> displayLabels) {
        ...
        com.grafana.foundation.piechart.Options optionsResource = (com.grafana.foundation.piechart.Options) this.internal.options;
        optionsResource.displayLabels = displayLabels;
    this.internal.options = optionsResource;
        return this;
    }
    ...
    public PanelBuilder hideFrom(com.grafana.foundation.cog.Builder<HideSeriesConfig> hideFrom) {
        ...
        com.grafana.foundation.piechart.FieldConfig fieldConfigResource = (com.grafana.foundation.piechart.FieldConfig) this.internal.fieldConfig.defaults.custom;
