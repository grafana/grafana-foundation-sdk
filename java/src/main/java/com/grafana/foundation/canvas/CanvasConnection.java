...
public class CanvasConnection {
    ...
    public CanvasConnection(ConnectionCoordinates source,ConnectionCoordinates target,String targetName,ColorDimensionConfig color,ScaleDimensionConfig size) {
        this.source = source;
        this.target = target;
