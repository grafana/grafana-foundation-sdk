...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public PanelBuilder inlineEditing(Boolean inlineEditing) {
        ...
        optionsResource.inlineEditing = inlineEditing;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder showAdvancedTypes(Boolean showAdvancedTypes) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.canvas.Options();
		}
        com.grafana.foundation.canvas.Options optionsResource = (com.grafana.foundation.canvas.Options) this.internal.options;
        optionsResource.showAdvancedTypes = showAdvancedTypes;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder panZoom(Boolean panZoom) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.canvas.Options();
		}
        com.grafana.foundation.canvas.Options optionsResource = (com.grafana.foundation.canvas.Options) this.internal.options;
        optionsResource.panZoom = panZoom;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder infinitePan(Boolean infinitePan) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.canvas.Options();
		}
        com.grafana.foundation.canvas.Options optionsResource = (com.grafana.foundation.canvas.Options) this.internal.options;
        optionsResource.infinitePan = infinitePan;
    this.internal.options = optionsResource;
        return this;
    }
