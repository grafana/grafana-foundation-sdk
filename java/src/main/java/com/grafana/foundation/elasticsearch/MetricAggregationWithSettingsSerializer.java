...
public class MetricAggregationWithSettingsSerializer extends JsonSerializer<MetricAggregationWithSettings> {

    @Override
    public void serialize(MetricAggregationWithSettings value, JsonGenerator gen, SerializerProvider serializerProvider) throws IOException {
        if (value.bucketScript != null) {
