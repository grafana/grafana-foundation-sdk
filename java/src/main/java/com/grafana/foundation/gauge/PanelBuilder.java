...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public PanelBuilder showThresholdLabels(Boolean showThresholdLabels) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.gauge.Options();
		}
        com.grafana.foundation.gauge.Options optionsResource = (com.grafana.foundation.gauge.Options) this.internal.options;
        optionsResource.showThresholdLabels = showThresholdLabels;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder showThresholdMarkers(Boolean showThresholdMarkers) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.gauge.Options();
		}
        com.grafana.foundation.gauge.Options optionsResource = (com.grafana.foundation.gauge.Options) this.internal.options;
        optionsResource.showThresholdMarkers = showThresholdMarkers;
    this.internal.options = optionsResource;
        return this;
    }
