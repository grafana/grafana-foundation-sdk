...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public PanelBuilder labels(String labels) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.alertgroups.Options();
		}
        com.grafana.foundation.alertgroups.Options optionsResource = (com.grafana.foundation.alertgroups.Options) this.internal.options;
        optionsResource.labels = labels;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder alertmanager(String alertmanager) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.alertgroups.Options();
		}
        com.grafana.foundation.alertgroups.Options optionsResource = (com.grafana.foundation.alertgroups.Options) this.internal.options;
        optionsResource.alertmanager = alertmanager;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder expandAll(Boolean expandAll) {
		if (this.internal.options == null) {
			this.internal.options = new com.grafana.foundation.alertgroups.Options();
		}
        com.grafana.foundation.alertgroups.Options optionsResource = (com.grafana.foundation.alertgroups.Options) this.internal.options;
        optionsResource.expandAll = expandAll;
    this.internal.options = optionsResource;
        return this;
    }
