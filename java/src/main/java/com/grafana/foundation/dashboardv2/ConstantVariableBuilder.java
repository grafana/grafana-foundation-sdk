...
public class ConstantVariableBuilder implements com.grafana.foundation.cog.Builder<ConstantVariableKind> {
    ...
    public ConstantVariableBuilder(String name) {
		...
		if (this.internal.spec == null) {
			this.internal.spec = new com.grafana.foundation.dashboardv2.ConstantVariableSpec();
		}
    ...
    public ConstantVariableBuilder origin(com.grafana.foundation.cog.Builder<ControlSourceRef> origin) {
		if (this.internal.spec == null) {
			this.internal.spec = new com.grafana.foundation.dashboardv2.ConstantVariableSpec();
		}
