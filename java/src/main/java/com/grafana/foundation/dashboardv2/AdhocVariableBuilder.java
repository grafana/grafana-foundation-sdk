...
public class AdhocVariableBuilder implements com.grafana.foundation.cog.Builder<AdhocVariableKind> {
    ...
    public AdhocVariableBuilder(String name) {
		...
		if (this.internal.spec == null) {
			this.internal.spec = new com.grafana.foundation.dashboardv2.AdhocVariableSpec();
		}
    ...
    public AdhocVariableBuilder datasource(com.grafana.foundation.cog.Builder<Dashboardv2AdhocVariableKindDatasource> datasource) {
    Dashboardv2AdhocVariableKindDatasource datasourceResource = datasource.build();
