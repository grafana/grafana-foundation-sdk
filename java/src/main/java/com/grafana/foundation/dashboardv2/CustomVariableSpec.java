...
public class CustomVariableSpec {
    ...
    public CustomVariableSpec() {
        this.name = "";
        this.query = "";
        this.current = new com.grafana.foundation.dashboardv2.VariableOption();
    ...
    public CustomVariableSpec(String name,String query,VariableOption current,List<VariableOption> options,Boolean multi,Boolean includeAll,String allValue,String label,VariableHide hide,Boolean skipUrlSync,String description,Boolean allowCustomValue,CustomVariableSpecValuesFormat valuesFormat,ControlSourceRef origin) {
        this.name = name;
        this.query = query;
