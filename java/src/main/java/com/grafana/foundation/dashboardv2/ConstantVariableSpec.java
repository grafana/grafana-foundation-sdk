...
public class ConstantVariableSpec {
    ...
    public ConstantVariableSpec(String name,String query,VariableOption current,String label,VariableHide hide,Boolean skipUrlSync,String description,ControlSourceRef origin) {
        this.name = name;
        this.query = query;
