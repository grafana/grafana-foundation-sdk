...
public class Action {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty("style")
    public Dashboardv2ActionStyle style;
    public Action() {
        this.type = ActionType.FETCH;
        this.title = "";
    }
    public Action(ActionType type,String title,FetchOptions fetch,InfinityOptions infinity,String confirmation,Boolean oneClick,List<ActionVariable> variables,Dashboardv2ActionStyle style) {
        this.type = type;
        this.title = title;
        this.fetch = fetch;
