...
public class LibraryPanelKindSpec {
    ...
    public LibraryPanelKindSpec() {
        this.id = 0;
        this.title = "";
        this.libraryPanel = new com.grafana.foundation.dashboardv2.LibraryPanelRef();
    }
    public LibraryPanelKindSpec(Integer id,String title,LibraryPanelRef libraryPanel) {
        this.id = id;
        this.title = title;
