...
public class GroupByVariableBuilder implements com.grafana.foundation.cog.Builder<GroupByVariableKind> {
    ...
    public GroupByVariableBuilder(String name) {
		...
		if (this.internal.spec == null) {
			this.internal.spec = new com.grafana.foundation.dashboardv2.GroupByVariableSpec();
		}
    ...
    public GroupByVariableBuilder datasource(com.grafana.foundation.cog.Builder<Dashboardv2GroupByVariableKindDatasource> datasource) {
    Dashboardv2GroupByVariableKindDatasource datasourceResource = datasource.build();
