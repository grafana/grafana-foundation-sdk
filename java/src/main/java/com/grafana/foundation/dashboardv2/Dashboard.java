...
public class Dashboard {
    ...
    public Dashboard() {
        ...
        this.layout = new com.grafana.foundation.dashboardv2.GridLayoutKindOrRowsLayoutKindOrAutoGridLayoutKindOrTabsLayoutKind();
        this.links = new LinkedList<>();
        this.preload = false;
        this.tags = new LinkedList<>();
        this.timeSettings = new com.grafana.foundation.dashboardv2.TimeSettingsSpec();
        this.title = "";
