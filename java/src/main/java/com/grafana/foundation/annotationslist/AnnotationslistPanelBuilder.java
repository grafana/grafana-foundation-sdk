...
public class AnnotationslistPanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public AnnotationslistPanelBuilder timeCompare(String timeCompare) {
    ...
    public AnnotationslistPanelBuilder actions(List<com.grafana.foundation.cog.Builder<Action>> actions) {
		if (this.internal.fieldConfig == null) {
			this.internal.fieldConfig = new com.grafana.foundation.dashboard.FieldConfigSource();
		}
		if (this.internal.fieldConfig.defaults == null) {
    ...
    public AnnotationslistPanelBuilder fieldMinMax(Boolean fieldMinMax) {
		if (this.internal.fieldConfig == null) {
			this.internal.fieldConfig = new com.grafana.foundation.dashboard.FieldConfigSource();
		}
		if (this.internal.fieldConfig.defaults == null) {
