...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public PanelBuilder candleStyle(CandleStyle candleStyle) {
        ...
        com.grafana.foundation.candlestick.Options optionsResource = (com.grafana.foundation.candlestick.Options) this.internal.options;
        optionsResource.candleStyle = candleStyle;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder colorStrategy(ColorStrategy colorStrategy) {
        ...
        com.grafana.foundation.candlestick.Options optionsResource = (com.grafana.foundation.candlestick.Options) this.internal.options;
        optionsResource.colorStrategy = colorStrategy;
    this.internal.options = optionsResource;
        return this;
    }
    ...
    public PanelBuilder includeAllFields(Boolean includeAllFields) {
        ...
        com.grafana.foundation.candlestick.Options optionsResource = (com.grafana.foundation.candlestick.Options) this.internal.options;
        optionsResource.includeAllFields = includeAllFields;
    this.internal.options = optionsResource;
        return this;
    }
    public PanelBuilder drawStyle(GraphDrawStyle drawStyle) {
        ...
        com.grafana.foundation.candlestick.FieldConfig fieldConfigResource = (com.grafana.foundation.candlestick.FieldConfig) this.internal.fieldConfig.defaults.custom;
