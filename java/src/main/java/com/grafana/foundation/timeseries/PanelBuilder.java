...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    this.internal.type = "timeseries";
        ...
        this.height(9);
        this.span(12);
        VizLegendOptions.Builder vizLegendOptionsResource = new VizLegendOptions.Builder();
        this.legend(vizLegendOptionsResource);
    }
    ...
    public PanelBuilder timezone(List<String> timezone) {
        ...
        com.grafana.foundation.timeseries.Options optionsResource = (com.grafana.foundation.timeseries.Options) this.internal.options;
    ...
    public PanelBuilder drawStyle(GraphDrawStyle drawStyle) {
        ...
        com.grafana.foundation.timeseries.FieldConfig fieldConfigResource = (com.grafana.foundation.timeseries.FieldConfig) this.internal.fieldConfig.defaults.custom;
