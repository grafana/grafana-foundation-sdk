...
public class TimeseriesPanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public TimeseriesPanelBuilder timeCompare(String timeCompare) {
    ...
    public TimeseriesPanelBuilder actions(List<com.grafana.foundation.cog.Builder<Action>> actions) {
		if (this.internal.fieldConfig == null) {
			this.internal.fieldConfig = new com.grafana.foundation.dashboard.FieldConfigSource();
		}
		if (this.internal.fieldConfig.defaults == null) {
    ...
    public TimeseriesPanelBuilder fieldMinMax(Boolean fieldMinMax) {
		if (this.internal.fieldConfig == null) {
			this.internal.fieldConfig = new com.grafana.foundation.dashboard.FieldConfigSource();
		}
		if (this.internal.fieldConfig.defaults == null) {
