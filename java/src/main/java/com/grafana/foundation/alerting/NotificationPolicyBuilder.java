...
public class NotificationPolicyBuilder implements com.grafana.foundation.cog.Builder<NotificationPolicy> {
    ...
    public NotificationPolicyBuilder objectMatchers(List<com.grafana.foundation.cog.Builder<Matcher>> objectMatchers) {
        List<Matcher> objectMatchersResources = new LinkedList<>();
        for (com.grafana.foundation.cog.Builder<Matcher> r1 : objectMatchers) {
                Matcher objectMatchersDepth1 = r1.build();
                objectMatchersResources.add(objectMatchersDepth1); 
        }
