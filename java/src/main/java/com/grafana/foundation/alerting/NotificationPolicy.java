...
public class NotificationPolicy {
    ...
    public NotificationPolicy(Boolean continueArg,List<String> groupBy,String groupInterval,String groupWait,Map<String, String> match,Map<String, Object> matchRe,List<Matcher> matchers,List<String> muteTimeIntervals,List<Matcher> objectMatchers,String provenance,String receiver,String repeatInterval,List<NotificationPolicy> routes) {
