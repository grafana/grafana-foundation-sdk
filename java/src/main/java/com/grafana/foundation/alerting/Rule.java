...
public class Rule {
    ...
    public Builder notificationSettings(com.grafana.foundation.cog.Builder<NotificationSettings> notificationSettings) {
    ...
    public Builder record(com.grafana.foundation.cog.Builder<RecordRule> record) {
