...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public PanelBuilder width(Double width) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.width = width;
    ...
    public PanelBuilder minWidth(Double minWidth) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.minWidth = minWidth;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
    public PanelBuilder align(FieldTextAlignment align) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.align = align;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
    public PanelBuilder displayMode(TableCellDisplayMode displayMode) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.displayMode = displayMode;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
    public PanelBuilder cellOptions(TableCellOptions cellOptions) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.cellOptions = cellOptions;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
    public PanelBuilder hidden(Boolean hidden) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.hidden = hidden;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
    public PanelBuilder inspect(Boolean inspect) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.inspect = inspect;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
    public PanelBuilder filterable(Boolean filterable) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.filterable = filterable;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
    public PanelBuilder hideHeader(Boolean hideHeader) {
        ...
        com.grafana.foundation.table.FieldConfig fieldConfigResource = (com.grafana.foundation.table.FieldConfig) this.internal.fieldConfig.defaults.custom;
        fieldConfigResource.hideHeader = hideHeader;
    this.internal.fieldConfig.defaults.custom = fieldConfigResource;
        return this;
    }
