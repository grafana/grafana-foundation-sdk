...
public class Registry {
    ...
    static {
        ...
        registerPanel("table", com.grafana.foundation.table.Options.class, com.grafana.foundation.table.FieldConfig.class);
        ...
        registerDataquery("cloudwatch", com.grafana.foundation.cloudwatch.Request.class);
