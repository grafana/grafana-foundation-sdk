...
public class DashboardBuilder implements com.grafana.foundation.cog.Builder<Dashboard> {
    ...
    public DashboardBuilder style(DashboardStyle style) {
    ...
    public DashboardBuilder timepicker(com.grafana.foundation.cog.Builder<TimePicker> timepicker) {
    TimePicker timepickerResource = timepicker.build();
    ...
    public DashboardBuilder refresh(String string) {
