...
public class PanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public PanelBuilder selectedSeries(Integer selectedSeries) {
        if (!(selectedSeries >= 0)) {
        ...
        com.grafana.foundation.datagrid.Options optionsResource = (com.grafana.foundation.datagrid.Options) this.internal.options;
        optionsResource.selectedSeries = selectedSeries;
