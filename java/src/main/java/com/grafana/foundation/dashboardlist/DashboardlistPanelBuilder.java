...
public class DashboardlistPanelBuilder implements com.grafana.foundation.cog.Builder<Panel> {
    ...
    public DashboardlistPanelBuilder timeCompare(String timeCompare) {
    ...
    public DashboardlistPanelBuilder actions(List<com.grafana.foundation.cog.Builder<Action>> actions) {
		if (this.internal.fieldConfig == null) {
			this.internal.fieldConfig = new com.grafana.foundation.dashboard.FieldConfigSource();
		}
		if (this.internal.fieldConfig.defaults == null) {
    ...
    public DashboardlistPanelBuilder fieldMinMax(Boolean fieldMinMax) {
		if (this.internal.fieldConfig == null) {
			this.internal.fieldConfig = new com.grafana.foundation.dashboard.FieldConfigSource();
		}
		if (this.internal.fieldConfig.defaults == null) {
