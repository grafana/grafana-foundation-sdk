...
```java
public VisualizationBuilder displayMode(BarGaugeDisplayMode displayMode)
```
...
```java
public VisualizationBuilder maxVizHeight(Integer maxVizHeight)
```
...
```java
public VisualizationBuilder minVizHeight(Integer minVizHeight)
```

### <span class="badge object-method"></span> minVizWidth

```java
public VisualizationBuilder minVizWidth(Integer minVizWidth)
```

### <span class="badge object-method"></span> namePlacement

```java
public VisualizationBuilder namePlacement(BarGaugeNamePlacement namePlacement)
```
...
```java
public VisualizationBuilder reduceOptions(com.grafana.foundation.cog.Builder<ReduceDataOptions> reduceOptions)
```

### <span class="badge object-method"></span> showUnfilled

```java
public VisualizationBuilder showUnfilled(Boolean showUnfilled)
```

### <span class="badge object-method"></span> sizing

```java
public VisualizationBuilder sizing(BarGaugeSizing sizing)
```
...
```java
public VisualizationBuilder valueMode(BarGaugeValueMode valueMode)
```
