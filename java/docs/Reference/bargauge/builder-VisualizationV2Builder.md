...
```java
public VisualizationV2Builder displayMode(BarGaugeDisplayMode displayMode)
```
...
```java
public VisualizationV2Builder maxVizHeight(Integer maxVizHeight)
```
...
```java
public VisualizationV2Builder minVizHeight(Integer minVizHeight)
```

### <span class="badge object-method"></span> minVizWidth

```java
public VisualizationV2Builder minVizWidth(Integer minVizWidth)
```

### <span class="badge object-method"></span> namePlacement

```java
public VisualizationV2Builder namePlacement(BarGaugeNamePlacement namePlacement)
```
...
```java
public VisualizationV2Builder reduceOptions(com.grafana.foundation.cog.Builder<ReduceDataOptions> reduceOptions)
```

### <span class="badge object-method"></span> showUnfilled

```java
public VisualizationV2Builder showUnfilled(Boolean showUnfilled)
```

### <span class="badge object-method"></span> sizing

```java
public VisualizationV2Builder sizing(BarGaugeSizing sizing)
```
...
```java
public VisualizationV2Builder valueMode(BarGaugeValueMode valueMode)
```
