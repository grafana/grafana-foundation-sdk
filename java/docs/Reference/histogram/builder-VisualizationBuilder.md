...
```java
public VisualizationBuilder bucketCount(Integer bucketCount)
```
...
```java
public VisualizationBuilder bucketOffset(Float bucketOffset)
```
...
```java
public VisualizationBuilder bucketSize(Integer bucketSize)
```
...
```java
public VisualizationBuilder combine(Boolean combine)
```
