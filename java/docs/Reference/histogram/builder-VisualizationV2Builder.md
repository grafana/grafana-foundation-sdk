...
```java
public VisualizationV2Builder bucketCount(Integer bucketCount)
```
...
```java
public VisualizationV2Builder bucketOffset(Float bucketOffset)
```
...
```java
public VisualizationV2Builder bucketSize(Integer bucketSize)
```
...
```java
public VisualizationV2Builder combine(Boolean combine)
```
