...
```java
public VisualizationV2Builder infinitePan(Boolean infinitePan)
```
...
```java
public VisualizationV2Builder inlineEditing(Boolean inlineEditing)
```
...
```java
public VisualizationV2Builder panZoom(Boolean panZoom)
```
...
```java
public VisualizationV2Builder root(com.grafana.foundation.cog.Builder<CanvasOptionsRoot> root)
```
...
```java
public VisualizationV2Builder showAdvancedTypes(Boolean showAdvancedTypes)
```
