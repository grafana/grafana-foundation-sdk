...
```java
public VisualizationBuilder infinitePan(Boolean infinitePan)
```
...
```java
public VisualizationBuilder inlineEditing(Boolean inlineEditing)
```
...
```java
public VisualizationBuilder panZoom(Boolean panZoom)
```
...
```java
public VisualizationBuilder root(com.grafana.foundation.cog.Builder<CanvasOptionsRoot> root)
```
...
```java
public VisualizationBuilder showAdvancedTypes(Boolean showAdvancedTypes)
```
