...
```java
public VisualizationV2Builder alignValue(TimelineValueAlignment alignValue)
```
...
```java
public VisualizationV2Builder disablePagination()
```
...
```java
public VisualizationV2Builder insertNulls(BoolOrUint32 insertNulls)
```
...
```java
public VisualizationV2Builder mergeValues(Boolean mergeValues)
```
...
```java
public VisualizationV2Builder perPage(Double perPage)
```
...
```java
public VisualizationV2Builder rowHeight(Double rowHeight)
```
...
```java
public VisualizationV2Builder spanNulls(BoolOrUint32 spanNulls)
```
