...
```java
public VisualizationBuilder alignValue(TimelineValueAlignment alignValue)
```
...
```java
public VisualizationBuilder mergeValues(Boolean mergeValues)
```
...
```java
public VisualizationBuilder perPage(Double perPage)
```
...
```java
public VisualizationBuilder rowHeight(Double rowHeight)
```
