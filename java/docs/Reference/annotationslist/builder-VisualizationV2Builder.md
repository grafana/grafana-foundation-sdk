...
```java
public VisualizationV2Builder limit(Integer limit)
```
...
```java
public VisualizationV2Builder navigateAfter(String navigateAfter)
```

### <span class="badge object-method"></span> navigateBefore

```java
public VisualizationV2Builder navigateBefore(String navigateBefore)
```

### <span class="badge object-method"></span> navigateToPanel

```java
public VisualizationV2Builder navigateToPanel(Boolean navigateToPanel)
```
...
```java
public VisualizationV2Builder onlyFromThisDashboard(Boolean onlyFromThisDashboard)
```

### <span class="badge object-method"></span> onlyInTimeRange

```java
public VisualizationV2Builder onlyInTimeRange(Boolean onlyInTimeRange)
```
...
```java
public VisualizationV2Builder showTags(Boolean showTags)
```
...
```java
public VisualizationV2Builder showUser(Boolean showUser)
```
