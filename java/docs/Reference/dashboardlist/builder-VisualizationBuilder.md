...
```java
public VisualizationBuilder folderId(Long folderId)
```

### <span class="badge object-method"></span> folderUID

```java
public VisualizationBuilder folderUID(String folderUID)
```

### <span class="badge object-method"></span> includeVars

```java
public VisualizationBuilder includeVars(Boolean includeVars)
```

### <span class="badge object-method"></span> keepTime

```java
public VisualizationBuilder keepTime(Boolean keepTime)
```
...
```java
public VisualizationBuilder maxItems(Long maxItems)
```
...
```java
public VisualizationBuilder query(String query)
```

### <span class="badge object-method"></span> showFolderNames

```java
public VisualizationBuilder showFolderNames(Boolean showFolderNames)
```

### <span class="badge object-method"></span> showHeadings

```java
public VisualizationBuilder showHeadings(Boolean showHeadings)
```

### <span class="badge object-method"></span> showRecentlyViewed

```java
public VisualizationBuilder showRecentlyViewed(Boolean showRecentlyViewed)
```

### <span class="badge object-method"></span> showSearch

```java
public VisualizationBuilder showSearch(Boolean showSearch)
```

### <span class="badge object-method"></span> showStarred

```java
public VisualizationBuilder showStarred(Boolean showStarred)
```
