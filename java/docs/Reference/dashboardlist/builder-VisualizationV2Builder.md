...
```java
public VisualizationV2Builder folderId(Long folderId)
```

### <span class="badge object-method"></span> folderUID

```java
public VisualizationV2Builder folderUID(String folderUID)
```

### <span class="badge object-method"></span> includeVars

```java
public VisualizationV2Builder includeVars(Boolean includeVars)
```

### <span class="badge object-method"></span> keepTime

```java
public VisualizationV2Builder keepTime(Boolean keepTime)
```
...
```java
public VisualizationV2Builder maxItems(Long maxItems)
```
...
```java
public VisualizationV2Builder query(String query)
```

### <span class="badge object-method"></span> showFolderNames

```java
public VisualizationV2Builder showFolderNames(Boolean showFolderNames)
```

### <span class="badge object-method"></span> showHeadings

```java
public VisualizationV2Builder showHeadings(Boolean showHeadings)
```

### <span class="badge object-method"></span> showRecentlyViewed

```java
public VisualizationV2Builder showRecentlyViewed(Boolean showRecentlyViewed)
```

### <span class="badge object-method"></span> showSearch

```java
public VisualizationV2Builder showSearch(Boolean showSearch)
```

### <span class="badge object-method"></span> showStarred

```java
public VisualizationV2Builder showStarred(Boolean showStarred)
```

### <span class="badge object-method"></span> tags

```java
public VisualizationV2Builder tags(List<String> tags)
```
