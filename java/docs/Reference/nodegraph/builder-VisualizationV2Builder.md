...
```java
public VisualizationV2Builder edges(com.grafana.foundation.cog.Builder<EdgeOptions> edges)
```
...
```java
public VisualizationV2Builder nodes(com.grafana.foundation.cog.Builder<NodeOptions> nodes)
```
...
```java
public VisualizationV2Builder zoomMode(ZoomMode zoomMode)
```
