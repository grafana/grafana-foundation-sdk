...
```java
public VisualizationBuilder displayLabels(List<PieChartLabels> displayLabels)
```
...
```java
public VisualizationBuilder legend(com.grafana.foundation.cog.Builder<PieChartLegendOptions> legend)
```
...
```java
public VisualizationBuilder pieType(PieChartType pieType)
```
