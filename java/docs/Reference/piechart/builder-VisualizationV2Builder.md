...
```java
public VisualizationV2Builder displayLabels(List<PieChartLabels> displayLabels)
```
...
```java
public VisualizationV2Builder legend(com.grafana.foundation.cog.Builder<PieChartLegendOptions> legend)
```
...
```java
public VisualizationV2Builder pieType(PieChartType pieType)
```
