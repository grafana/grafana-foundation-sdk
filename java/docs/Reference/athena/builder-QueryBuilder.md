...
```java
public QueryBuilder connectionArgs(com.grafana.foundation.cog.Builder<ConnectionArgs> connectionArgs)
```
...
```java
public QueryBuilder format(FormatOptions format)
```
...
```java
public QueryBuilder queryID(String queryID)
```
