...
```java
package com.grafana.foundation.expr.ExprTypeClassicConditionsResultAssertionsType;
...
public enum ExprTypeClassicConditionsResultAssertionsType {
    NONE(""),
    ...
    private ExprTypeClassicConditionsResultAssertionsType(String value) {
        this.value = value;
    }
