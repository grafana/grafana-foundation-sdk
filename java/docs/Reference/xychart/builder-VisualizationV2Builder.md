...
```java
public VisualizationV2Builder mapping(SeriesMapping mapping)
```
...
```java
public VisualizationV2Builder pointShape(PointShape pointShape)
```

### <span class="badge object-method"></span> pointSize

```java
public VisualizationV2Builder pointSize(com.grafana.foundation.cog.Builder<XychartFieldConfigPointSize> pointSize)
```

### <span class="badge object-method"></span> pointStrokeWidth

```java
public VisualizationV2Builder pointStrokeWidth(Integer pointStrokeWidth)
```
...
```java
public VisualizationV2Builder series(List<com.grafana.foundation.cog.Builder<XYSeriesConfig>> series)
```

### <span class="badge object-method"></span> show

```java
public VisualizationV2Builder show(XYShowMode show)
```
