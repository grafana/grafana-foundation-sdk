...
```java
public VisualizationBuilder mapping(SeriesMapping mapping)
```
...
```java
public VisualizationBuilder pointShape(PointShape pointShape)
```

### <span class="badge object-method"></span> pointSize

```java
public VisualizationBuilder pointSize(com.grafana.foundation.cog.Builder<XychartFieldConfigPointSize> pointSize)
```

### <span class="badge object-method"></span> pointStrokeWidth

```java
public VisualizationBuilder pointStrokeWidth(Integer pointStrokeWidth)
```
...
```java
public VisualizationBuilder series(List<com.grafana.foundation.cog.Builder<XYSeriesConfig>> series)
```

### <span class="badge object-method"></span> show

```java
public VisualizationBuilder show(XYShowMode show)
```
