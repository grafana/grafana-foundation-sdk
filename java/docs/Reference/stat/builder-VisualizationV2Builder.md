...
```java
public VisualizationV2Builder colorMode(BigValueColorMode colorMode)
```
...
```java
public VisualizationV2Builder graphMode(BigValueGraphMode graphMode)
```

### <span class="badge object-method"></span> justifyMode

```java
public VisualizationV2Builder justifyMode(BigValueJustifyMode justifyMode)
```
...
```java
public VisualizationV2Builder percentChangeColorMode(PercentChangeColorMode percentChangeColorMode)
```
...
```java
public VisualizationV2Builder showPercentChange(Boolean showPercentChange)
```
...
```java
public VisualizationV2Builder textMode(BigValueTextMode textMode)
```
...
```java
public VisualizationV2Builder wideLayout(Boolean wideLayout)
```
