...
```java
public VisualizationBuilder colorMode(BigValueColorMode colorMode)
```
...
```java
public VisualizationBuilder graphMode(BigValueGraphMode graphMode)
```

### <span class="badge object-method"></span> justifyMode

```java
public VisualizationBuilder justifyMode(BigValueJustifyMode justifyMode)
```
...
```java
public VisualizationBuilder percentChangeColorMode(PercentChangeColorMode percentChangeColorMode)
```
...
```java
public VisualizationBuilder showPercentChange(Boolean showPercentChange)
```
...
```java
public VisualizationBuilder textMode(BigValueTextMode textMode)
```
...
```java
public VisualizationBuilder wideLayout(Boolean wideLayout)
```
