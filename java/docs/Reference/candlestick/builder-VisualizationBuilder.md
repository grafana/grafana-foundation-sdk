...
```java
public VisualizationBuilder candleStyle(CandleStyle candleStyle)
```
...
```java
public VisualizationBuilder colorStrategy(ColorStrategy colorStrategy)
```
...
```java
public VisualizationBuilder colors(com.grafana.foundation.cog.Builder<CandlestickColors> colors)
```
...
```java
public VisualizationBuilder fields(com.grafana.foundation.cog.Builder<CandlestickFieldMap> fields)
```
...
```java
public VisualizationBuilder includeAllFields(Boolean includeAllFields)
```
...
```java
public VisualizationBuilder mode(VizDisplayMode mode)
```
