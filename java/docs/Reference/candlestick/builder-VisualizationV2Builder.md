...
```java
public VisualizationV2Builder candleStyle(CandleStyle candleStyle)
```
...
```java
public VisualizationV2Builder colorStrategy(ColorStrategy colorStrategy)
```
...
```java
public VisualizationV2Builder colors(com.grafana.foundation.cog.Builder<CandlestickColors> colors)
```
...
```java
public VisualizationV2Builder fields(com.grafana.foundation.cog.Builder<CandlestickFieldMap> fields)
```
...
```java
public VisualizationV2Builder includeAllFields(Boolean includeAllFields)
```
...
```java
public VisualizationV2Builder mode(VizDisplayMode mode)
```
