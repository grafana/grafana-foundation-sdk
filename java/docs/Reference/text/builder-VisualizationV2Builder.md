...
```java
public VisualizationV2Builder code(com.grafana.foundation.cog.Builder<CodeOptions> code)
```
...
```java
public VisualizationV2Builder content(String content)
```
...
```java
public VisualizationV2Builder mode(TextMode mode)
```
