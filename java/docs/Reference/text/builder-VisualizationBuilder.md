...
```java
public VisualizationBuilder code(com.grafana.foundation.cog.Builder<CodeOptions> code)
```
...
```java
public VisualizationBuilder content(String content)
```
...
```java
public VisualizationBuilder mode(TextMode mode)
```
