...
```java
public VisualizationV2Builder basemap(com.grafana.foundation.cog.Builder<MapLayerOptions> basemap)
```
...
```java
public VisualizationV2Builder controls(com.grafana.foundation.cog.Builder<ControlsOptions> controls)
```
...
```java
public VisualizationV2Builder layers(List<com.grafana.foundation.cog.Builder<MapLayerOptions>> layers)
```
...
```java
public VisualizationV2Builder tooltip(com.grafana.foundation.cog.Builder<TooltipOptions> tooltip)
```
...
```java
public VisualizationV2Builder view(com.grafana.foundation.cog.Builder<MapViewConfig> view)
```
