...
```java
public VisualizationBuilder basemap(com.grafana.foundation.cog.Builder<MapLayerOptions> basemap)
```
...
```java
public VisualizationBuilder controls(com.grafana.foundation.cog.Builder<ControlsOptions> controls)
```
...
```java
public VisualizationBuilder layers(List<com.grafana.foundation.cog.Builder<MapLayerOptions>> layers)
```
...
```java
public VisualizationBuilder tooltip(com.grafana.foundation.cog.Builder<TooltipOptions> tooltip)
```
...
```java
public VisualizationBuilder view(com.grafana.foundation.cog.Builder<MapViewConfig> view)
```
